...
`,ie=dt(()=>{Qt="nvision-blank-card",Zt="nvision-blank-card-editor"});function ne(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var se,ae=dt(()=>{}),oe=dt(()=>{St(),ae(),se=class extends vt{},ne([At({attribute:!1})],se.prototype,"hass",void 0)});function re(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function le(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var ce,he,de=dt(()=>{}),ue=/* @__PURE__ */ut({NvisionBlankCardEditor:()=>he}),me=dt(()=>{St(),Dt(),Gt(),oe(),de(),ie(),ae(),ce=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},re()],he=class extends se{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):le(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${ce}
      ...
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ne([Pt()],he.prototype,"_config",void 0),he=ne([bt(Zt)],he)});St(),Dt(),ie(),ae(),Ht({type:Qt,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var pe=class extends vt{constructor(...t){super(...t),this._actions=new Kt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(me(),ue)),document.createElement(Zt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Qt}`,entity:n}}setConfig(t){this._config={tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Xt(t);return W`
      <ha-card>
        <div
          class="content"
          role="button"
  ...
  `]}};ne([At({attribute:!1})],zn.prototype,"hass",void 0),ne([Pt()],zn.prototype,"_config",void 0),ne([Pt()],zn.prototype,"_gaugeReady",void 0),ne([Lt("canvas")],zn.prototype,"_canvas",void 0),ne([Lt(".stage")],zn.prototype,"_stage",void 0),zn=ne([bt(hn)],zn);var Pn,En,Tn=dt(()=>{Sn="nvision-circle-gauge-card",Cn="nvision-circle-gauge-card-editor"}),In=/* @__PURE__ */ut({NvisionCircleGaugeCardEditor:()=>En}),On=dt(()=>{St(),Dt(),Gt(),oe(),de(),Tn(),ae(),Pn=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{name:"color",selector:{color_rgb:{}}},{name:"track_color",selector:{color_rgb:{}}},{name:"reverse",selector:{boolean:{}}},re("toggle")],En=class extends se{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color"===t.name?"Gauge color":"track_color"===t.name?"Track color":"reverse"===t.name?"Reverse":le(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,...t}}render(){return this.hass&&this._config?W`
    ...
    `}render(){if(!this._config||!this.hass)return K;const t=this._config.entity,e=t?this.hass.states[t]:void 0,{value:i,valueText:n,unit:s}=this._reading(),a=Se(this._config.color,this,"--primary-color","#03a9f4");const o=function(t,e){return Se(t,e,"--primary-background-color","#e0e0e0")}(this._config.track_color,this),r=this._config.name||e?.attributes.friendly_name||"Circle Gauge";return W`
      <ha-card>
        <div
          class="body"
          role="button"
  ...
  `]}};ne([At({attribute:!1})],ns.prototype,"hass",void 0),ne([Pt()],ns.prototype,"_config",void 0),ne([Lt("canvas")],ns.prototype,"_canvas",void 0),ne([Lt(".plug")],ns.prototype,"_plug",void 0),ne([function(t){return(e,i)=>Et(e,i,{get(){return(this.renderRoot??(Nt??=document.createDocumentFragment())).querySelectorAll(t)}})}(".entity-icon")],ns.prototype,"_entityIcons",void 0),ns=ne([bt(Kn)],ns),$t();var ss=_e(class extends ve{constructor(t){if(super(t),t.type!==ge||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=/* @__PURE__ */new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const n of this.st)n in e||(i.remove(n),this.st.delete(n));for(const n in e){const t=!!e[n];t===this.st.has(n)||this.nt?.has(n)||(t?(i.add(n),this.st.add(n)):(i.remove(n),this.st.delete(n)))}return Y}});function as(t){if("on"!==t.state)return 0;const e=t.attributes.brightness;return"number"!=typeof e?1:Math.max(0,Math.min(1,e/255))}function os(t){const e=t.attributes.brightness;return e&&"on"===t.state?`brightness(${(e+245)/5}%)`:""}function rs(t){const e=Math.max(1e3,Math.min(4e4,t))/100;let i,n,s;return e<=66?(i=255,n=Math.min(255,Math.max(0,99.4708025861*Math.log(e)-161.1195681661)),s=e<=19?0:Math.min(255,Math.max(0,138.5177312231*Math.log(e-10)-305.0447927307))):(i=Math.min(255,Math.max(0,329.698727446*(e-60)**-.1332047592)),n=Math.min(255,Math.max(0,288.1221695283*(e-60)**-.0755148492)),s=255),[Math.round(i),Math.round(n),Math.round(s)]}function ls(t){if("on"!==t.state)return;const e=t.attributes.rgb_color;if(e)return e;const i=t.attributes.color_temp_kelvin;if("number"==typeof i)return rs(i);const n=t.attributes.color_temp;if("number"==typeof n&&n>0)return rs(Math.round(1e6/n));const s=t.attributes.hs_color;return s?function(t,e,i){const n=e/100,s=i/100,a=(1-Math.abs(2*s-1))*n,o=t/60,r=a*(1-Math.abs(o%2-1));let l=0,c=0,h=0;o>=0&&o<1?(l=a,c=r):o<2?(l=r,c=a):o<3?(c=a,h=r):o<4?(c=r,h=a):o<5?(l=r,h=a):(l=a,h=r);const d=s-a/2;return[Math.round(255*(l+d)),Math.round(255*(c+d)),Math.round(255*(h+d))]}(s[0],s[1],50):void 0}var cs,hs,ds,us,ms="nvision-light-glow-stack";var ps,gs,fs=dt(()=>{cs="nvision-light-card",hs="nvision-light-card-editor",ds=.72,us=.62}),_s=/* @__PURE__ */ut({NvisionLightCardEditor:()=>gs}),vs=dt(()=>{St(),Dt(),Gt(),oe(),fs(),ae(),ps=[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{type:"grid",name:"",schema:[{name:"glow_size",required:!0,default:165,selector:{number:{min:20,max:300,step:5,unit_of_measurement:"%"}}},{name:"glow_intensity",required:!0,default:ds,selector:{number:{min:0,max:1,step:.05}}}]},{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}],gs=class extends se{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"glow_size"===t.name?"Glow size":"glow_intensity"===t.name?"Glow intensity":"interactions"===t.name?"Interactions":"hold_action"===t.name||"double_tap_action"===t.name?`${this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)} (${this.hass.localize("ui.panel.lovelace.editor.card.config.optional")})`:this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={tap_action:{action:"toggle"},hold_action:{action:"more-info"},glow_size:165,glow_intensity:ds,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ne([Pt()],gs.prototype,"_config",void 0),gs=ne([bt(hs)],gs)});St(),Dt(),Gt(),fs(),ae(),Ht({type:cs,name:"Nvision Light",description:"Light control with ambient color glow"}),function(t){if("undefined"==typeof document||document.getElementById(ms))return;const e=document.createElement("style");e.id=ms,e.textContent=`\n    hui-card:has(${t}),\n    .card:has(${t}) {\n      position: relative;\n      z-index: 0;\n      overflow: visible;\n    }\n\n    hui-card:not(:has(${t})),\n    .card:not(:has(${t})) {\n      position: relative;\n      z-index: 1;\n    }\n\n    section:has(${t}) {\n      position: relative;\n      z-index: 0;\n    }\n\n    section:not(:has(${t})) {\n      position: relative;\n      z-index: 1;\n    }\n\n    section .meta {\n      position: relative;\n      z-index: 2;\n    }\n\n    .preview:has(${t}) {\n      overflow: visible;\n    }\n  `,document.head.appendChild(e)}(cs);var ys,bs,xs,ws,$s,ks,Ms,Ss=class extends vt{constructor(...t){super(...t),this._holdTriggered=!1}static async getConfigElement(){return await Promise.resolve().then(()=>(vs(),_s)),document.createElement(hs)}static getStubConfig(t,e,i){const n=e.find(t=>t.startsWith("light."))||i.find(t=>t.startsWith("light."))||Object.keys(t.states).find(t=>t.startsWith("light."))||e[0]||i[0]||"";return{type:`custom:${cs}`,entity:n,glow_size:165,glow_intensity:ds}}setConfig(t){if(!t.entity||"light"!==t.entity.split(".")[0])throw new Error("Specify an entity from within the light domain");this._config={tap_action:{action:"toggle"},hold_action:{action:"more-info"},glow_size:165,glow_intensity:ds,...t}}getCardSize(){return 5}getGridOptions(){return{columns:6,rows:5,min_rows:3}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0;if(!t)return W`
        <ha-card>
  ...
  `]}};ne([At({attribute:!1})],_a.prototype,"hass",void 0),ne([Pt()],_a.prototype,"_config",void 0),ne([Pt()],_a.prototype,"_grid",void 0),ne([Pt()],_a.prototype,"_loading",void 0),ne([Pt()],_a.prototype,"_error",void 0),ne([Pt()],_a.prototype,"_popover",void 0),ne([Pt()],_a.prototype,"_xLabelVisible",void 0),_a=ne([bt(Vs)],_a),$t();var{I:va}=rt,ya=t=>t,ba=()=>document.createComment(""),xa=(t,e,i)=>{const n=t._$AA.parentNode,s=void 0===e?t._$AB:e._$AA;if(void 0===i)i=new va(n.insertBefore(ba(),s),n.insertBefore(ba(),s),t,t.options);else{const e=i._$AB.nextSibling,a=i._$AM,o=a!==t;if(o){let e;i._$AQ?.(t),i._$AM=t,void 0!==i._$AP&&(e=t._$AU)!==a._$AU&&i._$AP(e)}if(e!==s||o){let t=i._$AA;for(;t!==e;){const e=ya(t).nextSibling;ya(n).insertBefore(t,s),t=e}}}return i},wa=(t,e,i=t)=>(t._$AI(e,i),t),$a={},ka=(t,e=$a)=>t._$AH=e,Ma=t=>{t._$AR(),t._$AA.remove()};$t();var Sa,Ca,Aa,za,Pa,Ea,Ta=(t,e,i)=>{const n=/* @__PURE__ */new Map;for(let s=e;s<=i;s++)n.set(t[s],s);return n},Ia=_e(class extends ve{constructor(t){if(super(t),t.type!==fe)throw Error("repeat() can only be used in text expressions")}dt(t,e,i){let n;void 0===i?i=e:void 0!==e&&(n=e);const s=[],a=[];let o=0;for(const r of t)s[o]=n?n(r,o):o,a[o]=i(r,o),o++;return{values:a,keys:s}}render(t,e,i){return this.dt(t,e,i).values}update(t,[e,i,n]){const s=(t=>t._$AH)(t),{values:a,keys:o}=this.dt(e,i,n);if(!Array.isArray(s))return this.ut=o,a;const r=this.ut??=[],l=[];let c,h,d=0,u=s.length-1,m=0,p=a.length-1;for(;d<=u&&m<=p;)if(null===s[d])d++;else if(null===s[u])u--;else if(r[d]===o[m])l[m]=wa(s[d],a[m]),d++,m++;else if(r[u]===o[p])l[p]=wa(s[u],a[p]),u--,p--;else if(r[d]===o[p])l[p]=wa(s[d],a[p]),xa(t,l[p+1],s[d]),d++,p--;else if(r[u]===o[m])l[m]=wa(s[u],a[m]),xa(t,s[d],s[u]),u--,m++;else if(void 0===c&&(c=Ta(o,m,p),h=Ta(r,d,u)),c.has(r[d]))if(c.has(r[u])){const e=h.get(o[m]),i=void 0!==e?s[e]:null;if(null===i){const e=xa(t,s[d]);wa(e,a[m]),l[m]=e}else l[m]=wa(i,a[m]),xa(t,s[d],i),s[e]=null;m++}else Ma(s[u]),u--;else Ma(s[d]),d++;for(;m<=p;){const e=xa(t,l[p+1]);wa(e,a[m]),l[m++]=e}for(;d<=u;){const t=s[d++];null!==t&&Ma(t)}return this.ut=o,ka(t,l),Y}}),Oa=dt(()=>{Sa="nvision-entity-overview-card",Ca="nvision-entity-overview-card-editor",Aa="auto",za="on_update",Pa=["sensor","binary_sensor","switch","light","timer"],Ea=["sensor","binary_sensor","switch","light","timer"]});function La(t){const e=t.split(":").map(Number);return 3===e.length?3600*e[0]+60*e[1]+e[2]:2===e.length?60*e[0]+e[1]:Number(t)||0}function Na(t){return void 0!==t&&"unavailable"!==t&&"unknown"!==t&&("on"===t||"true"===t||"open"===t||"home"===t||"active"===t)}function Fa(t,e){const i=e.split(".",1)[0];if("light"===i)return"light";if("timer"===i)return"timer";if("switch"===i||Hs(e))return"toggle";const n=t.states[e]?.state;return void 0!==ti(n)?"numeric":"other"}function Ra(t,e,i,n){const s=ti(t.states[e]?.state);return void 0===s?.35:ei(s,i,n)}function qa(t,e){const i=t.states[e];if(!i||"active"!==i.state)return 0;const n=function(t){const e=t.attributes.remaining;if("string"!=typeof e)return;let i=La(e);if("active"===t.state&&t.attributes.finishes_at){const e=new Date(String(t.attributes.finishes_at)).getTime();i=Math.max((e-Date.now())/1e3,0)}return i}(i),s=function(t){const e=t.attributes.duration;return"string"==typeof e?La(e):0}(i);return void 0===n||s<=0?.55:1-Math.min(1,Math.max(0,n/s))}function Ba(t,e,i,n){const s=t.states[e]?.state,a=Fa(t,e),o="light"===a?function(t,e){const i=t.states[e];if(!i||"on"!==i.state)return{lightBrightness:0};const n=ls(i);return{lightColor:n?`rgb(${n.join(", ")})`:void 0,lightBrightness:as(i)}}(t,e):{};return{kind:a,isOn:Na(s),numericNorm:Ra(t,e,i,n),lightColor:o.lightColor,lightBrightness:o.lightBrightness??0,timerUrgency:"timer"===a?qa(t,e):0,unavailable:"unavailable"===s||"unknown"===s}}Oa(),ui();var ja=[.42,.58,.72,.84],Da=[185,198,215,248,278,312,42],Ha=2*Math.PI,Ua=.34,Ga=1.1,Wa=.06;function Va(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}function Ya(t,e){const i=Math.min(ja.length,Math.max(2,Math.ceil(Math.sqrt(e)))),n=t%i,s=Math.ceil(e/i);return{shell:n,slot:Math.floor(t/i)%s,slotsOnShell:s}}function Ka(t,e){const i=(14e-6*e+.31*t)%Da.length,n=Math.floor(i);return Da[n]+(Da[(n+1)%Da.length]-Da[n])*(i-n)}function Xa(t,e,i,n){const s=Ba(e,t.entityId,i,n);t.kind=s.kind,t.isOn=s.isOn,t.numericNorm=s.numericNorm,t.lightColor=s.lightColor,t.lightBrightness=s.lightBrightness,t.timerUrgency=s.timerUrgency,t.unavailable=s.unavailable}function Qa(t,e){const i=Za(t,e),n=.014*e;return Math.min(3.4,Math.max(.5,n/Math.max(i,.004*e)))}function Za(t,e){return"numeric"===t.kind?Ja(e,t.numericNorm):to(e,t.kind)}function Ja(t,e){return t*(.006+.028*e)}function to(t,e){switch(e){case"toggle":return.016*t;case"light":return.011*t;case"timer":return.013*t;case"numeric":return.012*t;default:return.01*t}}function eo(t,e){e.push({x:t.x,y:t.y,age:0,seed:t.seed})}function io(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:Pa,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function no(t,e,i,n,s,a){const o=Va(e),r=Va(`${e}:y`),l=Ya(s,a),c=t.states[e]?.state,h={entityId:e,kind:Fa(t,e),seed:o,seedY:r,x:0,y:0,phase:o*Ha,shell:l.shell,slot:l.slot,slotsOnShell:l.slotsOnShell,orbitTilt:o*Ha,orbitRyScale:.62+.32*r,baseOrbitSpeed:85e-5+.0011*o,wobbleSpeed:.0016+.0024*r,pathDrift:0,isOn:!1,lastState:c,numericNorm:.35,lightBrightness:0,timerUrgency:0,unavailable:"unavailable"===c||"unknown"===c,placed:!1};return Xa(h,t,i,n),h}function so(t,e){const i=t/2,n=Math.min(.22*e,72),s=(e-n)/2,a=Math.max(10,.06*t),o=Math.max(10,.06*e+.35*n),r=Math.max(1,t/2-a),l=Math.max(1,(e-n)/2-o);return{cx:i,cy:s,halfW:r,halfH:l,scale:Math.min(t,e),clampX:r,clampY:l}}function ao(t,e,i,n){const{cx:s,cy:a,halfW:o,halfH:r}=so(e,i),l=ja[t.shell%ja.length],c=t.slot/Math.max(1,t.slotsOnShell)*Ha+.55*t.seed+t.phase,h=o*l,d=r*l*t.orbitRyScale,u=Math.cos(c)*h,m=Math.sin(c)*d,p=t.orbitTilt;let g=s+u*Math.cos(p)-m*Math.sin(p),f=a+u*Math.sin(p)+m*Math.cos(p);const _=.001*n,v=.028+.018*t.seed;return g+=Math.cos(_*t.wobbleSpeed+11*t.seed)*h*v,f+=Math.sin(_*t.wobbleSpeed*1.23+9*t.seedY)*d*v,{x:g,y:f}}function oo(t,e,i,n){const s=ao(t,e,i,n),a=ao(t,e,i,n+24),o=a.x-s.x,r=a.y-s.y,l=Math.hypot(o,r);return l<.01?{x:1,y:0}:{x:o/l,y:r/l}}function ro(t,e,i,n){const s=ao(t,e,i,n);t.x=s.x,t.y=s.y,t.pathDrift=0,t.placed=!0}function lo(t,e,i){const n=Ka(t.seed,e);let s=82,a=58;return t.unavailable&&(s=18,a=42),`hsla(${n}, ${s}%, ${a}%, ${i})`}function co(t,e){for(const i of e)t.beginPath(),t.arc(i.x,i.y,i.radius,0,Ha),t.fillStyle=i.color,t.fill()}function ho(t,e,i,n,s,a=.5){const o=i*(1+s*a),r={core:{x:t,y:e,radius:i,color:n}};return o>1.02*i&&(r.halo={x:t,y:e,radius:o,color:n.replace(/[\d.]+\)$/,.07+.1*s+")")}),r}function uo(t,e,i){switch(t.kind){case"toggle":return function(t,e,i){const n=to(e,"toggle"),s=t.isOn?.009:.007,a=(Math.sin(i*s+12*t.seed)+1)/2,o=Ka(t.seed,i),r=t.unavailable?18:t.isOn?38+50*a:38,l=t.unavailable?42:t.isOn?36+22*a:36,c=`hsla(${o}, ${r}%, ${l}%, ${t.unavailable?.18:t.isOn?Ua+.44*a:Ua})`,h=t.unavailable?1.08*n:t.isOn?n*(Ga+.4*a):n*Ga,d=`hsla(${o}, ${r}%, ${Math.max(l-6,40)}%, ${t.isOn?Wa+.12*a:Wa})`;return{halo:h>1.02*n?{x:t.x,y:t.y,radius:h,color:d}:void 0,core:{x:t.x,y:t.y,radius:n,color:c}}}(t,e,i);case"light":return function(t,e,i){const n=t.lightBrightness,s=to(e,"light"),a=t.unavailable?.25:t.isOn?.55+.35*n:.18,o=t.lightColor??(t.isOn?"rgb(255, 183, 77)":lo(t,i,.25)),r=mo(o,a),l=t.unavailable?1.08*s:t.isOn?s*(1.35+2.15*n):1.08*s,c=mo(o,t.isOn?.08+.16*n:.05);return{halo:l>1.02*s?{x:t.x,y:t.y,radius:l,color:c}:void 0,core:{x:t.x,y:t.y,radius:s,color:r}}}(t,e,i);case"timer":return function(t,e,i){const n=t.timerUrgency,s=to(e,"timer"),a=.005+.048*n,o=Math.sin(i*a+10*t.seed),r=(o+1)/2,l=r*o*(24+36*n),c=(Ka(t.seed,i)+l+360)%360,h=52+6*n,d=.38+.24*n,u=t.unavailable?18:38+50*r,m=t.unavailable?42:36+r*(h-36),p=`hsla(${c}, ${u}%, ${m}%, ${t.unavailable?.25:Ua+r*(d-Ua)})`,g=t.unavailable?1.08*s:s*(Ga+r*(.35+.45*n)),f=`hsla(${c}, ${u}%, ${Math.max(m-4,40)}%, ${Wa+r*(.08+.12*n)})`;return{halo:g>1.02*s?{x:t.x,y:t.y,radius:g,color:f}:void 0,core:{x:t.x,y:t.y,radius:s,color:p}}}(t,e,i);default:return function(t,e,i){const n="numeric"===t.kind?Ja(e,t.numericNorm):to(e,t.kind),s=t.unavailable?.28:.78,a=lo(t,i,s);return ho(t.x,t.y,n,a,.65*s)}(t,e,i)}}function mo(t,e){const i=t.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/);return i?`rgba(${i[1]}, ${i[2]}, ${i[3]}, ${e})`:t.match(/hsla?\(([^)]+)\)/)?t.replace(/[\d.]+\)$/,`${e})`):t}function po(t,e,i,n,s,a){const{cx:o,cy:r,scale:l,clampX:c,clampY:h}=so(e,i),d=.012*l,u=.003*l,m=.05*a,p=.024*a,g=.09*l,f=t.map(t=>function(t,e){const i=Za(t,e);return"toggle"===t.kind?t.isOn?1.55*i:i*Ga:"light"===t.kind?t.isOn?i*(1.2+1.4*t.lightBrightness):1.08*i:"timer"===t.kind?1.45*i:1.3*i}(t,l));for(let v=0;v<t.length;v+=1){const e=t[v];e.phase+=e.baseOrbitSpeed*Qa(e,l)*n}const _=t.map(t=>{return{target:ao(t,e,i,s),normal:(n=oo(t,e,i,s),{x:-n.y,y:n.x})};var n});for(let v=0;v<t.length;v+=1){const e=t[v],{target:i,normal:s}=_[v],a=f[v],y=Math.max(a,u)/d,b=m*Math.min(1.35,Math.max(.4,1/Math.sqrt(y)));let x=-e.pathDrift*b*n;const w=i.x+s.x*e.pathDrift,$=i.y+s.y*e.pathDrift;for(let o=0;o<t.length;o+=1){if(o===v)continue;const e=t[o],i=_[o],r=f[o],c=a+r,h=c+.014*l,d=w-(i.target.x+i.normal.x*e.pathDrift),m=$-(i.target.y+i.normal.y*e.pathDrift),g=Math.hypot(d,m);if(g<=.5||g>=h)continue;const b=(h-g)/(h-.65*c),k=Math.max(0,c-g),M=(b**1.2+k/c*2.5)*p*(Math.max(r,u)/Math.max(a,u))*n,S=d/g*s.x+m/g*s.y;x+=S*M,k>0&&(x+=S*(k/c)*.35*(1/y)*n)}e.pathDrift+=x,e.pathDrift=Math.min(g,Math.max(-g,e.pathDrift));let k=i.x+s.x*e.pathDrift,M=i.y+s.y*e.pathDrift;k=Math.min(o+c,Math.max(o-c,k)),M=Math.min(r+h,Math.max(r-h,M)),e.x=k,e.y=M,e.pathDrift=(k-i.x)*s.x+(M-i.y)*s.y,e.placed=!0}}function go(t,e,i,n,s,a,o=[]){const{cx:r,cy:l,scale:c}=so(n,s);t.clearRect(0,0,n,s);const h=t.createRadialGradient(r,l,0,r,l,.72*c);h.addColorStop(0,"hsla(200, 70%, 58%, 0.06)"),h.addColorStop(.35,"hsla(260, 55%, 42%, 0.03)"),h.addColorStop(1,"hsla(0, 0%, 0%, 0)"),t.fillStyle=h,t.fillRect(0,0,n,s),function(t,e,i,n){for(const s of e){const e=s.age/1400,a=i*(.03+.48*e),o=(1-e)**1.2*.11,r=Ka(s.seed,n);t.beginPath(),t.arc(s.x,s.y,a,0,Ha),t.strokeStyle=`hsla(${r}, 86%, 64%, ${o})`,t.lineWidth=1+1.4*(1-e),t.stroke()}}(t,i,c,a);const d=[],u=[];for(const m of e){const t=uo(m,c,a);t.halo&&d.push(t.halo),u.push(t.core)}co(t,d),o.length&&function(t,e,i,n){for(const s of e){const e=`hsla(${Ka(s.seed,n)}, 78%, 62%, 0.42)`;t.beginPath(),t.moveTo(s.fromX,s.fromY),t.lineTo(s.toX,s.toY),t.strokeStyle=e,t.lineWidth=1,t.stroke(),t.beginPath(),t.arc(s.toX,s.toY,.0045*i,0,Ha),t.fillStyle=e.replace(/[\d.]+\)$/,"0.65)"),t.fill()}}(t,o,c,a),co(t,u);!function(t,e,i,n,s,a,o=.5){const r=ho(e,i,n,s,a,o);r.halo&&co(t,[r.halo]),co(t,[r.core])}(t,r,l,.012*c*(.55+.12*Math.sin(.0018*a)),`hsla(${Da[Math.floor(14e-6*a%Da.length)]}, 88%, 68%, 0.65)`,.5,.3)}var fo,_o,vo,yo=/* @__PURE__ */ut({NvisionEntityOverviewCardEditor:()=>vo}),bo=dt(()=>{St(),Dt(),Gt(),oe(),de(),Oa(),ae(),fo=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:Aa,selector:{select:{options:[{value:"auto",label:"Auto-discover entities"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{name:"info_selection",required:!0,default:za,selector:{select:{options:[{value:"on_update",label:"On update"},{value:"random_interval",label:"Random every 10s"},{value:"nearest_cursor",label:"Nearest 4 to cursor/tap"}]}}},{name:"show_info",default:!0,selector:{boolean:{}}},{name:"show_info_change",default:!1,selector:{boolean:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},re()],_o=[{name:"entities",selector:{entity:{multiple:!0,domain:[...Ea]}}}],vo=class extends se{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"info_selection"===t.name?"Info card selection":"show_info"===t.name?"Show info cards":"show_info_change"===t.name?"Show value change (10W → 50W)":"min"===t.name?"Numeric orbit min":"max"===t.name?"Numeric orbit max":le(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:Aa,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...fo.slice(0,3),..._o,...fo.slice(3)]:fo}render(){return this.hass&&this._config?W`
    ...
    `;var n}render(){if(!this._config)return K;const t=this._config.title||"Event Log",e=this._trackedEntities(),i=this.preview||!this._entries.length&&!this._connected?il:this._entries,n=e.length?"Waiting for events from selected entities…":"Waiting for events…";return W`
  ...
  `}};ne([At({attribute:!1})],nl.prototype,"hass",void 0),ne([At({type:Boolean})],nl.prototype,"preview",void 0),ne([Pt()],nl.prototype,"_config",void 0),ne([Pt()],nl.prototype,"_entries",void 0),ne([Pt()],nl.prototype,"_connected",void 0),ne([Lt(".terminal-body")],nl.prototype,"_body",void 0),nl=ne([bt(Tr)],nl),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");