...
`,Kt=ht(()=>{Ht="nvision-blank-card",Gt="nvision-blank-card-editor"});function Xt(t,e,i,n){var s,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var o=t.length-1;o>=0;o--)(s=t[o])&&(r=(a<3?s(r):a>3?s(e,i,r):s(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r}var Qt=ht(()=>{});function Zt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}var Jt,te,ee,ie=ht(()=>{}),ne=ht(()=>{kt(),Qt(),Jt=class extends _t{},Xt([St({attribute:!1})],Jt.prototype,"hass",void 0)}),se=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ee}),ae=ht(()=>{kt(),Dt(),ie(),ne(),Kt(),Qt(),te=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}}],ee=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?V`
  ...
  `]}};Xt([St({attribute:!1})],en.prototype,"hass",void 0),Xt([zt()],en.prototype,"_config",void 0),Xt([It(".stage")],en.prototype,"_stage",void 0),Xt([It("canvas")],en.prototype,"_canvas",void 0),en=Xt([yt(yi)],en);var nn,sn,an=ht(()=>{Ji="nvision-air-quality-card",tn="nvision-air-quality-card-editor"}),rn=/* @__PURE__ */dt({NvisionAirQualityCardEditor:()=>sn}),on=ht(()=>{kt(),Dt(),ie(),ne(),an(),Qt(),nn=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"color_good",selector:{color_rgb:{}}},{name:"color_warning",selector:{color_rgb:{}}}]},{type:"grid",name:"",schema:[{name:"color_bad",selector:{color_rgb:{}}},{name:"color_mist",selector:{color_rgb:{}}}]},{type:"grid",name:"",schema:[{name:"color_clear",selector:{color_rgb:{}}},{name:"color_sky",selector:{color_rgb:{}}}]}],sn=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color_good"===t.name?"Good gauge color":"color_warning"===t.name?"Moderate gauge color":"color_bad"===t.name?"Poor gauge color":"color_mist"===t.name?"Mist color":"color_clear"===t.name?"Clear glow color":"color_sky"===t.name?"Sky glow color":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,...t}}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${nn}
    ...
    `}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=gn(t?.state),i=e??this._targetValue,n=this._config.name||t?.attributes.friendly_name||"Air Quality",s=t?.attributes.unit_of_measurement??"",a=void 0!==e?String(Math.round(10*e)/10):"—",r=mn(this._config,this);return V`
      <ha-card
  ...
  `]}};Xt([St({attribute:!1})],Dn.prototype,"hass",void 0),Xt([zt()],Dn.prototype,"_config",void 0),Xt([It("canvas")],Dn.prototype,"_canvas",void 0),Xt([It(".plug")],Dn.prototype,"_plug",void 0),Xt([It(".entity-icon")],Dn.prototype,"_entityIcon",void 0),Dn=Xt([yt(Pn)],Dn);var Un,Bn,Hn=ht(()=>{Nn="nvision-power-glance-card",jn="nvision-power-glance-card-editor"}),Gn=/* @__PURE__ */dt({NvisionPowerGlanceCardEditor:()=>Bn}),Vn=ht(()=>{kt(),Dt(),ie(),ne(),ii(),Hn(),Qt(),Un=[{name:"entities",selector:{entity:{multiple:!0,domain:"sensor"}}},{name:"columns",default:3,selector:{number:{min:1,max:6,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:ze,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"effects_min",required:!0,default:0,selector:{number:{min:0,max:1,step:.05}}},{name:"effects_max",required:!0,default:1,selector:{number:{min:0,max:1,step:.05}}}]},{name:"color",selector:{color_rgb:{}}},{name:"icon",selector:{icon:{}}}],Bn=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"columns"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.columns"):"min"===t.name?"Minimum watts":"max"===t.name?"Maximum watts":"effects_min"===t.name?"Minimum effect":"effects_max"===t.name?"Maximum effect":"color"===t.name?"Lightning color":"icon"===t.name?"Source icon":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={entities:[],columns:3,min:0,max:ze,effects_min:0,effects_max:1,...t}}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Un}
  ...
  `}};function ys(t){return String(t).padStart(2,"0")}function bs(t,e){const i=Object.fromEntries(function(t){let e=ps.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),ps.set(t,e)),e}(e).formatToParts(new Date(t)).map(t=>[t.type,t.value])),n=gs.indexOf(String(i.weekday))>=0?gs.indexOf(String(i.weekday)):0,s=Number(i.year),a=Number(i.month),r=Number(i.day);return{year:s,month:a,day:r,hour:Number(i.hour)%24,weekday:n,dateKey:`${s}-${ys(a)}-${ys(r)}`,monthKey:`${s}-${ys(a)}`}}function xs(t,e,i){const n=bs(ws(t,e,i),e);return`${n.year}-${ys(n.month)}-${ys(n.day)}`}function ws(t,e,i){const n=bs(t,e),s=(n.weekday-i+7)%7;return $s(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function $s(t,e,i,n,s,a){const r=Date.UTC(t,e-1,i,n,s,0),o=Object.fromEntries(function(t){let e=fs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),fs.set(t,e)),e}(a).formatToParts(new Date(r)).map(t=>[t.type,t.value]));return r-(Date.UTC(Number(o.year),Number(o.month)-1,Number(o.day),Number(o.hour),Number(o.minute),0)-r)}function Ms(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...bs(t,e),weekKey:xs(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function ks(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>gs[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=bs(t.startMs,e);let s=$s(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=bs(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=ws(t.startMs,e,i);for(;s<=t.endMs;){const t=bs(s,e);n.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=bs(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${ys(a)}`;if(i.push({key:n,label:`${s}-${ys(a)}`}),a+=1,a>12&&(a=1,s+=1),$s(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const r=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const o of r)a.set(o.key,`${new Date(o.start).toLocaleString()} – ${new Date(o.end).toLocaleString()}`);return{keys:r.map(t=>t.key),labels:r.map(t=>t.label),bucketRanges:a}}function Cs(t,e,i,n,s,a,r){return"time"===t?r.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function Ss(t){return us[t&&ms[t]||(t&&t in us?t:void 0)||"week_hourly"]}function As(t,e,i,n,s){const a=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(ds[i]),r=(o=a.hours)<=24||o<=48||o<=336?36e5:864e5;var o;const l=ks(t,a,n,s,r),c=ks(e,a,n,s,r);return{window:a,bucketMs:r,xAxis:l,yAxis:c,xKeySet:new Set(l.keys),yKeySet:new Set(c.keys),bucketMap:/* @__PURE__ */new Map}}function zs(t,e,i,n,s,a){if(e.time<t.window.startMs||e.time>t.window.endMs)return;const r=Ms(i,e.time,s,t.bucketMs,a),o=Ms(n,e.time,s,t.bucketMs,a);if(void 0===r||void 0===o)return;if(!t.xKeySet.has(r)||!t.yKeySet.has(o))return;const l=`${o}|${r}`,c=t.bucketMap.get(l)??[];c.push({time:e.time,value:e.value}),t.bucketMap.set(l,c)}function Es(t,e,i,n,s,a){const r=[],o=t.yAxis.keys.map((s,a)=>t.xAxis.keys.map((o,l)=>{const c=t.bucketMap.get(`${s}|${o}`)??[],h=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e.value,0);case"max":return Math.max(...t.map(t=>t.value));case"min":return Math.min(...t.map(t=>t.value));case"last":{let e=t[0];for(const i of t)i.time>=e.time&&(e=i);return e.value}default:return t.reduce((t,e)=>t+e.value,0)/t.length}}(c,n);return null!==h&&r.push(h),{value:h,count:c.length,rangeLabel:Cs(e,i,o,0,t.xAxis.labels[l],t.yAxis.labels[a],t.xAxis.bucketRanges)}}));let l=s,c=a;if(void 0===l||void 0===c){const t=r.length?Math.min(...r):0,e=r.length?Math.max(...r):1;l=l??t,c=c??(e===t?t+1:e)}return c<=l&&(c=l+1),{xLabels:t.xAxis.labels,yLabels:t.yAxis.labels,xKeys:t.xAxis.keys,yKeys:t.yAxis.keys,cells:o,min:l,max:c}}function Ps(t,e,i){return null===t?0:Math.min(1,Math.max(0,(t-e)/(i-e)))}Xt([St({attribute:!1})],vs.prototype,"hass",void 0),Xt([zt()],vs.prototype,"_config",void 0),vs=Xt([yt(es)],vs);var Ts=ht(()=>{ds={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},us={week_hourly:{x:"hour",y:"day",period:"7d"},two_weeks:{x:"hour",y:"day",period:"14d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_days:{x:"weekday",y:"week",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},quarter:{x:"week",y:"month",period:"90d"},timeline_24h:{x:"time",y:"none",period:"24h"},timeline_48h:{x:"time",y:"none",period:"48h"},year_overview:{x:"week",y:"month",period:"365d"}},ms={timeline:"timeline_24h",custom:"week_hourly"},gs=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],ps=/* @__PURE__ */new Map,fs=/* @__PURE__ */new Map,_s=["day","week","month"]});function Ls(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function Is(t){return Ls(t)}function Os(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function qs(t,e){const i=(...t)=>{for(const e of t){if(null==e)continue;const t=Number(e);if(Number.isFinite(t))return t}};switch(e){case"mean":default:return i(t.mean,t.state);case"sum":return i(t.sum,t.change,t.state);case"max":return i(t.max,t.state,t.sum);case"min":return i(t.min,t.state);case"last":return i(t.state,t.mean);case"count":return i(t.change)}}function Rs(t){if("string"==typeof t){const e=Date.parse(t);return Number.isFinite(e)?e:void 0}return t<1e11?1e3*t:t}var Fs,Ns,js,Ds,Us,Bs,Hs;async function Gs(t,e,i,n,s,a="mean"){const r=Is(t),o=function(t){return"max"===t||"last"===t}(a);return function(t,e,i=!1){if(t.length<=e)return t;const n=Math.ceil(t.length/e),s=[];for(let a=0;a<t.length;a+=n){const e=t.slice(a,a+n);e.length&&(i?s.push(e.reduce((t,e)=>e.value>t.value||e.value===t.value&&e.time>t.time?e:t,e[0])):s.push(e[0]))}return s}(function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await r({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!o}),e),s),8e3,o)}async function Vs(t,e,i,n,s,a){const r=Is(t),o="sum"===s?["sum","change","state"]:"max"===s?["max","state","sum"]:"min"===s?["min","state"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=qs(n,e);if(null==t||!Number.isFinite(t))continue;const s=Rs(n.start);void 0!==s&&i.push({time:s,value:t})}return i}((await r({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:o}))[e]??[],s)}var Ws,Ys,Ks,Xs=ht(()=>{Ts(),Fs="nvision-heat-map-card",Ns="nvision-heat-map-card-editor",js="week_hourly",Ds="theme",Us=[{value:"week_hourly",label:"Week — hour × day"},{value:"two_weeks",label:"Two weeks — hour × day"},{value:"daily_rhythm",label:"Daily rhythm — hour × weekday"},{value:"month_days",label:"Month — weekday × week"},{value:"month_calendar",label:"Quarter calendar — weekday × week"},{value:"quarter",label:"Quarter — week × month"},{value:"timeline_24h",label:"Timeline — 24 hours"},{value:"timeline_48h",label:"Timeline — 48 hours"},{value:"year_overview",label:"Year — week × month"}],Bs=[{value:"theme",label:"Theme"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"},{value:"custom",label:"Custom"}],Hs=[{value:"auto",label:"Auto"},{value:"mean",label:"Mean"},{value:"sum",label:"Sum"},{value:"max",label:"Maximum"},{value:"min",label:"Minimum"},{value:"count",label:"Count"},{value:"last",label:"Last"}]}),Qs=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>Ks}),Zs=ht(()=>{kt(),Dt(),ie(),ne(),Xs(),Qt(),Ws=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:js,selector:{select:{options:[...Us],mode:"dropdown"}}},{name:"operation",default:"auto",selector:{select:{options:[...Hs],mode:"dropdown"}}},{name:"color_mode",required:!0,default:Ds,selector:{select:{options:[...Bs],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_cell_values",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}},{name:"dim_low_values",selector:{boolean:{}}}]}],Ys=[{type:"grid",name:"",schema:[{name:"color_low",selector:{color_rgb:{}}},{name:"color_high",selector:{color_rgb:{}}}]}],Ks=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"View":"color_mode"===t.name?"Color mode":"operation"===t.name?"Operation":"color_low"===t.name?"Low color":"color_high"===t.name?"High color":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Scale":"show_cell_values"===t.name?"Values in cells":"dim_low_values"===t.name?"Dim low values":"show_current"===t.name?"Current value":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:js,color_mode:Ds,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,...t,color_mode:"primary"===t.color_mode?"theme":t.color_mode,operation:t.operation??"auto"}}_schema(){return"custom"===this._config?.color_mode?[...Ws,...Ys]:Ws}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){const e=t.detail.value;Zt(this,"config-changed",{config:{...e,color_mode:"primary"===e.color_mode?"theme":e.color_mode}})}},Xt([zt()],Ks.prototype,"_config",void 0),Ks=Xt([yt(Ns)],Ks)});function Js(){return new Promise(t=>{"function"!=typeof requestIdleCallback?setTimeout(t,0):requestIdleCallback(()=>t(),{timeout:120})})}function ta(t){return t&&"primary"!==t?t:"theme"}function ea(t,e,i,n){const s=ta(i);return"semantic"===s?we(t,e):"temperature"===s?function(t,e){const i=ve(pe(t,"--info-color","#2196f3")),n=ve(pe(t,"--warning-color","#ff9800")),s=ve(pe(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return ye(a<=.5?be(i,n,2*a):be(n,s,2*(a-.5)))}(t,e):"custom"===s?function(t,e,i,n){return ye(be(ve(fe(i,pe(t,"--info-color","#2196f3"))),ve(fe(n,pe(t,"--error-color","#f44336"))),Math.min(1,Math.max(0,e))))}(t,e,n.color_low,n.color_high):function(t,e){const i=ve(pe(t,"--primary-color","#03a9f4")),n=ve(pe(t,"--card-background-color","#1c1c1c")),s=Math.min(1,Math.max(0,e));return ye(be(be(n,i,.18),i,.35+.65*s))}(t,e)}kt(),Dt(),Ts(),Xs(),Qt(),Ut({type:Fs,name:"Nvision Heat Map",description:"Temporal heat map for sensor history and patterns"});function ia(t,e,i,n,s){if(!s)return"rgba(0, 0, 0, 0.05)";const a=ea(t,e,i,n);return n.dim_low_values?`color-mix(in srgb, ${a} ${22+e*e*78}%, var(--card-background-color))`:a}function na(t,e,i,n=!1){if(null===t)return"—";const s="count"===e?String(Math.round(t)):Number.isInteger(t)?String(t):n?t.toFixed(0):t.toFixed(1);return i&&"count"!==e?n?s:`${s} ${i}`:s}function sa(t,e,i){return na(t,e,i,!0)}var aa=null;function ra(t,e){return aa??=document.createElement("canvas").getContext("2d"),aa?(aa.font=e,aa.measureText(t).width):6*t.length}var oa=class extends _t{constructor(...t){super(...t),this._loading=!1,this._fetchVersion=0,this._measureFrame=0}static async getConfigElement(){return await Promise.resolve().then(()=>(Zs(),Qs)),document.createElement(Ns)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return e.startsWith("sensor.")||e.startsWith("binary_sensor.")||Number.isFinite(Number(i?.state))})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Fs}`,entity:n,preset:js,operation:"auto",color_mode:Ds,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1}}_entityAttributes(){const t=this._config?.entity;if(t&&this.hass)return this.hass.states[t]?.attributes}_resolveAggregate(t){const e=this._config?.operation;if(e&&"auto"!==e)return e;const i=this._config?.entity,n=this._entityAttributes();return s=t.x,a=t.y,r=function(t,e){return Os(t)?"count":function(t,e){return!!function(t){return"string"==typeof t?.start&&"string"==typeof t?.end&&void 0!==t?.value}(e)||!!e?.last_reset||!(!t||!/_today$/i.test(t))}(t,e)?"max":function(t){const e=t?.state_class;return"total_increasing"===e||"total"===e}(e)?"last":"mean"}(i,n),"count"===r?"count":_s.includes(s)||_s.includes(a)?"max":r;var s,a,r}_computeLoadKey(){const t=this._config;if(!t?.entity)return"";const e=Ss(t.preset),i=this._entityAttributes();return JSON.stringify({entity:t.entity,preset:t.preset,operation:t.operation??"auto",stateClass:i?.state_class,aggregate:this._resolveAggregate(e),axes:e})}setConfig(t){this._config={preset:js,operation:"auto",color_mode:Ds,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t,color_mode:ta(t.color_mode)},this._loadKey=void 0}getCardSize(){const t=this._grid?.yLabels.length??4;return Math.max(3,Math.min(8,Math.ceil(.75*t)+2))}getGridOptions(){const t=this._grid?.yLabels.length??4;return{columns:6,rows:Math.max(3,Math.min(8,Math.ceil(.75*t)+2)),min_rows:3}}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(()=>this._scheduleXLabelMeasure())}disconnectedCallback(){this._resizeObserver?.disconnect(),cancelAnimationFrame(this._measureFrame),super.disconnectedCallback()}shouldUpdate(t){if(1!==t.size||!t.has("hass"))return!0;const e=t.get("hass"),i=this._config?.entity;return!(e&&this.hass&&i)||(e.states[i]!==this.hass.states[i]||e.config.time_zone!==this.hass.config.time_zone)}updated(t){if(t.has("_config")||t.has("hass")){const t=this._computeLoadKey();t&&this.hass&&t!==this._loadKey&&(this._loadKey=t,this._loadData())}t.has("_grid")&&(this._xLabelVisible=void 0),this._grid&&!1!==this._config?.show_axis_labels&&this._scheduleXLabelMeasure()}_scheduleXLabelMeasure(){cancelAnimationFrame(this._measureFrame),this._measureFrame=requestAnimationFrame(()=>this._updateXLabelVisibility())}_observeGridWrap(t){this._resizeObserver&&t!==this._observedWrap&&(this._observedWrap&&this._resizeObserver.unobserve(this._observedWrap),this._observedWrap=t,this._resizeObserver.observe(t))}_updateXLabelVisibility(){const t=this._grid,e=this.shadowRoot;if(!t||!e||!1===this._config?.show_axis_labels)return;const i=e.querySelector(".grid-wrap"),n=e.querySelector(".data-grid .cell")??e.querySelector(".timeline-grid .cell");if(!i||!n)return;this._observeGridWrap(i);const s=e.querySelector(".data-grid .cell + .cell")??e.querySelector(".timeline-slot + .timeline-slot .cell");let a=n.getBoundingClientRect().width;if(s){const t=n.getBoundingClientRect();a=s.getBoundingClientRect().left-t.left}const r=e.querySelector(".axis.x"),o=r?getComputedStyle(r).font:"500 10px Roboto, sans-serif",l=function(t,e,i,n=6){if(e<=0||!t.length)return t.map(()=>!0);const s=t.map(()=>!1);let a=-1/0;for(let r=0;r<t.length;r++){const o=t[r];if(!o)continue;const l=ra(o,i),c=(r+.5)*e;c-l/2>=a+n&&(s[r]=!0,a=c+l/2)}return s}(t.xLabels,a,o);(function(t,e){return!(!t||!e||t.length!==e.length)&&t.every((t,i)=>t===e[i])})(l,this._xLabelVisible)||(this._xLabelVisible=l)}async _loadData(){const t=this._config,e=this.hass,i=t?.entity;if(!t||!e||!i)return this._grid=void 0,void(this._error=void 0);try{Ls(e)}catch{return this._error="History unavailable",void(this._grid=void 0)}const n=++this._fetchVersion;this._loading=!0,this._error=void 0;try{const s=Ss(t.preset),a=this._resolveAggregate(s),r=await async function(t,e,i,n){const s=/* @__PURE__ */new Date,a=/* @__PURE__ */new Date(s.getTime()-60*i*60*1e3);if(Os(e)||"count"===n)return Gs(t,e,a,s,!0,n);if(i>=24&&("max"===n||"sum"===n))try{const r=await Vs(t,e,a,s,n,i>336?"day":"hour");if(function(t,e){return!!t.length&&("max"!==e&&"sum"!==e||t.some(t=>t.value>0))}(r,n))return r}catch{}if(i>=24&&"mean"===n)try{const r=await Vs(t,e,a,s,n,i>336?"day":"hour");if(r.length>0)return r}catch{}return Gs(t,e,a,s,!1,n)}(e,i,ds[s.period],a);if(n!==this._fetchVersion)return;if(await Js(),n!==this._fetchVersion)return;const o=await async function(t,e,i,n,s,a,r=0,o={}){const l=As(e,i,n,a,r),c=o.yieldEvery??250;for(let h=0;h<t.length;h++){if(!1===o.shouldContinue?.())return;zs(l,t[h],e,i,a,r),o.yieldToMain&&(h+1)%c===0&&await o.yieldToMain()}if(!1!==o.shouldContinue?.())return Es(l,e,i,s,o.minOverride,o.maxOverride)}(r,s.x,s.y,s.period,a,e.config.time_zone||"UTC",1,{shouldContinue:()=>n===this._fetchVersion,yieldToMain:Js});if(n!==this._fetchVersion||!o)return;this._grid=o}catch(s){if(n!==this._fetchVersion)return;this._error=function(t,e="Could not load history"){return t instanceof Error||"object"==typeof t&&null!==t&&"message"in t&&"string"==typeof t.message?t.message:e}(s),this._grid=void 0}finally{n===this._fetchVersion&&(this._loading=!1)}}_handleHeaderClick(t){t.stopPropagation(),this.hass&&this._config&&ts(this,this.hass,this._config,"tap")}_showPopover(t,e){const i=t.currentTarget,n=i.closest(".grid-wrap");if(!n)return;const s=i.getBoundingClientRect(),a=n.getBoundingClientRect(),r=this._config,o=r.entity?this.hass?.states[r.entity]:void 0,l=String(o?.attributes.unit_of_measurement??""),c=this._resolveAggregate(Ss(r.preset));this._popover={anchorX:s.left-a.left+s.width/2,anchorY:s.top-a.top,label:e.rangeLabel,value:na(e.value,c,"count"===c?"":l),count:e.count}}_hidePopover(){this._popover=void 0}_renderLegend(t){const e=this._config,i=ta(e.color_mode),n=e.entity?this.hass?.states[e.entity]:void 0,s=String(n?.attributes.unit_of_measurement??""),a=this._resolveAggregate(Ss(e.preset)),r=`linear-gradient(to bottom, ${Array.from({length:12},(t,n)=>{const s=n/11,a=(100*s).toFixed(1);return`${ia(this,s,i,e,!0)} ${a}%`}).join(", ")})`,o=(t.min+t.max)/2;return V`
      <div class="legend-wrap" aria-hidden="true">
        <div class="legend-labels">
          <span>${sa(t.max,a,s)}</span>
          <span>${sa(o,a,s)}</span>
          <span>${sa(t.min,a,s)}</span>
        </div>
        <div
          class="legend-bar"
    ...
    `}_renderCell(t,e,i,n,s,a,r){const o=Ps(t.value,n.min,n.max),l=null!==t.value;return V`
      <div
        class=${Yn({cell:!0,empty:!l,"has-value":l})}
        tabindex=${l?0:K}
        style=${ge({background:ia(this,o,e,i,l)})}
    ...
    `:K}_renderGrid(t){const e=this._config,i=ta(e.color_mode),n=!1!==e.show_axis_labels,s=!0===e.show_cell_values,a=!1!==e.show_legend,r=e.entity?this.hass?.states[e.entity]:void 0,o=String(r?.attributes.unit_of_measurement??""),l=this._resolveAggregate(Ss(e.preset)),c=n?2:1,h=this._xLabelVisible??t.xLabels.map(()=>!0);if(function(t){return 1===t.yKeys.length&&""===t.yKeys[0]}(t))return this._renderTimelineGrid(t,e,i,n,s,a,l,o,h);const d={"--heatmap-columns":String(Math.max(1,t.xLabels.length))},u=`repeat(${t.yLabels.length}, minmax(0, 1fr))`,m=n?`minmax(24px, clamp(32px, 16%, 56px)) repeat(${t.xLabels.length}, minmax(0, 1fr))`:`repeat(${t.xLabels.length}, minmax(0, 1fr))`;return V`
            ...
            <div class="grid-wrap">
              ...
              >
                    ${t.cells.flatMap((a,r)=>{const h=r+1;return[n?V`
                          ...
                          `:K,...a.map((n,a)=>{const r=Ps(n.value,t.min,t.max),d=null!==n.value;return V`
                          <div
                            class=${Yn({cell:!0,empty:!d,"has-value":d})}
                            tabindex=${d?0:K}
                            style=${ge({gridColumn:String(a+c),gridRow:String(h),background:ia(this,r,i,e,d)})}
  ...
  `]}};Xt([St({attribute:!1})],oa.prototype,"hass",void 0),Xt([zt()],oa.prototype,"_config",void 0),Xt([zt()],oa.prototype,"_grid",void 0),Xt([zt()],oa.prototype,"_loading",void 0),Xt([zt()],oa.prototype,"_error",void 0),Xt([zt()],oa.prototype,"_popover",void 0),Xt([zt()],oa.prototype,"_xLabelVisible",void 0),oa=Xt([yt(Fs)],oa),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");