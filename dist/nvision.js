...
`,Kt=ht(()=>{Ht="nvision-blank-card",Gt="nvision-blank-card-editor"});function Qt(t,e,i,n){var s,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var o=t.length-1;o>=0;o--)(s=t[o])&&(r=(a<3?s(r):a>3?s(e,i,r):s(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r}var Xt=ht(()=>{});function Zt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}var Jt,te,ee,ie=ht(()=>{}),ne=ht(()=>{kt(),Xt(),Jt=class extends _t{},Qt([St({attribute:!1})],Jt.prototype,"hass",void 0)}),se=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ee}),ae=ht(()=>{kt(),Ut(),ie(),ne(),Kt(),Xt(),te=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}}],ee=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${te}
      ...
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Qt([zt()],ee.prototype,"_config",void 0),ee=Qt([yt(Gt)],ee)});kt(),Ut(),Kt(),Xt(),Dt({type:Ht,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var re=class extends _t{static async getConfigElement(){return await Promise.resolve().then(()=>(ae(),se)),document.createElement(Gt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Ht}`,entity:n}}setConfig(t){this._config=t}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Bt(t);return V`
      <ha-card>
        <div class="content">
          ${t?V`<ha-state-icon
                .hass=${this.hass}
  ...
  `]}};Qt([St({attribute:!1})],re.prototype,"hass",void 0),Qt([zt()],re.prototype,"_config",void 0),re=Qt([yt(Ht)],re);var oe=1,le=t=>(...e)=>({_$litDirective$:t,values:e}),ce=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};wt();var he,de,ue,me,ge=le(class extends ce{constructor(t){if(super(t),t.type!==oe||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const n=t[i];return null==n?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const n of this.ft)e[n]??(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in e){const t=e[n];if(null!=t){this.ft.add(n);const e="string"==typeof t&&t.endsWith(" !important");n.includes("-")||e?i.setProperty(n,e?t.slice(0,-11):t,e?"important":""):i[n]=t}}return Y}});function pe(t,e,i){return getComputedStyle(t).getPropertyValue(e).trim()||i}function fe(t,e){if(!t)return e;if(Array.isArray(t)&&t.length>=3)return`rgb(${t[0]}, ${t[1]}, ${t[2]})`;if("string"==typeof t){const e=t.split(",").map(t=>Number(t.trim()));return e.length>=3&&e.every(t=>Number.isFinite(t))?`rgb(${e[0]}, ${e[1]}, ${e[2]})`:t}return e}function _e(t,e,i,n){return fe(t,pe(e,i,n))}function ve(t){he??=document.createElement("canvas"),he.width=1,he.height=1;const e=he.getContext("2d");if(!e)return[41,182,246];e.fillStyle="#000000",e.fillStyle=t,e.fillRect(0,0,1,1);const[i,n,s]=e.getImageData(0,0,1,1).data;return[i,n,s]}function ye([t,e,i]){return`rgb(${t}, ${e}, ${i})`}function be(t,e,i){return[Math.round(t[0]+(e[0]-t[0])*i),Math.round(t[1]+(e[1]-t[1])*i),Math.round(t[2]+(e[2]-t[2])*i)]}function xe(t,e){return e>=0?be(t,[255,255,255],e):be(t,[0,0,0],-e)}function we(t,e){const i=ve(pe(t,"--success-color","#4caf50")),n=ve(pe(t,"--warning-color","#ff9800")),s=ve(pe(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return ye(a<=.5?be(i,n,2*a):be(n,s,2*(a-.5)))}function $e(t,e){const i=ve(pe(t,"--info-color","#2196f3")),n=ve(pe(t,"--warning-color","#ff9800")),s=ve(pe(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return ye(a<=.5?be(i,n,2*a):be(n,s,2*(a-.5)))}function Me(t,e){const i=ve(pe(t,"--primary-color","#03a9f4")),n=ve(pe(t,"--card-background-color","#1c1c1c")),s=ve(pe(t,"--state-inactive-color","#6b7280")),a=Math.min(1,Math.max(0,e));return ye(be(be(be(n,s,.35),i,.06),i,.15+.85*a))}function ke(t,e,i,n){return ye(be(ve(fe(i,pe(t,"--info-color","#2196f3"))),ve(fe(n,pe(t,"--error-color","#f44336"))),Math.min(1,Math.max(0,e))))}function Ce(t,e,i,n,s=12){return`linear-gradient(to bottom, ${Array.from({length:s},(a,r)=>{const o=r/(s-1),l=(100*o).toFixed(1);return`${(s=>"primary"===e?Me(t,s):"semantic"===e?we(t,s):"temperature"===e?$e(t,s):"custom"===e?ke(t,s,i,n):Me(t,s))(o)} ${l}%`}).join(", ")})`}var Se,Ae,ze=ht(()=>{de="nvision-activity-card",ue="nvision-activity-card-editor",me={still:"idle",unknown:"idle",on_foot:"on_foot",walking:"walking",running:"running",on_bicycle:"bicycle",in_vehicle:"vehicle",automotive:"vehicle",tilting:"tilting"}}),Ee=/* @__PURE__ */dt({NvisionActivityCardEditor:()=>Ae}),Pe=ht(()=>{kt(),Ut(),ie(),ne(),ze(),Xt(),Se=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"color",selector:{color_rgb:{}}},{name:"speed",required:!0,default:1,selector:{number:{min:.25,max:3,step:.05}}}],Ae=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"color"===t.name?"Figure color":"speed"===t.name?"Animation speed":"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={speed:1,...t}}render(){return this.hass&&this._config?V`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Qt([zt()],Ae.prototype,"_config",void 0),Ae=Qt([yt(ue)],Ae)});function Te(t,e,i){const n=.7*i;return W`
  ...
  `]}};Qt([St({attribute:!1})],Ri.prototype,"hass",void 0),Qt([zt()],Ri.prototype,"_config",void 0),Qt([Lt("canvas")],Ri.prototype,"_canvas",void 0),Ri=Qt([yt(ei)],Ri);var qi=ht(()=>{$i="nvision-waveform-card",Mi="nvision-waveform-card-editor",ki=.72,Ci=.78,Si=.45,Ai="line",zi="balanced",Ei="surge",Pi={wave:"surge",echo:"spawn",pulse:"surge",stream:"jet",spectrum:"surge",cascade:"spawn"},Ti={line:"line",circle:"ring",grid:"field"},Ii=[{value:"line",label:"Line"},{value:"ring",label:"Ring"},{value:"field",label:"Field"}],Li=[{value:"compact",label:"Compact"},{value:"balanced",label:"Balanced"},{value:"expansive",label:"Expansive"}],Oi=[{value:"surge",label:"Surge"},{value:"spawn",label:"Spawn"},{value:"jet",label:"Jet stream"}]});function Ni(t){return t-Math.floor(t)}qi();var Fi={compact:{dotScale:.88,span:.94,phaseSpeed:.92},balanced:{dotScale:1,span:.98,phaseSpeed:1},expansive:{dotScale:1.08,span:1,phaseSpeed:1.08}},ji={line:{compact:16,balanced:24,expansive:32},ring:{compact:18,balanced:24,expansive:32},field:{compact:16,balanced:25,expansive:36}};function Ui(t){return t*t*(3-2*t)}function Di(t,e){const i=Math.max(.08,t),n=Ui(i);return e*(.28+.16*(1-n)+.22*n+.26*Math.max(0,i-.5)**2)}function Bi(t){if("ring"===t.layout){const e=t.width/2,i=t.height/2,n=Math.atan2(t.baseY-i,t.baseX-e);return{primary:{x:-Math.sin(n),y:Math.cos(n)},perp:{x:Math.cos(n),y:Math.sin(n)}}}return{primary:{x:0,y:1},perp:{x:1,y:0}}}function Hi(t,e){const{x:i,y:n}=function(t,e,i){const{dot:n,index:s,phase:a,intensity:r,variant:o,height:l}=t;if(r<=.38)return{x:e,y:i};const c=Bi(t),h=(a+1.4*o)*(1+.18*r),d=s+.47*o,u=r*r;let m=Math.sin(h*(3.1+2.4*n.seed)+.85*d)*l*u*.12;if(r>.45){const t=(r-.45)**2;m+=Math.cos(7.4*h+1.7*d+n.phase+o)*l*t*.18,m+=Math.sin(8.2*h+2.1*d)*l*t*.1}return{x:e+c.perp.x*m,y:i+c.perp.y*m}}(t,e.x,e.y);return{...e,x:i,y:n}}function Gi(t){const e=function(t){return t.layout?t.layout:t.shape?Ti[t.shape]??"line":Ai}(t),i=function(t){if(t.size)return t.size;const e=t.dot_count;if(void 0!==e){if(e<=18)return"compact";if(e>=30)return"expansive"}return zi}(t),n=function(t){return t.motion?Pi[t.motion]??t.motion:t.overlap_dots?"spawn":Ei}(t),s=Fi[i];return{layout:e,size:i,motion:n,dotCount:ji[e][i],dotScale:s.dotScale,span:s.span,phaseSpeed:s.phaseSpeed}}function Vi(t){return Array.from({length:t},(e,i)=>{const n=.618033988749895*i%1;return{phase:i/t*Math.PI*2,seed:n,sign:n>.5?1:-1}})}function Wi(t){return.5*t}var Yi={spawn:function(t){const{dot:e,phase:i,intensity:n,height:s,width:a,baseX:r,baseY:o,layout:l}=t,c=Ui(n),h=3.6-1.4*c,d=Ni(i*(.05+c*c*1.15)*(.06+.22*c)+e.seed*h),u=Math.sin(d*Math.PI),m=Di(n,s)*d*(.85+.45*c),g=e.sign;if("ring"===l){const e=a/2,i=s/2,n=Math.atan2(o-i,r-e),l=.06*Math.min(a,s),h=Math.hypot(r-e,o-i),m=h*(.18+.55*c),p=Math.max(l,h+g*d*m);return Hi(t,{x:e+Math.cos(n)*p,y:i+Math.sin(n)*p,radiusMul:.52+u*(.65+.35*c),alphaMul:u*(.32+.58*c)})}const p=Bi(t),f=m*g*(.45+.35*e.seed);return Hi(t,{x:r+p.primary.x*f,y:o+p.primary.y*f,radiusMul:.5+u*(.62+.38*c),alphaMul:u*(.32+.58*c)})},jet:function(t){const{dot:e,index:i,count:n,phase:s,intensity:a,height:r,width:o,baseX:l,baseY:c,layout:h}=t,d=Ui(Math.max(.1,a)),u=.16+.78*d,m=u*(.4+1.35*e.seed),g=Di(a,r)*(.035+.1*d),p=Math.sin(s*(1.6+.8*e.seed)+9.4*e.seed)*g,f=m/(1.75*u),_=.58+.32*f+.28*d;if("ring"===h){const a=o/2,l=r/2,c=.06*Math.min(o,r),h=Math.min(o,r)/2-c,u=i/n*Math.PI*2-Math.PI/2+.35*e.seed,g=Ni(s*(.05+d*d*.24)*m+2.6*e.seed),p=h+g*(h*(.2+.75*d)),v=1-g;return Hi(t,{x:a+Math.cos(u)*p,y:l+Math.sin(u)*p,radiusMul:_*(.88+.22*(1-g)),alphaMul:(.38+.18*f+.32*d)*v})}const v=.12*o,y=c+p;return Hi(t,{x:Ni(s*m*.32+2.1*e.seed+.04*i)*(o+2*v)-v,y:y,radiusMul:_,alphaMul:.42+.2*f+.4*d})},surge:function(t){const{index:e,count:i,phase:n,intensity:s,height:a,baseX:r,baseY:o,layout:l}=t,c=Ui(s),h=Di(s,a),d=function(t){return.42+.68*Ui(Math.max(.08,t))}(s),u=e%2==0,m=n*d-e/Math.max(1,i-1)*Math.PI*1.6,g=.5*Math.sin(m)+.5,p=h*(.25+g*(.55+.65*c)),f=.06*a,_=.58+g*(.28+.42*c);if("ring"===l){const n=t.width/2,s=t.height/2,a=e/i*Math.PI*2-Math.PI/2,l=u?-1:1,h=Math.hypot(r-n,o-s)+l*p*.85;return Hi(t,{x:n+Math.cos(a)*h,y:s+Math.sin(a)*h,radiusMul:_,alphaMul:.4+g*(.28+.48*c)})}return Hi(t,{x:r,y:u?f+p:a-f-p,radiusMul:_,alphaMul:.38+g*(.3+.5*c)})}};function Ki(t,e,i,n,s,a,r,o,l){const c=Math.min(r,o),h=function(t,e,i,n,s,a){const r=Math.min(n,s),o=.04*r;switch(t){case"ring":{const t=n/2,o=s/2,l=.06*r,c=(Math.min(n,s)/2-l)*(.92+.06*a),h=(e+.5)/i*Math.PI*2-Math.PI/2;return{x:t+Math.cos(h)*c,y:o+Math.sin(h)*c}}case"field":{const t=Math.ceil(Math.sqrt(i)),o=Math.ceil(i/t),l=.04*r,c=.04*r,h=.028*r*a,d=(n-2*l-h*(t-1))/t,u=(s-2*c-h*(o-1))/o;return{x:l+e%t*(d+h)+d/2,y:c+Math.floor(e/t)*(u+h)+u/2}}default:{const t=n-o,r=(t-o)*a;return{x:(o+t-r)/2+(i<=1?.5:e/(i-1))*r,y:Wi(s)}}}}(t.layout,i,n,r,o,t.span),d={dot:e,index:i,count:n,phase:s,intensity:a,scale:c,baseX:h.x,baseY:h.y,width:r,height:o,variant:l,layout:t.layout};return Yi[t.motion](d)}function Qi(t,e,i,n){const s=.04*i,a=.58*i;let r=1;t<a&&(r=t<=s?.06:.06+.94*Ui((t-s)/(a-s)));const o=.5*n,l=.42*n,c=Math.abs(e-o);let h=1;return t<a&&c<l&&(h=.08+.92*Ui(c/l)),r*h}function Xi(t,e,i,n,s,a){if("ring"===a)return 1;const r=Math.max(4,.06*s),o=Math.max(3,.04*s),l=Math.min(1,Math.max(0,t/r)),c=Math.min(1,Math.max(0,(i-t)/r)),h=Math.min(1,Math.max(0,e/o)),d=Math.min(1,Math.max(0,(n-e)/o));return"line"===a?Math.min(l,c):Math.min(l,c,h,d)}var Zi,Ji,tn=/* @__PURE__ */dt({NvisionWaveformCardEditor:()=>Ji}),en=ht(()=>{kt(),Ut(),ie(),ne(),qi(),Xt(),Zi=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{name:"color",selector:{color_rgb:{}}},{type:"grid",name:"",schema:[{name:"layout",required:!0,default:Ai,selector:{select:{options:[...Ii],mode:"dropdown"}}},{name:"size",required:!0,default:zi,selector:{select:{options:[...Li],mode:"dropdown"}}}]},{name:"motion",required:!0,default:Ei,selector:{select:{options:[...Oi],mode:"dropdown"}}},{name:"shake_speed",required:!0,default:Si,selector:{number:{min:.15,max:1.5,step:.05}}}],Ji=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color"===t.name?"Waveform color":"layout"===t.name?"Layout":"size"===t.name?"Size":"motion"===t.name?"Motion":"shake_speed"===t.name?"Shake speed":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,layout:Ai,size:zi,motion:Ei,shake_speed:Si,...t}}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Zi}
  ...
  `]}};Qt([St({attribute:!1})],qn.prototype,"hass",void 0),Qt([zt()],qn.prototype,"_config",void 0),Qt([zt()],qn.prototype,"_gaugeReady",void 0),Qt([zt()],qn.prototype,"_tick",void 0),qn=Qt([yt(bn)],qn);var Nn,Fn,jn=ht(()=>{On="nvision-power-draw-card",Rn="nvision-power-draw-card-editor"}),Un=/* @__PURE__ */dt({NvisionPowerDrawCardEditor:()=>Fn}),Dn=ht(()=>{kt(),Ut(),ie(),ne(),ri(),jn(),Xt(),Nn=[{name:"entity",selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:Ie,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"effects_min",required:!0,default:0,selector:{number:{min:0,max:1,step:.05}}},{name:"effects_max",required:!0,default:1,selector:{number:{min:0,max:1,step:.05}}}]},{name:"color",selector:{color_rgb:{}}},{name:"icon",selector:{icon:{}}}],Fn=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum watts":"max"===t.name?"Maximum watts":"effects_min"===t.name?"Minimum effect":"effects_max"===t.name?"Maximum effect":"color"===t.name?"Lightning color":"icon"===t.name?"Source icon":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:Ie,effects_min:0,effects_max:1,...t}}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Nn}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Qt([zt()],Fn.prototype,"_config",void 0),Fn=Qt([yt(Rn)],Fn)});kt(),Ut(),ri(),jn(),Xt(),Dt({type:On,name:"Nvision Power Draw",description:"Power consumption with animated lightning from a plug"});var Bn,Hn,Gn=class extends _t{constructor(...t){super(...t),this._displayIntensity=0}static async getConfigElement(){return await Promise.resolve().then(()=>(Dn(),Un)),document.createElement(Rn)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return"power"===i?.attributes.device_class||e.includes("power")||void 0!==Ke(i?.state)})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${On}`,entity:n,min:0,max:Ie}}setConfig(t){this._config={min:0,max:Ie,effects_min:0,effects_max:1,...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}disconnectedCallback(){this._renderer?.detach(),super.disconnectedCallback()}firstUpdated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}updated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}_lightningColor(){return Fe(this._config?.color,this)}_overMaxColor(){return He(this)}_rawValue(){const t=this._config?.entity;return Ke(t?this.hass?.states[t]?.state:void 0)}_overMaxSeverity(){const t=this._rawValue();return void 0===t?0:Be(t,this._config?.min??0,this._config?.max??3e3)}_syncLightningTheme(){const t=this._overMaxSeverity()>0?this._overMaxColor():this._lightningColor();this.style.setProperty("--lightning-color",t),this.style.setProperty("--lightning-glow",String(De(this._displayIntensity)))}_targetIntensity(){return Ue(this._rawValue(),this._config??{})}_tickIntensity(t){const e=this._targetIntensity(),i=e-this._displayIntensity;return Math.abs(i)<.001?this._displayIntensity=e:this._displayIntensity+=i*Le*t,this._syncLightningTheme(),this._displayIntensity}_ensureRenderer(){const t=this._canvas;t&&(this._renderer||(this._renderer=new Re(this,t=>this._buildArcs(t),()=>this._lightningColor(),t=>{this._tickIntensity(t)})),this._renderer.attach(t))}_buildArcs(t){const e=this._canvas;if(!e)return[];const i=Xe(this._plug,e,"center"),n=Xe(this._entityIcon,e,"center");if(!i||!n)return[];const s=this._overMaxSeverity(),a=s>0?this._overMaxColor():this._lightningColor(),r=[{from:i,to:n,intensity:this._displayIntensity,color:a}];if(s>0){const{width:i,height:o}=e.getBoundingClientRect();We(r,n,i,o,s,t,a)}return r}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Power Draw",i=Bt(t);return V`
  ...
  `]}};Qt([St({attribute:!1})],Gn.prototype,"hass",void 0),Qt([zt()],Gn.prototype,"_config",void 0),Qt([Lt("canvas")],Gn.prototype,"_canvas",void 0),Qt([Lt(".plug")],Gn.prototype,"_plug",void 0),Qt([Lt(".entity-icon")],Gn.prototype,"_entityIcon",void 0),Gn=Qt([yt(On)],Gn);var Vn,Wn,Yn=ht(()=>{Bn="nvision-power-glance-card",Hn="nvision-power-glance-card-editor"}),Kn=/* @__PURE__ */dt({NvisionPowerGlanceCardEditor:()=>Wn}),Qn=ht(()=>{kt(),Ut(),ie(),ne(),ri(),Yn(),Xt(),Vn=[{name:"entities",selector:{entity:{multiple:!0,domain:"sensor"}}},{name:"columns",default:3,selector:{number:{min:1,max:6,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:Ie,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"effects_min",required:!0,default:0,selector:{number:{min:0,max:1,step:.05}}},{name:"effects_max",required:!0,default:1,selector:{number:{min:0,max:1,step:.05}}}]},{name:"color",selector:{color_rgb:{}}},{name:"icon",selector:{icon:{}}}],Wn=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"columns"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.columns"):"min"===t.name?"Minimum watts":"max"===t.name?"Maximum watts":"effects_min"===t.name?"Minimum effect":"effects_max"===t.name?"Maximum effect":"color"===t.name?"Lightning color":"icon"===t.name?"Source icon":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={entities:[],columns:3,min:0,max:Ie,effects_min:0,effects_max:1,...t}}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Vn}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Qt([zt()],Wn.prototype,"_config",void 0),Wn=Qt([yt(Hn)],Wn)});kt(),Ut(),ri(),Yn(),Xt(),Dt({type:Bn,name:"Nvision Power Glance",description:"Multiple power sensors with lightning from a bottom plug"});var Xn=class extends _t{constructor(...t){super(...t),this._displayIntensities=/* @__PURE__ */new Map}static async getConfigElement(){return await Promise.resolve().then(()=>(Qn(),Kn)),document.createElement(Hn)}static getStubConfig(t,e,i){const n=[...e,...i,...Object.keys(t.states)],s=/* @__PURE__ */new Set,a=[];for(const r of n){if(s.has(r))continue;s.add(r);const e=t.states[r];if(("power"===e?.attributes.device_class||r.includes("power")||void 0!==Ke(e?.state))&&a.push(r),a.length>=4)break}return{type:`custom:${Bn}`,entities:a.length?a:n.slice(0,3),columns:3,min:0,max:Ie}}setConfig(t){this._config={entities:[],columns:3,min:0,max:Ie,effects_min:0,effects_max:1,...t},this._syncGridColumns()}_syncGridColumns(){const t=this._config?.columns??3,e=this._config?.entities?.length??0,i=e>0?Math.min(t,e):t;this.style.setProperty("--columns",String(i))}getCardSize(){const t=this._config?.entities?.length??1,e=this._config?.columns??3;return Math.max(1,Math.ceil(t/e))}getGridOptions(){return{columns:6,rows:this.getCardSize()}}connectedCallback(){super.connectedCallback()}disconnectedCallback(){this._renderer?.detach(),super.disconnectedCallback()}firstUpdated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}updated(){this._syncGridColumns(),this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}_lightningColor(){return Fe(this._config?.color,this)}_overMaxColor(){return He(this)}_entitySeverity(t){const e=Ke(this.hass?.states[t]?.state);return void 0===e?0:Be(e,this._config?.min??0,this._config?.max??3e3)}_rawValues(){return this._entityIds().map(t=>Ke(this.hass?.states[t]?.state))}_overMaxSeverity(){return function(t,e){const i=e.min??0,n=e.max??3e3;return t.reduce((t,e)=>Math.max(t,void 0!==e?Be(e,i,n):0),0)}(this._rawValues(),this._config??{})}_syncLightningTheme(){const t=this._lightningColor(),e=this._overMaxColor(),i=this._overMaxSeverity()>0;this.style.setProperty("--lightning-color",t);const n=this._entityIds(),s=this._entityIcons?Array.from(this._entityIcons):[];let a=De(0);n.forEach((i,n)=>{const r=De(this._displayIntensities.get(i)??0);a=Math.max(a,r);const o=s[n];o?.style.setProperty("--lightning-glow",String(r)),o?.style.setProperty("--lightning-color",this._entitySeverity(i)>0?e:t)}),this._plug?.style.setProperty("--lightning-glow",String(a)),this._plug?.style.setProperty("--lightning-color",i?e:t)}_entityIds(){return this._config?.entities??[]}_targetIntensity(t){const e=this.hass?.states[t]?.state;return Ue(Ke(e),this._config??{})}_tickIntensities(t){for(const e of this._entityIds()){const i=this._targetIntensity(e),n=this._displayIntensities.get(e)??0,s=i-n;Math.abs(s)<.001?this._displayIntensities.set(e,i):this._displayIntensities.set(e,n+s*Le*t)}this._syncLightningTheme()}_ensureRenderer(){const t=this._canvas;t&&(this._renderer||(this._renderer=new Re(this,t=>this._buildArcs(t),()=>this._lightningColor(),t=>this._tickIntensities(t))),this._renderer.attach(t))}_buildArcs(t){const e=this._canvas;if(!e)return[];const i=Xe(this._plug,e,"center");if(!i)return[];const n=this._entityIcons?Array.from(this._entityIcons):[],s=this._entityIds(),a=this._lightningColor(),r=this._overMaxColor(),{width:o,height:l}=e.getBoundingClientRect(),c=[];return s.forEach((s,h)=>{const d=Xe(n[h],e,"center"),u=this._displayIntensities.get(s)??0,m=this._entitySeverity(s);if(!d)return;const g=m>0?r:a;c.push({from:i,to:d,intensity:u,color:g}),m>0&&We(c,d,o,l,m,t,r)}),c}render(){if(!this._config||!this.hass)return K;const t=this._entityIds();return V`
      <ha-card class=${this._overMaxSeverity()>0?"over-max":""}>
        <div class="stage">
          <div class="entities">
  ...
  `]}};Qt([St({attribute:!1})],Xn.prototype,"hass",void 0),Qt([zt()],Xn.prototype,"_config",void 0),Qt([Lt("canvas")],Xn.prototype,"_canvas",void 0),Qt([Lt(".plug")],Xn.prototype,"_plug",void 0),Qt([function(t){return(e,i)=>Et(e,i,{get(){return(this.renderRoot??(Ot??=document.createDocumentFragment())).querySelectorAll(t)}})}(".entity-icon")],Xn.prototype,"_entityIcons",void 0),Xn=Qt([yt(Bn)],Xn),wt();var Zn=le(class extends ce{constructor(t){if(super(t),t.type!==oe||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=/* @__PURE__ */new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const n of this.st)n in e||(i.remove(n),this.st.delete(n));for(const n in e){const t=!!e[n];t===this.st.has(n)||this.nt?.has(n)||(t?(i.add(n),this.st.add(n)):(i.remove(n),this.st.delete(n)))}return Y}});function Jn(t){const e=t.attributes.brightness;return e&&"on"===t.state?`brightness(${(e+245)/5}%)`:""}function ts(t){const e=Math.max(1e3,Math.min(4e4,t))/100;let i,n,s;return e<=66?(i=255,n=Math.min(255,Math.max(0,99.4708025861*Math.log(e)-161.1195681661)),s=e<=19?0:Math.min(255,Math.max(0,138.5177312231*Math.log(e-10)-305.0447927307))):(i=Math.min(255,Math.max(0,329.698727446*(e-60)**-.1332047592)),n=Math.min(255,Math.max(0,288.1221695283*(e-60)**-.0755148492)),s=255),[Math.round(i),Math.round(n),Math.round(s)]}function es(t){if("on"!==t.state)return;const e=t.attributes.rgb_color;if(e)return e;const i=t.attributes.color_temp_kelvin;if("number"==typeof i)return ts(i);const n=t.attributes.color_temp;if("number"==typeof n&&n>0)return ts(Math.round(1e6/n));const s=t.attributes.hs_color;return s?function(t,e,i){const n=e/100,s=i/100,a=(1-Math.abs(2*s-1))*n,r=t/60,o=a*(1-Math.abs(r%2-1));let l=0,c=0,h=0;r>=0&&r<1?(l=a,c=o):r<2?(l=o,c=a):r<3?(c=a,h=o):r<4?(c=o,h=a):r<5?(l=o,h=a):(l=a,h=o);const d=s-a/2;return[Math.round(255*(l+d)),Math.round(255*(c+d)),Math.round(255*(h+d))]}(s[0],s[1],50):void 0}ie();var is={tap:"toggle",hold:"more-info",double_tap:"none"},ns={tap:"tap_action",hold:"hold_action",double_tap:"double_tap_action"};function ss(t,e,i,n){const s=i[ns[n]],a=s?.action??is[n];if("none"===a)return;const r=s?.entity??i.entity;if(r)switch(a){case"toggle":return void e.callService("homeassistant","toggle",{entity_id:r});case"more-info":return void Zt(t,"hass-more-info",{entityId:r});case"navigate":return void(s?.navigation_path&&Zt(t,"hass-navigate",{navigation_path:s.navigation_path}));case"url":return void(s?.url_path&&window.open(s.url_path));case"call-service":if(s?.service){const[t,i]=s.service.split(".",2);e.callService(t,i,s.service_data,s.target)}return;default:return}}var as,rs,os,ls,cs="nvision-light-glow-stack";var hs,ds,us=ht(()=>{as="nvision-light-card",rs="nvision-light-card-editor",os=.72,ls=.62}),ms=/* @__PURE__ */dt({NvisionLightCardEditor:()=>ds}),gs=ht(()=>{kt(),Ut(),ie(),ne(),us(),Xt(),hs=[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{type:"grid",name:"",schema:[{name:"glow_size",required:!0,default:165,selector:{number:{min:20,max:300,step:5,unit_of_measurement:"%"}}},{name:"glow_intensity",required:!0,default:os,selector:{number:{min:0,max:1,step:.05}}}]},{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}],ds=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"glow_size"===t.name?"Glow size":"glow_intensity"===t.name?"Glow intensity":"interactions"===t.name?"Interactions":"hold_action"===t.name||"double_tap_action"===t.name?`${this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)} (${this.hass.localize("ui.panel.lovelace.editor.card.config.optional")})`:this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={tap_action:{action:"toggle"},hold_action:{action:"more-info"},glow_size:165,glow_intensity:os,...t}}render(){return this.hass&&this._config?V`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Qt([zt()],ds.prototype,"_config",void 0),ds=Qt([yt(rs)],ds)});kt(),Ut(),ie(),us(),Xt(),Dt({type:as,name:"Nvision Light",description:"Light control with ambient color glow"}),function(t){if("undefined"==typeof document||document.getElementById(cs))return;const e=document.createElement("style");e.id=cs,e.textContent=`\n    hui-card:has(${t}),\n    .card:has(${t}) {\n      position: relative;\n      z-index: 0;\n      overflow: visible;\n    }\n\n    hui-card:not(:has(${t})),\n    .card:not(:has(${t})) {\n      position: relative;\n      z-index: 1;\n    }\n\n    section:has(${t}) {\n      position: relative;\n      z-index: 0;\n    }\n\n    section:not(:has(${t})) {\n      position: relative;\n      z-index: 1;\n    }\n\n    section .meta {\n      position: relative;\n      z-index: 2;\n    }\n\n    .preview:has(${t}) {\n      overflow: visible;\n    }\n  `,document.head.appendChild(e)}(as);var ps,fs,_s,vs,ys,bs,xs=class extends _t{constructor(...t){super(...t),this._holdTriggered=!1}static async getConfigElement(){return await Promise.resolve().then(()=>(gs(),ms)),document.createElement(rs)}static getStubConfig(t,e,i){const n=e.find(t=>t.startsWith("light."))||i.find(t=>t.startsWith("light."))||Object.keys(t.states).find(t=>t.startsWith("light."))||e[0]||i[0]||"";return{type:`custom:${as}`,entity:n,glow_size:165,glow_intensity:os}}setConfig(t){if(!t.entity||"light"!==t.entity.split(".")[0])throw new Error("Specify an entity from within the light domain");this._config={tap_action:{action:"toggle"},hold_action:{action:"more-info"},glow_size:165,glow_intensity:os,...t}}getCardSize(){return 5}getGridOptions(){return{columns:6,rows:5,min_rows:3}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0;if(!t)return V`
        <ha-card>
  ...
  `}};function ws(t){return String(t).padStart(2,"0")}function $s(t,e){const i=Object.fromEntries(function(t){let e=ys.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),ys.set(t,e)),e}(e).formatToParts(new Date(t)).map(t=>[t.type,t.value])),n=vs.indexOf(String(i.weekday))>=0?vs.indexOf(String(i.weekday)):0,s=Number(i.year),a=Number(i.month),r=Number(i.day);return{year:s,month:a,day:r,hour:Number(i.hour)%24,weekday:n,dateKey:`${s}-${ws(a)}-${ws(r)}`,monthKey:`${s}-${ws(a)}`}}function Ms(t,e,i){const n=$s(ks(t,e,i),e);return`${n.year}-${ws(n.month)}-${ws(n.day)}`}function ks(t,e,i){const n=$s(t,e),s=(n.weekday-i+7)%7;return Cs(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function Cs(t,e,i,n,s,a){const r=Date.UTC(t,e-1,i,n,s,0),o=Object.fromEntries(function(t){let e=bs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),bs.set(t,e)),e}(a).formatToParts(new Date(r)).map(t=>[t.type,t.value]));return r-(Date.UTC(Number(o.year),Number(o.month)-1,Number(o.day),Number(o.hour),Number(o.minute),0)-r)}function Ss(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...$s(t,e),weekKey:Ms(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function As(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>vs[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=$s(t.startMs,e);let s=Cs(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=$s(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=ks(t.startMs,e,i);for(;s<=t.endMs;){const t=$s(s,e);n.push({key:t.weekKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=$s(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${ws(a)}`;if(i.push({key:n,label:`${s}-${ws(a)}`}),a+=1,a>12&&(a=1,s+=1),Cs(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const r=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const o of r)a.set(o.key,`${new Date(o.start).toLocaleString()} – ${new Date(o.end).toLocaleString()}`);return{keys:r.map(t=>t.key),labels:r.map(t=>t.label),bucketRanges:a}}function zs(t,e,i,n,s,a,r){return"time"===t?r.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function Es(t){return fs[t&&_s[t]||(t&&t in fs?t:void 0)||"week_hourly"]}function Ps(t,e,i,n,s,a,r=0,o,l){const c=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(ps[n]),h=(d=c.hours)<=24||d<=48||d<=336?36e5:864e5;var d;const u=As(e,c,a,r,h),m=As(i,c,a,r,h),g=new Set(u.keys),p=new Set(m.keys),f=/* @__PURE__ */new Map;for(const x of t){if(x.time<c.startMs||x.time>c.endMs)continue;const t=Ss(e,x.time,a,h,r),n=Ss(i,x.time,a,h,r);if(void 0===t||void 0===n)continue;if(!g.has(t)||!p.has(n))continue;const s=`${n}|${t}`,o=f.get(s)??[];o.push(x.value),f.set(s,o)}const _=[],v=m.keys.map((t,n)=>u.keys.map((a,r)=>{const o=f.get(`${t}|${a}`)??[],l=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e,0);case"max":return Math.max(...t);case"min":return Math.min(...t);case"last":return t[t.length-1];default:return t.reduce((t,e)=>t+e,0)/t.length}}(o,s);return null!==l&&_.push(l),{value:l,count:o.length,rangeLabel:zs(e,i,a,0,u.labels[r],m.labels[n],u.bucketRanges)}}));let y=o,b=l;if(void 0===y||void 0===b){const t=_.length?Math.min(..._):0,e=_.length?Math.max(..._):1;y=y??t,b=b??(e===t?t+1:e)}return b<=y&&(b=y+1),{xLabels:u.labels,yLabels:m.labels,xKeys:u.keys,yKeys:m.keys,cells:v,min:y,max:b}}Qt([St({attribute:!1})],xs.prototype,"hass",void 0),Qt([zt()],xs.prototype,"_config",void 0),xs=Qt([yt(as)],xs);var Ts=ht(()=>{ps={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},fs={week_hourly:{x:"hour",y:"day",period:"7d"},two_weeks:{x:"hour",y:"day",period:"14d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_days:{x:"day",y:"week",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},quarter:{x:"week",y:"month",period:"90d"},timeline_24h:{x:"time",y:"none",period:"24h"},timeline_48h:{x:"time",y:"none",period:"48h"},year_overview:{x:"week",y:"month",period:"365d"}},_s={timeline:"timeline_24h",custom:"week_hourly"},vs=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],ys=/* @__PURE__ */new Map,bs=/* @__PURE__ */new Map});function Is(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function Ls(t){return Is(t)}function Os(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function Rs(t){return Os(t)?"count":"mean"}function qs(t,e){switch(e){case"mean":default:return t.mean??t.state??void 0;case"sum":return t.sum??t.change??void 0;case"max":return t.max??void 0;case"min":return t.min??void 0;case"last":return t.state??t.mean??void 0;case"count":return t.change??void 0}}function Ns(t){return t<1e11?1e3*t:t}var Fs,js,Us,Ds,Bs,Hs;async function Gs(t,e,i,n,s){return function(t,e){if(t.length<=e)return t;const i=Math.ceil(t.length/e),n=[];for(let s=0;s<t.length;s+=i)n.push(t[s]);return n}(function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await Ls(t)({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!0}),e),s),8e3)}async function Vs(t,e,i,n,s,a){const r=Ls(t),o="sum"===s?["sum","change"]:"max"===s?["max"]:"min"===s?["min"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=qs(n,e);null!=t&&Number.isFinite(t)&&i.push({time:Ns(n.start),value:t})}return i}((await r({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:o}))[e]??[],s)}var Ws,Ys,Ks,Qs=ht(()=>{Ts(),Fs="nvision-heat-map-card",js="nvision-heat-map-card-editor",Us="week_hourly",Ds="theme",Bs=[{value:"week_hourly",label:"Week — hour × day"},{value:"two_weeks",label:"Two weeks — hour × day"},{value:"daily_rhythm",label:"Daily rhythm — hour × weekday"},{value:"month_days",label:"Month — day × week"},{value:"month_calendar",label:"Quarter calendar — weekday × week"},{value:"quarter",label:"Quarter — week × month"},{value:"timeline_24h",label:"Timeline — 24 hours"},{value:"timeline_48h",label:"Timeline — 48 hours"},{value:"year_overview",label:"Year — week × month"}],Hs=[{value:"theme",label:"Theme"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"},{value:"custom",label:"Custom"}]}),Xs=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>Ks}),Zs=ht(()=>{kt(),Ut(),ie(),ne(),Qs(),Xt(),Ws=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:Us,selector:{select:{options:[...Bs],mode:"dropdown"}}},{name:"color_mode",required:!0,default:Ds,selector:{select:{options:[...Hs],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_cell_values",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}}]}],Ys=[{type:"grid",name:"",schema:[{name:"color_low",selector:{color_rgb:{}}},{name:"color_high",selector:{color_rgb:{}}}]}],Ks=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"View":"color_mode"===t.name?"Color mode":"color_low"===t.name?"Low color":"color_high"===t.name?"High color":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Scale":"show_cell_values"===t.name?"Values in cells":"show_current"===t.name?"Current value":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:Us,color_mode:Ds,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,...t,color_mode:"primary"===t.color_mode?"theme":t.color_mode}}_schema(){return"custom"===this._config?.color_mode?[...Ws,...Ys]:Ws}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){const e=t.detail.value;Zt(this,"config-changed",{config:{...e,color_mode:"primary"===e.color_mode?"theme":e.color_mode}})}},Qt([zt()],Ks.prototype,"_config",void 0),Ks=Qt([yt(js)],Ks)});function Js(t){return t&&"primary"!==t?t:"theme"}function ta(t,e,i,n,s){return s?`color-mix(in srgb, ${function(t,e,i,n){const s=Js(i);return"semantic"===s?we(t,e):"temperature"===s?$e(t,e):"custom"===s?ke(t,e,n.color_low,n.color_high):Me(t,e)}(t,e,i,n)} ${85*Math.max(e,.08)}%, var(--card-background-color))`:"var(--state-inactive-color, var(--divider-color))"}function ea(t,e,i,n=!1){if(null===t)return"—";const s="count"===e?String(Math.round(t)):Number.isInteger(t)?String(t):n?t.toFixed(0):t.toFixed(1);return i&&"count"!==e?n?s:`${s} ${i}`:s}function ia(t,e,i){return ea(t,e,i,!0)}kt(),Ut(),Ts(),Qs(),Xt(),Dt({type:Fs,name:"Nvision Heat Map",description:"Temporal heat map for sensor history and patterns"});var na=class extends _t{constructor(...t){super(...t),this._loading=!1,this._fetchVersion=0}static async getConfigElement(){return await Promise.resolve().then(()=>(Zs(),Xs)),document.createElement(js)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return e.startsWith("sensor.")||e.startsWith("binary_sensor.")||Number.isFinite(Number(i?.state))})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Fs}`,entity:n,preset:Us,color_mode:Ds,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1}}_computeLoadKey(){const t=this._config;if(!t?.entity)return"";const e=Es(t.preset);return JSON.stringify({entity:t.entity,preset:t.preset,aggregate:Rs(t.entity),axes:e})}setConfig(t){this._config={preset:Us,color_mode:Ds,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t,color_mode:Js(t.color_mode)},this._loadKey=void 0}getCardSize(){const t=this._grid?.yLabels.length??4;return Math.max(3,Math.min(8,Math.ceil(.75*t)+2))}getGridOptions(){const t=this._grid?.yLabels.length??4;return{columns:6,rows:Math.max(3,Math.min(8,Math.ceil(.75*t)+2)),min_rows:3}}updated(t){if(!t.has("_config")&&!t.has("hass"))return;const e=this._computeLoadKey();e&&this.hass&&e!==this._loadKey&&(this._loadKey=e,this._loadData())}async _loadData(){const t=this._config,e=this.hass,i=t?.entity;if(!t||!e||!i)return this._grid=void 0,void(this._error=void 0);try{Is(e)}catch{return this._error="History unavailable",void(this._grid=void 0)}const n=++this._fetchVersion;this._loading=!0,this._error=void 0;try{const s=Es(t.preset),a=Rs(i),r=await async function(t,e,i,n){const s=/* @__PURE__ */new Date,a=/* @__PURE__ */new Date(s.getTime()-60*i*60*1e3);if(Os(e)||"count"===n)return Gs(t,e,a,s,!0);if(i>=24)try{const r=await Vs(t,e,a,s,n,i>336?"day":"hour");if(r.length>0)return r}catch{}return Gs(t,e,a,s,!1)}(e,i,ps[s.period],a);if(n!==this._fetchVersion)return;if(await new Promise(t=>{"function"!=typeof requestIdleCallback?setTimeout(t,0):requestIdleCallback(()=>t(),{timeout:120})}),n!==this._fetchVersion)return;this._grid=Ps(r,s.x,s.y,s.period,a,e.config.time_zone||"UTC",1)}catch(s){if(n!==this._fetchVersion)return;this._error=function(t,e="Could not load history"){return t instanceof Error||"object"==typeof t&&null!==t&&"message"in t&&"string"==typeof t.message?t.message:e}(s),this._grid=void 0}finally{n===this._fetchVersion&&(this._loading=!1)}}_handleHeaderClick(t){t.stopPropagation(),this.hass&&this._config&&ss(this,this.hass,this._config,"tap")}_showPopover(t,e){const i=t.currentTarget,n=i.closest(".grid-wrap");if(!n)return;const s=i.getBoundingClientRect(),a=n.getBoundingClientRect(),r=this._config,o=r.entity?this.hass?.states[r.entity]:void 0,l=String(o?.attributes.unit_of_measurement??""),c=Rs(r.entity);this._popover={anchorX:s.left-a.left+s.width/2,anchorY:s.top-a.top,label:e.rangeLabel,value:ea(e.value,c,"count"===c?"":l),count:e.count}}_hidePopover(){this._popover=void 0}_renderLegend(t){const e=this._config,i=Js(e.color_mode),n=e.entity?this.hass?.states[e.entity]:void 0,s=String(n?.attributes.unit_of_measurement??""),a=Rs(e.entity),r=Ce(this,i,e.color_low,e.color_high),o=(t.min+t.max)/2;return V`
    ...
    `}_renderGrid(t){const e=this._config,i=Js(e.color_mode),n=!1!==e.show_axis_labels,s=!0===e.show_cell_values,a=!1!==e.show_legend,r=e.entity?this.hass?.states[e.entity]:void 0,o=String(r?.attributes.unit_of_measurement??""),l=Rs(e.entity),c=n?2:1,h=n?2:1;return V`
      <div class="heatmap-body">
        <div class="grid-wrap">
          <div
            class="grid"
            style=${ge({gridTemplateColumns:n?`auto repeat(${t.xLabels.length}, minmax(0, 1fr))`:`repeat(${t.xLabels.length}, minmax(0, 1fr))`,gridTemplateRows:n?`auto repeat(${t.yLabels.length}, auto)`:`repeat(${t.yLabels.length}, auto)`})}
          >
            ${n?V`<div class="corner"></div>`:K}
            ${n?t.xLabels.map((t,e)=>V`
                    <div
                      class="axis x"
                  ...
                  `):K}
            ${t.cells.flatMap((a,r)=>[n?V`
                    <div
                      class="axis y"
                      style=${ge({gridColumn:"1",gridRow:String(r+h)})}
                    >
                      ${t.yLabels[r]}
                    </div>
                  `:K,...a.map((n,a)=>{const d=(u=n.value,m=t.min,g=t.max,null===u?0:Math.min(1,Math.max(0,(u-m)/(g-m))));var u,m,g;const p=null!==n.value;return V`
                  <div
                    class=${Zn({cell:!0,empty:!p,"has-value":p})}
                    tabindex="0"
                    style=${ge({gridColumn:String(a+c),gridRow:String(r+h),background:ta(this,d,i,e,p)})}
                    @pointerenter=${t=>this._showPopover(t,n)}
                    @pointerleave=${this._hidePopover}
                    @focus=${t=>this._showPopover(t,n)}
                    @blur=${this._hidePopover}
                  >
                    ${s&&p?V`<span class="cell-value"
  ...
  `]}};Qt([St({attribute:!1})],na.prototype,"hass",void 0),Qt([zt()],na.prototype,"_config",void 0),Qt([zt()],na.prototype,"_grid",void 0),Qt([zt()],na.prototype,"_loading",void 0),Qt([zt()],na.prototype,"_error",void 0),Qt([zt()],na.prototype,"_popover",void 0),na=Qt([yt(Fs)],na),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");