...
`,ie=dt(()=>{Qt="nvision-blank-card",Zt="nvision-blank-card-editor"});function ne(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var se,ae=dt(()=>{}),oe=dt(()=>{Ct(),ae(),se=class extends vt{},ne([At({attribute:!1})],se.prototype,"hass",void 0)});function re(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function ce(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,he,de=dt(()=>{}),ue=/* @__PURE__ */ut({NvisionBlankCardEditor:()=>he}),me=dt(()=>{Ct(),Bt(),Gt(),oe(),de(),ie(),ae(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},re()],he=class extends se{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):ce(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
                      ...
                      ${i?W`
                            <div class="entity-panel">
                              <ha-form
                                ...
                                .hass=${this.hass}
                                .data=${{entity:t.entityId,name:t.name??"",icon:t.icon??""}}
                                .schema=${Vr}
                                .computeLabel=${this._entityPanelLabel}
                                @value-changed=${t=>this._entityPanelChanged(e,t)}
                              ></ha-form>
                              <button
                                type="button"
                                class="remove"
  ...
  `}},ne([Et()],Kr.prototype,"_config",void 0),ne([Et()],Kr.prototype,"_componentsReady",void 0),ne([Et()],Kr.prototype,"_expandedIndex",void 0),Kr=ne([bt(Or)],Kr)});function Jr(t,e){const i=e?.attributes?.device_class,n=e?.attributes?.unit_of_measurement;return"monetary"===i||"energy"===i||"volume"===i||"water"===i||tc(t,"cost","price","money","eur","usd")||tc(t,"energy","kwh","wh","power")||tc(t,"water","liquid","volume","liter","litre")||"string"==typeof n}function tc(t,...e){const i=t.toLowerCase();return e.some(t=>i.includes(t))}Ct(),Bt(),ui(),jr(),Br(),ae(),Ht({type:Tr,name:"Nvision Sum",description:"Numeric entities with a summed total"});var ec,ic,nc,sc,ac,oc,rc,cc=class extends vt{constructor(...t){super(...t),this._actions=new Kt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Zr(),Xr)),document.createElement(Or)}static getStubConfig(t,e,i){const n=[...e,...i,...Object.keys(t.states)],s=function(t,e){const i=/* @__PURE__ */new Set,n=[];for(const s of e){if(i.has(s))continue;i.add(s);const e=t.states[s];if(void 0!==ti(e?.state)&&(Jr(s,e)&&n.push(s),n.length>=4))break}if(n.length>=2)return n;for(const s of e)if(!i.has(s)&&(i.add(s),void 0!==ti(t.states[s]?.state)&&n.push(s),n.length>=3))break;return n}(t,n);return{type:`custom:${Tr}`,entities:s.length?s:n.slice(0,3),columns:3,theme:Lr}}setConfig(t){this._config={entities:[],columns:3,theme:Lr,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t},this._syncLayout()}_entities(){return Dr(this._config?.entities)}_theme(){return this._config?.theme??"none"}_sumState(){const t=this._entities();let e,i=0,n=!1;for(const s of t){const t=this.hass?.states[s.entityId],a=ti(t?.state);void 0!==a&&(i+=a,n=!0,e||(e=t))}return{sum:n?i:void 0,reference:e}}_syncLayout(){const t=this._config?.columns??3,e=this._entities().length,i=e>0?Math.min(t,e):t;this.style.setProperty("--columns",String(i)),this.dataset.theme=this._theme()}getCardSize(){const t=this._entities().length||1,e=this._config?.columns??3;return 1+Math.max(1,Math.ceil(t/e))}getGridOptions(){return{columns:6,rows:this.getCardSize()}}updated(){this._syncLayout()}render(){if(!this._config||!this.hass)return K;const t=this._entities(),e=this._theme(),{sum:i,reference:n}=this._sumState(),s=this._config.name||"Total",a=Gr(this.hass,i,e,n),o=Fr[e];return W`
      <ha-card>
        <div
          class="total"
          role="button"
    ...
    `;var n}render(){if(!this._config)return K;const t=this._config.title||"Event Log",e=this._trackedEntities(),i=this.preview||!this._entries.length&&!this._connected?kc:this._entries,n=e.length?"Waiting for events from selected entities…":"Waiting for events…";return W`
  ...
  `}};ne([At({attribute:!1})],Mc.prototype,"hass",void 0),ne([At({type:Boolean})],Mc.prototype,"preview",void 0),ne([Et()],Mc.prototype,"_config",void 0),ne([Et()],Mc.prototype,"_entries",void 0),ne([Et()],Mc.prototype,"_connected",void 0),ne([Lt(".terminal-body")],Mc.prototype,"_body",void 0),Mc=ne([bt(ec)],Mc),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");