...
`,ee=ht(()=>{Xt="nvision-blank-card",Qt="nvision-blank-card-editor"});function ie(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var ne,se=ht(()=>{}),ae=ht(()=>{kt(),se(),ne=class extends _t{},ie([St({attribute:!1})],ne.prototype,"hass",void 0)});function oe(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function re(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,ce,he=ht(()=>{}),de=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ce}),ue=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ee(),se(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},oe()],ce=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${le}
      ...
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],ce.prototype,"_config",void 0),ce=ie([yt(Qt)],ce)});kt(),Dt(),ee(),se(),Bt({type:Xt,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var me=class extends _t{constructor(...t){super(...t),this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(ue(),de)),document.createElement(Qt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Xt}`,entity:n}}setConfig(t){this._config={tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Kt(t);return G`
      <ha-card>
        <div
          class="content"
          role="button"
  ...
  `}kt(),Dt(),Ie(),se(),Bt({type:ve,name:"Nvision Activity",description:"Animated figure that reacts to detected activity (walking, running, cycling, driving…)"});var Re,Fe,qe,Ne,je=class extends _t{constructor(...t){super(...t),this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Oe(),Te)),document.createElement(ye)}static getStubConfig(t,e,i){const n=e.find(t=>t.toLowerCase().includes("activity"))||e.find(t=>t.startsWith("sensor."))||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${ve}`,entity:n}}setConfig(t){this._config={speed:1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 4}getGridOptions(){return{columns:6,rows:4}}_renderScene(t){return"bicycle"===t?this._renderCyclist():"vehicle"===t?this._renderCar():this._renderPerson()}_renderPerson(){return V`
  ...
  `}};function ks(t){return String(t).padStart(2,"0")}function Cs(t,e){const i=Object.fromEntries(function(t){let e=xs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),xs.set(t,e)),e}(e).formatToParts(new Date(t)).map(t=>[t.type,t.value])),n=bs.indexOf(String(i.weekday))>=0?bs.indexOf(String(i.weekday)):0,s=Number(i.year),a=Number(i.month),o=Number(i.day);return{year:s,month:a,day:o,hour:Number(i.hour)%24,weekday:n,dateKey:`${s}-${ks(a)}-${ks(o)}`,monthKey:`${s}-${ks(a)}`}}function Ss(t,e,i){const n=Cs(As(t,e,i),e);return`${n.year}-${ks(n.month)}-${ks(n.day)}`}function As(t,e,i){const n=Cs(t,e),s=(n.weekday-i+7)%7;return zs(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function zs(t,e,i,n,s,a){const o=Date.UTC(t,e-1,i,n,s,0),r=Object.fromEntries(function(t){let e=ws.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),ws.set(t,e)),e}(a).formatToParts(new Date(o)).map(t=>[t.type,t.value]));return o-(Date.UTC(Number(r.year),Number(r.month)-1,Number(r.day),Number(r.hour),Number(r.minute),0)-o)}function Ps(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...Cs(t,e),weekKey:Ss(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function Es(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>bs[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=Cs(t.startMs,e);let s=zs(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=Cs(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=As(t.startMs,e,i);for(;s<=t.endMs;){const t=Cs(s,e);n.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=Cs(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${ks(a)}`;if(i.push({key:n,label:`${s}-${ks(a)}`}),a+=1,a>12&&(a=1,s+=1),zs(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const o=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const r of o)a.set(r.key,`${new Date(r.start).toLocaleString()} – ${new Date(r.end).toLocaleString()}`);return{keys:o.map(t=>t.key),labels:o.map(t=>t.label),bucketRanges:a}}function Is(t,e,i,n,s,a,o){return"time"===t?o.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function Ts(t){return vs[t&&ys[t]||(t&&t in vs?t:void 0)||"week_hourly"]}function Os(t,e,i,n,s){const a=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(_s[i]),o=(r=a.hours)<=24||r<=48||r<=336?36e5:864e5;var r;const l=Es(t,a,n,s,o),c=Es(e,a,n,s,o);return{window:a,bucketMs:o,xAxis:l,yAxis:c,xKeySet:new Set(l.keys),yKeySet:new Set(c.keys),bucketMap:/* @__PURE__ */new Map}}function Ls(t,e,i,n,s,a){if(e.time<t.window.startMs||e.time>t.window.endMs)return;const o=Ps(i,e.time,s,t.bucketMs,a),r=Ps(n,e.time,s,t.bucketMs,a);if(void 0===o||void 0===r)return;if(!t.xKeySet.has(o)||!t.yKeySet.has(r))return;const l=`${r}|${o}`,c=t.bucketMap.get(l)??[];c.push({time:e.time,value:e.value}),t.bucketMap.set(l,c)}function Rs(t,e,i,n,s,a){const o=[],r=t.yAxis.keys.map((s,a)=>t.xAxis.keys.map((r,l)=>{const c=t.bucketMap.get(`${s}|${r}`)??[],h=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e.value,0);case"max":return Math.max(...t.map(t=>t.value));case"min":return Math.min(...t.map(t=>t.value));case"last":{let e=t[0];for(const i of t)i.time>=e.time&&(e=i);return e.value}default:return t.reduce((t,e)=>t+e.value,0)/t.length}}(c,n);return null!==h&&o.push(h),{value:h,count:c.length,rangeLabel:Is(e,i,r,0,t.xAxis.labels[l],t.yAxis.labels[a],t.xAxis.bucketRanges)}}));let l=s,c=a;if(void 0===l||void 0===c){const t=o.length?Math.min(...o):0,e=o.length?Math.max(...o):1;l=l??t,c=c??(e===t?t+1:e)}return c<=l&&(c=l+1),{xLabels:t.xAxis.labels,yLabels:t.yAxis.labels,xKeys:t.xAxis.keys,yKeys:t.yAxis.keys,cells:r,min:l,max:c}}function Fs(t,e,i){return null===t?0:Math.min(1,Math.max(0,(t-e)/(i-e)))}ie([St({attribute:!1})],Ms.prototype,"hass",void 0),ie([zt()],Ms.prototype,"_config",void 0),Ms=ie([yt(rs)],Ms);var qs=ht(()=>{_s={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},vs={week_hourly:{x:"hour",y:"day",period:"7d"},two_weeks:{x:"hour",y:"day",period:"14d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_days:{x:"weekday",y:"week",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},quarter:{x:"week",y:"month",period:"90d"},timeline_24h:{x:"time",y:"none",period:"24h"},timeline_48h:{x:"time",y:"none",period:"48h"},year_overview:{x:"week",y:"month",period:"365d"}},ys={timeline:"timeline_24h",custom:"week_hourly"},bs=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],xs=/* @__PURE__ */new Map,ws=/* @__PURE__ */new Map,$s=["day","week","month"]});function Ns(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function js(t){return Ns(t)}function Ds(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function Bs(t,e){const i=(...t)=>{for(const e of t){if(null==e)continue;const t=Number(e);if(Number.isFinite(t))return t}};switch(e){case"mean":default:return i(t.mean,t.state);case"sum":return i(t.sum,t.change,t.state);case"max":return i(t.max,t.state,t.sum);case"min":return i(t.min,t.state);case"last":return i(t.state,t.mean);case"count":return i(t.change)}}function Us(t){if("string"==typeof t){const e=Date.parse(t);return Number.isFinite(e)?e:void 0}return t<1e11?1e3*t:t}var Hs,Ws,Gs,Vs,Ys,Ks,Xs;async function Qs(t,e,i,n,s,a="mean"){const o=js(t),r=function(t){return"max"===t||"last"===t}(a);return function(t,e,i=!1){if(t.length<=e)return t;const n=Math.ceil(t.length/e),s=[];for(let a=0;a<t.length;a+=n){const e=t.slice(a,a+n);e.length&&(i?s.push(e.reduce((t,e)=>e.value>t.value||e.value===t.value&&e.time>t.time?e:t,e[0])):s.push(e[0]))}return s}(function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await o({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!r}),e),s),8e3,r)}async function Zs(t,e,i,n,s,a){const o=js(t),r="sum"===s?["sum","change","state"]:"max"===s?["max","state","sum"]:"min"===s?["min","state"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=Bs(n,e);if(null==t||!Number.isFinite(t))continue;const s=Us(n.start);void 0!==s&&i.push({time:s,value:t})}return i}((await o({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:r}))[e]??[],s)}var Js,ta,ea,ia=ht(()=>{qs(),Hs="nvision-heat-map-card",Ws="nvision-heat-map-card-editor",Gs="week_hourly",Vs="theme",Ys=[{value:"week_hourly",label:"Week — hour × day"},{value:"two_weeks",label:"Two weeks — hour × day"},{value:"daily_rhythm",label:"Daily rhythm — hour × weekday"},{value:"month_days",label:"Month — weekday × week"},{value:"month_calendar",label:"Quarter calendar — weekday × week"},{value:"quarter",label:"Quarter — week × month"},{value:"timeline_24h",label:"Timeline — 24 hours"},{value:"timeline_48h",label:"Timeline — 48 hours"},{value:"year_overview",label:"Year — week × month"}],Ks=[{value:"theme",label:"Theme"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"},{value:"custom",label:"Custom"}],Xs=[{value:"auto",label:"Auto"},{value:"mean",label:"Mean"},{value:"sum",label:"Sum"},{value:"max",label:"Maximum"},{value:"min",label:"Minimum"},{value:"count",label:"Count"},{value:"last",label:"Last"}]}),na=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>ea}),sa=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ia(),se(),Js=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:Gs,selector:{select:{options:[...Ys],mode:"dropdown"}}},{name:"operation",default:"auto",selector:{select:{options:[...Xs],mode:"dropdown"}}},{name:"color_mode",required:!0,default:Vs,selector:{select:{options:[...Ks],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_cell_values",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}},{name:"dim_low_values",selector:{boolean:{}}}]},oe()],ta=[{type:"grid",name:"",schema:[{name:"color_low",selector:{color_rgb:{}}},{name:"color_high",selector:{color_rgb:{}}}]}],ea=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"View":"color_mode"===t.name?"Color mode":"operation"===t.name?"Operation":"color_low"===t.name?"Low color":"color_high"===t.name?"High color":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Scale":"show_cell_values"===t.name?"Values in cells":"dim_low_values"===t.name?"Dim low values":"show_current"===t.name?"Current value":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:Gs,color_mode:Vs,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,...t,color_mode:"primary"===t.color_mode?"theme":t.color_mode,operation:t.operation??"auto"}}_schema(){return"custom"===this._config?.color_mode?[...Js,...ta]:Js}render(){return this.hass&&this._config?G`
    ...
    `}_renderCell(t,e,i,n,s,a,o){const r=Fs(t.value,n.min,n.max),l=null!==t.value;return G`
      <div
            ...
            <div class="grid-wrap">
              ...
              >
                    ${t.cells.flatMap((a,o)=>{const h=o+1;return[n?G`
                          ...
                          `:K,...a.map((n,a)=>{const o=Fs(n.value,t.min,t.max),d=null!==n.value;return G`
                          <div
  ...
  `]}};ie([St({attribute:!1})],ya.prototype,"hass",void 0),ie([zt()],ya.prototype,"_config",void 0),ie([zt()],ya.prototype,"_grid",void 0),ie([zt()],ya.prototype,"_loading",void 0),ie([zt()],ya.prototype,"_error",void 0),ie([zt()],ya.prototype,"_popover",void 0),ie([zt()],ya.prototype,"_xLabelVisible",void 0),ya=ie([yt(Hs)],ya);var ba=ht(()=>{ma="nvision-reactor-core-card",pa="nvision-reactor-core-card-editor",ga="auto",fa="on_update",_a=["sensor","binary_sensor","switch","light","timer"],va=["sensor","binary_sensor","switch","light","timer"]});function xa(t){const e=t.split(":").map(Number);return 3===e.length?3600*e[0]+60*e[1]+e[2]:2===e.length?60*e[0]+e[1]:Number(t)||0}function wa(t){return void 0!==t&&"unavailable"!==t&&"unknown"!==t&&("on"===t||"true"===t||"open"===t||"home"===t||"active"===t)}function $a(t,e){const i=e.split(".",1)[0];if("light"===i)return"light";if("timer"===i)return"timer";if("switch"===i||Ds(e))return"toggle";const n=t.states[e]?.state;return void 0!==Ze(n)?"numeric":"other"}function Ma(t,e,i,n){const s=Ze(t.states[e]?.state);return void 0===s?.35:Je(s,i,n)}function ka(t,e){const i=t.states[e];if(!i||"active"!==i.state)return 0;const n=function(t){const e=t.attributes.remaining;if("string"!=typeof e)return;let i=xa(e);if("active"===t.state&&t.attributes.finishes_at){const e=new Date(String(t.attributes.finishes_at)).getTime();i=Math.max((e-Date.now())/1e3,0)}return i}(i),s=function(t){const e=t.attributes.duration;return"string"==typeof e?xa(e):0}(i);return void 0===n||s<=0?.55:1-Math.min(1,Math.max(0,n/s))}function Ca(t,e,i,n){const s=t.states[e]?.state,a=$a(t,e),o="light"===a?function(t,e){const i=t.states[e];if(!i||"on"!==i.state)return{lightBrightness:0};const n=os(i);return{lightColor:n?`rgb(${n.join(", ")})`:void 0,lightBrightness:ns(i)}}(t,e):{};return{kind:a,isOn:wa(s),numericNorm:Ma(t,e,i,n),lightColor:o.lightColor,lightBrightness:o.lightBrightness??0,timerUrgency:"timer"===a?ka(t,e):0,unavailable:"unavailable"===s||"unknown"===s}}ba(),hi();var Sa=[.42,.58,.72,.84],Aa=[185,198,215,248,278,312,42],za=2*Math.PI,Pa=.34,Ea=1.1,Ia=.06;function Ta(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}function Oa(t,e){const i=Math.min(Sa.length,Math.max(2,Math.ceil(Math.sqrt(e)))),n=t%i,s=Math.ceil(e/i);return{shell:n,slot:Math.floor(t/i)%s,slotsOnShell:s}}function La(t,e){const i=(14e-6*e+.31*t)%Aa.length,n=Math.floor(i);return Aa[n]+(Aa[(n+1)%Aa.length]-Aa[n])*(i-n)}function Ra(t,e,i,n){const s=Ca(e,t.entityId,i,n);t.kind=s.kind,t.isOn=s.isOn,t.numericNorm=s.numericNorm,t.lightColor=s.lightColor,t.lightBrightness=s.lightBrightness,t.timerUrgency=s.timerUrgency,t.unavailable=s.unavailable}function Fa(t,e){const i=qa(t,e),n=.014*e;return Math.min(3.4,Math.max(.5,n/Math.max(i,.004*e)))}function qa(t,e){return"numeric"===t.kind?Na(e,t.numericNorm):ja(e,t.kind)}function Na(t,e){return t*(.006+.028*e)}function ja(t,e){switch(e){case"toggle":return.016*t;case"light":return.011*t;case"timer":return.013*t;case"numeric":return.012*t;default:return.01*t}}function Da(t,e){e.push({x:t.x,y:t.y,age:0,seed:t.seed})}function Ba(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:_a,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function Ua(t,e,i,n,s,a){const o=Ta(e),r=Ta(`${e}:y`),l=Oa(s,a),c=t.states[e]?.state,h={entityId:e,kind:$a(t,e),seed:o,seedY:r,x:0,y:0,phase:o*za,shell:l.shell,slot:l.slot,slotsOnShell:l.slotsOnShell,orbitTilt:o*za,orbitRyScale:.62+.32*r,baseOrbitSpeed:85e-5+.0011*o,wobbleSpeed:.0016+.0024*r,pathDrift:0,isOn:!1,lastState:c,numericNorm:.35,lightBrightness:0,timerUrgency:0,unavailable:"unavailable"===c||"unknown"===c,placed:!1};return Ra(h,t,i,n),h}function Ha(t,e){const i=t/2,n=Math.min(.22*e,72),s=(e-n)/2,a=Math.max(10,.06*t),o=Math.max(10,.06*e+.35*n),r=Math.max(1,t/2-a),l=Math.max(1,(e-n)/2-o);return{cx:i,cy:s,halfW:r,halfH:l,scale:Math.min(t,e),clampX:r,clampY:l}}function Wa(t,e,i,n){const{cx:s,cy:a,halfW:o,halfH:r}=Ha(e,i),l=Sa[t.shell%Sa.length],c=t.slot/Math.max(1,t.slotsOnShell)*za+.55*t.seed+t.phase,h=o*l,d=r*l*t.orbitRyScale,u=Math.cos(c)*h,m=Math.sin(c)*d,p=t.orbitTilt;let g=s+u*Math.cos(p)-m*Math.sin(p),f=a+u*Math.sin(p)+m*Math.cos(p);const _=.001*n,v=.028+.018*t.seed;return g+=Math.cos(_*t.wobbleSpeed+11*t.seed)*h*v,f+=Math.sin(_*t.wobbleSpeed*1.23+9*t.seedY)*d*v,{x:g,y:f}}function Ga(t,e,i,n){const s=Wa(t,e,i,n),a=Wa(t,e,i,n+24),o=a.x-s.x,r=a.y-s.y,l=Math.hypot(o,r);return l<.01?{x:1,y:0}:{x:o/l,y:r/l}}function Va(t,e,i,n){const s=Wa(t,e,i,n);t.x=s.x,t.y=s.y,t.pathDrift=0,t.placed=!0}function Ya(t,e,i){const n=La(t.seed,e);let s=82,a=58;return t.unavailable&&(s=18,a=42),`hsla(${n}, ${s}%, ${a}%, ${i})`}function Ka(t,e){for(const i of e)t.beginPath(),t.arc(i.x,i.y,i.radius,0,za),t.fillStyle=i.color,t.fill()}function Xa(t,e,i,n,s,a=.5){const o=i*(1+s*a),r={core:{x:t,y:e,radius:i,color:n}};return o>1.02*i&&(r.halo={x:t,y:e,radius:o,color:n.replace(/[\d.]+\)$/,.07+.1*s+")")}),r}function Qa(t,e,i){switch(t.kind){case"toggle":return function(t,e,i){const n=ja(e,"toggle"),s=t.isOn?.009:.007,a=(Math.sin(i*s+12*t.seed)+1)/2,o=La(t.seed,i),r=t.unavailable?18:t.isOn?38+50*a:38,l=t.unavailable?42:t.isOn?36+22*a:36,c=`hsla(${o}, ${r}%, ${l}%, ${t.unavailable?.18:t.isOn?Pa+.44*a:Pa})`,h=t.unavailable?1.08*n:t.isOn?n*(Ea+.4*a):n*Ea,d=`hsla(${o}, ${r}%, ${Math.max(l-6,40)}%, ${t.isOn?Ia+.12*a:Ia})`;return{halo:h>1.02*n?{x:t.x,y:t.y,radius:h,color:d}:void 0,core:{x:t.x,y:t.y,radius:n,color:c}}}(t,e,i);case"light":return function(t,e,i){const n=t.lightBrightness,s=ja(e,"light"),a=t.unavailable?.25:t.isOn?.55+.35*n:.18,o=t.lightColor??(t.isOn?"rgb(255, 183, 77)":Ya(t,i,.25)),r=Za(o,a),l=t.unavailable?1.08*s:t.isOn?s*(1.35+2.15*n):1.08*s,c=Za(o,t.isOn?.08+.16*n:.05);return{halo:l>1.02*s?{x:t.x,y:t.y,radius:l,color:c}:void 0,core:{x:t.x,y:t.y,radius:s,color:r}}}(t,e,i);case"timer":return function(t,e,i){const n=t.timerUrgency,s=ja(e,"timer"),a=.005+.048*n,o=Math.sin(i*a+10*t.seed),r=(o+1)/2,l=r*o*(24+36*n),c=(La(t.seed,i)+l+360)%360,h=52+6*n,d=.38+.24*n,u=t.unavailable?18:38+50*r,m=t.unavailable?42:36+r*(h-36),p=`hsla(${c}, ${u}%, ${m}%, ${t.unavailable?.25:Pa+r*(d-Pa)})`,g=t.unavailable?1.08*s:s*(Ea+r*(.35+.45*n)),f=`hsla(${c}, ${u}%, ${Math.max(m-4,40)}%, ${Ia+r*(.08+.12*n)})`;return{halo:g>1.02*s?{x:t.x,y:t.y,radius:g,color:f}:void 0,core:{x:t.x,y:t.y,radius:s,color:p}}}(t,e,i);default:return function(t,e,i){const n="numeric"===t.kind?Na(e,t.numericNorm):ja(e,t.kind),s=t.unavailable?.28:.78,a=Ya(t,i,s);return Xa(t.x,t.y,n,a,.65*s)}(t,e,i)}}function Za(t,e){const i=t.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/);return i?`rgba(${i[1]}, ${i[2]}, ${i[3]}, ${e})`:t.match(/hsla?\(([^)]+)\)/)?t.replace(/[\d.]+\)$/,`${e})`):t}function Ja(t,e,i,n,s,a){const{cx:o,cy:r,scale:l,clampX:c,clampY:h}=Ha(e,i),d=.012*l,u=.003*l,m=.05*a,p=.024*a,g=.09*l,f=t.map(t=>function(t,e){const i=qa(t,e);return"toggle"===t.kind?t.isOn?1.55*i:i*Ea:"light"===t.kind?t.isOn?i*(1.2+1.4*t.lightBrightness):1.08*i:"timer"===t.kind?1.45*i:1.3*i}(t,l));for(let v=0;v<t.length;v+=1){const e=t[v];e.phase+=e.baseOrbitSpeed*Fa(e,l)*n}const _=t.map(t=>{return{target:Wa(t,e,i,s),normal:(n=Ga(t,e,i,s),{x:-n.y,y:n.x})};var n});for(let v=0;v<t.length;v+=1){const e=t[v],{target:i,normal:s}=_[v],a=f[v],y=Math.max(a,u)/d,b=m*Math.min(1.35,Math.max(.4,1/Math.sqrt(y)));let x=-e.pathDrift*b*n;const w=i.x+s.x*e.pathDrift,$=i.y+s.y*e.pathDrift;for(let o=0;o<t.length;o+=1){if(o===v)continue;const e=t[o],i=_[o],r=f[o],c=a+r,h=c+.014*l,d=w-(i.target.x+i.normal.x*e.pathDrift),m=$-(i.target.y+i.normal.y*e.pathDrift),g=Math.hypot(d,m);if(g<=.5||g>=h)continue;const b=(h-g)/(h-.65*c),M=Math.max(0,c-g),k=(b**1.2+M/c*2.5)*p*(Math.max(r,u)/Math.max(a,u))*n,C=d/g*s.x+m/g*s.y;x+=C*k,M>0&&(x+=C*(M/c)*.35*(1/y)*n)}e.pathDrift+=x,e.pathDrift=Math.min(g,Math.max(-g,e.pathDrift));let M=i.x+s.x*e.pathDrift,k=i.y+s.y*e.pathDrift;M=Math.min(o+c,Math.max(o-c,M)),k=Math.min(r+h,Math.max(r-h,k)),e.x=M,e.y=k,e.pathDrift=(M-i.x)*s.x+(k-i.y)*s.y,e.placed=!0}}function to(t,e,i,n,s,a,o=[]){const{cx:r,cy:l,scale:c}=Ha(n,s);t.clearRect(0,0,n,s);const h=t.createRadialGradient(r,l,0,r,l,.72*c);h.addColorStop(0,"hsla(200, 70%, 58%, 0.06)"),h.addColorStop(.35,"hsla(260, 55%, 42%, 0.03)"),h.addColorStop(1,"hsla(0, 0%, 0%, 0)"),t.fillStyle=h,t.fillRect(0,0,n,s),function(t,e,i,n){for(const s of e){const e=s.age/1400,a=i*(.03+.48*e),o=(1-e)**1.2*.11,r=La(s.seed,n);t.beginPath(),t.arc(s.x,s.y,a,0,za),t.strokeStyle=`hsla(${r}, 86%, 64%, ${o})`,t.lineWidth=1+1.4*(1-e),t.stroke()}}(t,i,c,a);const d=[],u=[];for(const m of e){const t=Qa(m,c,a);t.halo&&d.push(t.halo),u.push(t.core)}Ka(t,d),o.length&&function(t,e,i,n){for(const s of e){const e=`hsla(${La(s.seed,n)}, 78%, 62%, 0.42)`;t.beginPath(),t.moveTo(s.fromX,s.fromY),t.lineTo(s.toX,s.toY),t.strokeStyle=e,t.lineWidth=1,t.stroke(),t.beginPath(),t.arc(s.toX,s.toY,.0045*i,0,za),t.fillStyle=e.replace(/[\d.]+\)$/,"0.65)"),t.fill()}}(t,o,c,a),Ka(t,u);!function(t,e,i,n,s,a,o=.5){const r=Xa(e,i,n,s,a,o);r.halo&&Ka(t,[r.halo]),Ka(t,[r.core])}(t,r,l,.012*c*(.55+.12*Math.sin(.0018*a)),`hsla(${Aa[Math.floor(14e-6*a%Aa.length)]}, 88%, 68%, 0.65)`,.5,.3)}var eo,io,no,so=/* @__PURE__ */dt({NvisionReactorCoreCardEditor:()=>no}),ao=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ba(),se(),eo=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:ga,selector:{select:{options:[{value:"auto",label:"Auto-discover entities"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{name:"info_selection",required:!0,default:fa,selector:{select:{options:[{value:"on_update",label:"On update"},{value:"random_interval",label:"Random every 10s"},{value:"nearest_cursor",label:"Nearest 4 to cursor/tap"}]}}},{name:"show_info",default:!0,selector:{boolean:{}}},{name:"show_info_change",default:!1,selector:{boolean:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},oe()],io=[{name:"entities",selector:{entity:{multiple:!0,domain:[...va]}}}],no=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"info_selection"===t.name?"Info card selection":"show_info"===t.name?"Show info cards":"show_info_change"===t.name?"Show value change (10W → 50W)":"min"===t.name?"Numeric orbit min":"max"===t.name?"Numeric orbit max":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:ga,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...eo.slice(0,3),...io,...eo.slice(3)]:eo}render(){return this.hass&&this._config?G`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
      ...
      <ha-card aria-label=${t}>
        <div class="stage">
          ...
          >
            ${e?G`
                  <div class="info-bar">
                    ${this._slotIds.map((t,e)=>{const i=t?this.hass.states[t]:void 0;return G`
                        <div
                          class="info-slot"
                          data-slot=${e}
    ...
    `]}};ie([St({attribute:!1})],oo.prototype,"hass",void 0),ie([zt()],oo.prototype,"_config",void 0),ie([zt()],oo.prototype,"_slotIds",void 0),ie([zt()],oo.prototype,"_infoChangeFrom",void 0),ie([Ot(".stage")],oo.prototype,"_stage",void 0),ie([Ot("canvas")],oo.prototype,"_canvas",void 0),oo=ie([yt(ma)],oo),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");