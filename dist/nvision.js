...
`,ee=ht(()=>{Xt="nvision-blank-card",Qt="nvision-blank-card-editor"});function ie(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var ne,se=ht(()=>{}),ae=ht(()=>{kt(),se(),ne=class extends _t{},ie([St({attribute:!1})],ne.prototype,"hass",void 0)});function oe(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function re(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,ce,he=ht(()=>{}),de=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ce}),ue=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ee(),se(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},oe()],ce=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
  ...
  `]}};ie([St({attribute:!1})],va.prototype,"hass",void 0),ie([zt()],va.prototype,"_config",void 0),ie([zt()],va.prototype,"_grid",void 0),ie([zt()],va.prototype,"_loading",void 0),ie([zt()],va.prototype,"_error",void 0),ie([zt()],va.prototype,"_popover",void 0),ie([zt()],va.prototype,"_xLabelVisible",void 0),va=ie([yt(Hs)],va);var ya=ht(()=>{ma="nvision-reactor-core-card",pa="nvision-reactor-core-card-editor",ga="auto",fa=["sensor","binary_sensor","switch","light","timer"],_a=["sensor","binary_sensor","switch","light","timer"]});function ba(t){const e=t.split(":").map(Number);return 3===e.length?3600*e[0]+60*e[1]+e[2]:2===e.length?60*e[0]+e[1]:Number(t)||0}function xa(t){return void 0!==t&&"unavailable"!==t&&"unknown"!==t&&("on"===t||"true"===t||"open"===t||"home"===t||"active"===t)}function wa(t,e){const i=e.split(".",1)[0];if("light"===i)return"light";if("timer"===i)return"timer";if("switch"===i||Ds(e))return"toggle";const n=t.states[e]?.state;return void 0!==Ze(n)?"numeric":"other"}function $a(t,e,i,n){const s=Ze(t.states[e]?.state);return void 0===s?.35:Je(s,i,n)}function Ma(t,e){const i=t.states[e];if(!i||"active"!==i.state)return 0;const n=function(t){const e=t.attributes.remaining;if("string"!=typeof e)return;let i=ba(e);if("active"===t.state&&t.attributes.finishes_at){const e=new Date(String(t.attributes.finishes_at)).getTime();i=Math.max((e-Date.now())/1e3,0)}return i}(i),s=function(t){const e=t.attributes.duration;return"string"==typeof e?ba(e):0}(i);return void 0===n||s<=0?.55:1-Math.min(1,Math.max(0,n/s))}function ka(t,e,i,n){const s=t.states[e]?.state,a=wa(t,e),o="light"===a?function(t,e){const i=t.states[e];if(!i||"on"!==i.state)return{lightBrightness:0};const n=os(i);return{lightColor:n?`rgb(${n.join(", ")})`:void 0,lightBrightness:ns(i)}}(t,e):{};return{kind:a,isOn:xa(s),numericNorm:$a(t,e,i,n),lightColor:o.lightColor,lightBrightness:o.lightBrightness??0,timerUrgency:"timer"===a?Ma(t,e):0,unavailable:"unavailable"===s||"unknown"===s}}ya(),hi();var Ca=[.42,.58,.72,.84],Sa=[185,198,215,248,278,312,42],Aa=2*Math.PI;function za(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}function Ea(t,e){const i=Math.min(Ca.length,Math.max(2,Math.ceil(Math.sqrt(e)))),n=t%i,s=Math.ceil(e/i);return{shell:n,slot:Math.floor(t/i)%s,slotsOnShell:s}}function Pa(t,e){const i=(14e-6*e+.31*t)%Sa.length,n=Math.floor(i);return Sa[n]+(Sa[(n+1)%Sa.length]-Sa[n])*(i-n)}function Ta(t,e,i,n){const s=ka(e,t.entityId,i,n);t.kind=s.kind,t.isOn=s.isOn,t.numericNorm=s.numericNorm,t.lightColor=s.lightColor,t.lightBrightness=s.lightBrightness,t.timerUrgency=s.timerUrgency,t.unavailable=s.unavailable}function Oa(t){return"numeric"===t.kind?.35+1.35*t.numericNorm:1}function Ia(t,e){e.push({x:t.x,y:t.y,age:0,seed:t.seed})}function La(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:fa,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function qa(t,e,i,n,s,a){const o=za(e),r=za(`${e}:y`),l=Ea(s,a),c=t.states[e]?.state,h=l.shell%2==0?1:-1,d={entityId:e,kind:wa(t,e),seed:o,seedY:r,x:0,y:0,phase:o*Aa,shell:l.shell,slot:l.slot,slotsOnShell:l.slotsOnShell,orbitTilt:o*Aa,orbitRyScale:.62+.32*r,baseOrbitSpeed:h*(55e-5+75e-5*o),wobbleSpeed:.0016+.0024*r,isOn:!1,lastState:c,numericNorm:.35,lightBrightness:0,timerUrgency:0,unavailable:"unavailable"===c||"unknown"===c,placed:!1};return Ta(d,t,i,n),d}function Ra(t,e){const i=t/2,n=e/2,s=Math.max(10,.06*t),a=Math.max(10,.06*e),o=Math.max(1,t/2-s),r=Math.max(1,e/2-a);return{cx:i,cy:n,halfW:o,halfH:r,scale:Math.min(t,e),clampX:o,clampY:r}}function Fa(t,e,i,n){const{cx:s,cy:a,halfW:o,halfH:r}=Ra(e,i),l=Ca[t.shell%Ca.length],c=t.slot/Math.max(1,t.slotsOnShell)*Aa+.55*t.seed+t.phase,h=o*l,d=r*l*t.orbitRyScale,u=Math.cos(c)*h,m=Math.sin(c)*d,p=t.orbitTilt;let g=s+u*Math.cos(p)-m*Math.sin(p),f=a+u*Math.sin(p)+m*Math.cos(p);const _=.001*n,v=.035+.025*t.seed;g+=Math.cos(_*t.wobbleSpeed+11*t.seed)*h*v,f+=Math.sin(_*t.wobbleSpeed*1.23+9*t.seedY)*d*v,t.x=g,t.y=f,t.placed=!0}function Na(t,e,i){const n=Pa(t.seed,e);let s=82,a=58;return t.unavailable&&(s=18,a=42),`hsla(${n}, ${s}%, ${a}%, ${i})`}function ja(t,e,i,n,s,a,o=.5){t.beginPath(),t.arc(e,i,n*(1+a*o),0,Aa),t.fillStyle=s.replace(/[\d.]+\)$/,.07+.1*a+")"),t.fill(),t.beginPath(),t.arc(e,i,n,0,Aa),t.fillStyle=s,t.fill()}function Da(t,e,i,n){const s=.014*i,a=2.35*s,o=e.isOn?.013:.007,r=e.isOn?.28+.42*Math.sin(n*o+12*e.seed):.06+.05*Math.sin(n*o+12*e.seed),l=e.isOn?.92:.32,c=Pa(e.seed,n);t.beginPath(),t.arc(e.x,e.y,s,0,Aa),t.fillStyle=e.unavailable?`hsla(${c}, 18%, 42%, 0.35)`:`hsla(${c}, ${e.isOn?88:42}%, ${e.isOn?62:38}%, ${l})`,t.fill(),t.beginPath(),t.arc(e.x,e.y,a,0,Aa),t.strokeStyle=e.unavailable?`hsla(${c}, 12%, 45%, 0.12)`:`hsla(${c}, ${e.isOn?90:35}%, ${e.isOn?68:40}%, ${r})`,t.lineWidth=1.4,t.stroke()}function Ua(t,e,i,n){const s=e.lightBrightness,a=i*(.008+.024*s),o=e.unavailable?.25:e.isOn?.22+.72*s:.18,r=e.lightColor??(e.isOn?"rgb(255, 183, 77)":Na(e,n,.25));ja(t,e.x,e.y,a,function(t,e){const i=t.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/);return i?`rgba(${i[1]}, ${i[2]}, ${i[3]}, ${e})`:t.match(/hsla?\(([^)]+)\)/)?t.replace(/[\d.]+\)$/,`${e})`):t}(r,o),o)}function Ba(t,e,i,n){const s=e.timerUrgency,a=.005+.048*s,o=.42+.38*Math.sin(n*a+10*e.seed),r=e.unavailable?.25:Math.min(1,(.28+.35*s)*o+.2),l=i*(.012+.008*s),c=Pa(e.seed,n);if(ja(t,e.x,e.y,l,`hsla(${c}, 86%, ${58+12*s}%, ${r})`,r),s>.05){const i=.45*r*o;t.beginPath(),t.arc(e.x,e.y,2.1*l,0,Aa),t.strokeStyle=`hsla(${c}, 88%, 64%, ${i})`,t.lineWidth=1.2,t.stroke()}}function Ha(t,e,i,n){const s="numeric"===e.kind?.011*i+e.numericNorm*i*.007:.013*i,a=e.unavailable?.28:.78,o=Na(e,n,a);ja(t,e.x,e.y,s,o,a)}function Wa(t,e,i,n,s,a,o,r){const l=r?.15:1,c=i?.min??0,h=i?.max??100;if(e)for(const d of t)"timer"!==d.kind&&"light"!==d.kind||Ta(d,e,c,h);for(const d of t)d.phase+=d.baseOrbitSpeed*Oa(d)*a*l,Fa(d,n,s,o);!function(t,e,i,n){const{cx:s,cy:a,scale:o,clampX:r,clampY:l}=Ra(e,i),c=.11*o;for(const h of t){let e=h.x,i=h.y;for(const s of t){if(s===h)continue;const t=e-s.x,a=i-s.y,r=Math.hypot(t,a);if(r>.5&&r<c){const s=(c-r)/c*o*.018*n;e+=t/r*s,i+=a/r*s}}h.x=Math.min(s+r,Math.max(s-r,e)),h.y=Math.min(a+l,Math.max(a-l,i))}}(t,n,s,l)}function Ga(t,e,i,n,s,a){const{cx:o,cy:r,scale:l}=Ra(n,s);t.clearRect(0,0,n,s);const c=t.createRadialGradient(o,r,0,o,r,.72*l);c.addColorStop(0,"hsla(200, 70%, 58%, 0.06)"),c.addColorStop(.35,"hsla(260, 55%, 42%, 0.03)"),c.addColorStop(1,"hsla(0, 0%, 0%, 0)"),t.fillStyle=c,t.fillRect(0,0,n,s),function(t,e,i,n){for(const s of e){const e=s.age/1400,a=i*(.022+.42*e),o=.52*(1-e),r=Pa(s.seed,n);t.beginPath(),t.arc(s.x,s.y,a,0,Aa),t.strokeStyle=`hsla(${r}, 88%, 64%, ${o})`,t.lineWidth=1.2+2.2*(1-e),t.stroke()}}(t,i,l,a);for(const h of e)switch(h.kind){case"toggle":Da(t,h,l,a);break;case"light":Ua(t,h,l,a);break;case"timer":Ba(t,h,l,a);break;default:Ha(t,h,l,a)}ja(t,o,r,.012*l*(.55+.12*Math.sin(.0018*a)),`hsla(${Sa[Math.floor(14e-6*a%Sa.length)]}, 88%, 68%, 0.65)`,.5,.3)}var Va,Ya,Ka,Xa=/* @__PURE__ */dt({NvisionReactorCoreCardEditor:()=>Ka}),Qa=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ya(),se(),Va=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:ga,selector:{select:{options:[{value:"auto",label:"Auto-discover entities"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},oe()],Ya=[{name:"entities",selector:{entity:{multiple:!0,domain:[..._a]}}}],Ka=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"min"===t.name?"Numeric orbit min":"max"===t.name?"Numeric orbit max":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:ga,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...Va.slice(0,3),...Ya,...Va.slice(3)]:Va}render(){return this.hass&&this._config?G`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Bt(this,"config-changed",{config:t.detail.value})}},ie([zt()],Ka.prototype,"_config",void 0),Ka=ie([yt(pa)],Ka)});kt(),Dt(),ya(),se(),Ut({type:ma,name:"Nvision Reactor Core",description:"Orbiting sensor particles with reactor-style pulse effects"});var Za=class extends _t{constructor(...t){super(...t),this._frameId=0,this._animating=!1,this._lastFrame=0,this._particles=[],this._pulses=[],this._entityKey="",this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Qa(),Xa)),document.createElement(pa)}static getStubConfig(t,e,i){const n=[...e,...i,...Object.keys(t.states)],s=/* @__PURE__ */new Set,a=[];for(const o of n){if(s.has(o))continue;s.add(o);const t=o.split(".",1)[0];if("sensor"!==t&&"binary_sensor"!==t&&"switch"!==t&&"light"!==t&&"timer"!==t||a.push(o),a.length>=8)break}return{type:`custom:${ma}`,mode:ga,entities:a.length?a:void 0,max_particles:32,min:0,max:100}}setConfig(t){this._config={mode:ga,max_particles:32,min:0,max:100,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t},this._entityKey="",this._pulses=[]}getCardSize(){return 2}getGridOptions(){return{columns:6,rows:2}}connectedCallback(){super.connectedCallback(),this._lastFrame=0,this._startAnimation()}disconnectedCallback(){this._stopAnimation(),this._resizeObserver?.disconnect(),this._resizeObserver=void 0,super.disconnectedCallback()}updated(t){(t.has("hass")||t.has("_config"))&&this.hass&&this._config&&this._syncParticles(),this._ensureCanvas()}_canvasSize(){const t=this._canvas;return t?{width:t.clientWidth,height:t.clientHeight}:{width:0,height:0}}_syncParticles(t=performance.now()){if(!this.hass||!this._config)return;const{width:e,height:i}=this._canvasSize(),n=Ja(this.hass,this._config).join("|"),s=[this._config.mode,this._config.max_particles,(this._config.domains??[]).join(","),(this._config.exclude??[]).join(","),this._config.min,this._config.max,(this._config.entities??[]).join(","),e,i].join(";");n+s!==this._entityKey&&(this._pulses=[],this._entityKey=n+s),this._particles=function(t,e,i,n,s=0,a=0,o=0){const r=i.min??0,l=i.max??100,c=La(e,i),h=new Map(t.map(t=>[t.entityId,t])),d=[];for(let u=0;u<c.length;u+=1){const t=c[u],i=h.get(t);if(i){const h=Ea(u,c.length),m=e.states[t]?.state??"";i.shell=h.shell,i.slot=h.slot,i.slotsOnShell=h.slotsOnShell,s>0&&a>0&&Fa(i,s,a,o),void 0!==i.lastState&&m!==i.lastState&&Ia(i,n),i.lastState=m,Ta(i,e,r,l),d.push(i);continue}const m=qa(e,t,r,l,u,c.length);s>0&&a>0&&Fa(m,s,a,o),d.push(m)}return d}(this._particles,this.hass,this._config,this._pulses,e,i,t)}_ensureCanvas(){const t=this._canvas;if(t){if(!this._ctx){if(this._ctx=t.getContext("2d")??void 0,!this._ctx)return;this._resizeObserver=new ResizeObserver(()=>{this._resizeCanvas(),this._syncParticles()}),this._resizeObserver.observe(this._stage??t.parentElement??this)}this._resizeCanvas(),this._syncParticles(),this._animating||(this._lastFrame=0,this._startAnimation())}}_startAnimation(){if(this._animating||!this._ctx)return;this._animating=!0;const t=e=>{if(!this.isConnected||!this._ctx)return void(this._animating=!1);const i=this._lastFrame?Math.min((e-this._lastFrame)/16.67,3):1,n=this._lastFrame?e-this._lastFrame:16.67;this._lastFrame=e,this._draw(i,n,e),this._frameId=requestAnimationFrame(t)};this._frameId=requestAnimationFrame(t)}_stopAnimation(){cancelAnimationFrame(this._frameId),this._animating=!1}_resizeCanvas(){const t=this._canvas;if(!t)return;const e=t.getBoundingClientRect(),i=window.devicePixelRatio||1;t.width=Math.max(1,Math.floor(e.width*i)),t.height=Math.max(1,Math.floor(e.height*i)),this._ctx?.setTransform(i,0,0,i,0,0)}_draw(t,e,i){const n=this._canvas,s=this._ctx;if(!(n&&s&&this.hass&&this._config))return;const a=n.clientWidth,o=n.clientHeight;if(a<=0||o<=0)return;this._particles.length||this._syncParticles(i);const r=window.matchMedia("(prefers-reduced-motion: reduce)").matches;Wa(this._particles,this.hass,this._config,a,o,t,i,r),function(t,e){for(let i=t.length-1;i>=0;i-=1)t[i].age+=e,t[i].age>=1400&&t.splice(i,1)}(this._pulses,e),Ga(s,this._particles,this._pulses,a,o,i)}render(){if(!this._config||!this.hass)return K;const t=this._config.name||"Reactor Core",e=this._particles.length||Ja(this.hass,this._config).length;return G`
      <ha-card>
        <div class="stage">
          <canvas aria-hidden="true"></canvas>
          <div
    ...
    `]}};function Ja(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:[..._a],n=e.max_particles??32;return Object.keys(t.states).filter(t=>i.includes(t.split(".",1)[0])).sort((t,e)=>t.localeCompare(e)).slice(0,n)}ie([St({attribute:!1})],Za.prototype,"hass",void 0),ie([zt()],Za.prototype,"_config",void 0),ie([It(".stage")],Za.prototype,"_stage",void 0),ie([It("canvas")],Za.prototype,"_canvas",void 0),Za=ie([yt(ma)],Za),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");