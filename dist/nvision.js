...
`,ee=ht(()=>{Xt="nvision-blank-card",Qt="nvision-blank-card-editor"});function ie(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var ne,se=ht(()=>{}),ae=ht(()=>{kt(),se(),ne=class extends _t{},ie([St({attribute:!1})],ne.prototype,"hass",void 0)});function oe(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function re(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,ce,he=ht(()=>{}),de=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ce}),ue=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ee(),se(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},oe()],ce=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
      ...
      ></ha-form>
    `:K}_valueChanged(t){Bt(this,"config-changed",{config:t.detail.value})}},ie([zt()],ce.prototype,"_config",void 0),ce=ie([yt(Qt)],ce)});kt(),Dt(),ee(),se(),Ut({type:Xt,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var me=class extends _t{constructor(...t){super(...t),this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(ue(),de)),document.createElement(Qt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Xt}`,entity:n}}setConfig(t){this._config={tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Kt(t);return W`
      <ha-card>
        <div
          class="content"
          role="button"
  ...
  `]}};ie([St({attribute:!1})],me.prototype,"hass",void 0),ie([zt()],me.prototype,"_config",void 0),me=ie([yt(Xt)],me);var pe=1,ge=t=>(...e)=>({_$litDirective$:t,values:e}),fe=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};wt();var _e,ve,ye,be,xe=ge(class extends fe{constructor(t){if(super(t),t.type!==pe||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const n=t[i];return null==n?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const n of this.ft)e[n]??(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in e){const t=e[n];if(null!=t){this.ft.add(n);const e="string"==typeof t&&t.endsWith(" !important");n.includes("-")||e?i.setProperty(n,e?t.slice(0,-11):t,e?"important":""):i[n]=t}}return Y}});function we(t,e,i){return getComputedStyle(t).getPropertyValue(e).trim()||i}function $e(t,e){if(!t)return e;if(Array.isArray(t)&&t.length>=3)return`rgb(${t[0]}, ${t[1]}, ${t[2]})`;if("string"==typeof t){const e=t.split(",").map(t=>Number(t.trim()));return e.length>=3&&e.every(t=>Number.isFinite(t))?`rgb(${e[0]}, ${e[1]}, ${e[2]})`:t}return e}function Me(t,e,i,n){return $e(t,we(e,i,n))}function ke(t){_e??=document.createElement("canvas"),_e.width=1,_e.height=1;const e=_e.getContext("2d");if(!e)return[41,182,246];e.fillStyle="#000000",e.fillStyle=t,e.fillRect(0,0,1,1);const[i,n,s]=e.getImageData(0,0,1,1).data;return[i,n,s]}function Ce([t,e,i]){return`rgb(${t}, ${e}, ${i})`}function Se(t,e,i){return[Math.round(t[0]+(e[0]-t[0])*i),Math.round(t[1]+(e[1]-t[1])*i),Math.round(t[2]+(e[2]-t[2])*i)]}function Ae(t,e){return e>=0?Se(t,[255,255,255],e):Se(t,[0,0,0],-e)}function ze(t,e){const i=ke(we(t,"--success-color","#4caf50")),n=ke(we(t,"--warning-color","#ff9800")),s=ke(we(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return Ce(a<=.5?Se(i,n,2*a):Se(n,s,2*(a-.5)))}var Ee,Pe,Te=ht(()=>{ve="nvision-activity-card",ye="nvision-activity-card-editor",be={still:"idle",unknown:"idle",on_foot:"on_foot",walking:"walking",running:"running",on_bicycle:"bicycle",in_vehicle:"vehicle",automotive:"vehicle",tilting:"tilting"}}),Oe=/* @__PURE__ */dt({NvisionActivityCardEditor:()=>Pe}),Ie=ht(()=>{kt(),Dt(),Ht(),ae(),he(),Te(),se(),Ee=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"color",selector:{color_rgb:{}}},{name:"speed",required:!0,default:1,selector:{number:{min:.25,max:3,step:.05}}},oe()],Pe=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"color"===t.name?"Figure color":"speed"===t.name?"Animation speed":"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={speed:1,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Bt(this,"config-changed",{config:t.detail.value})}},ie([zt()],Pe.prototype,"_config",void 0),Pe=ie([yt(ye)],Pe)});function Le(t,e,i){const n=.7*i;return V`
  ...
  `}kt(),Dt(),Te(),se(),Ut({type:ve,name:"Nvision Activity",description:"Animated figure that reacts to detected activity (walking, running, cycling, driving…)"});var qe,Re,Fe,Ne,je=class extends _t{constructor(...t){super(...t),this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Ie(),Oe)),document.createElement(ye)}static getStubConfig(t,e,i){const n=e.find(t=>t.toLowerCase().includes("activity"))||e.find(t=>t.startsWith("sensor."))||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${ve}`,entity:n}}setConfig(t){this._config={speed:1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 4}getGridOptions(){return{columns:6,rows:4}}_renderScene(t){return"bicycle"===t?this._renderCyclist():"vehicle"===t?this._renderCar():this._renderPerson()}_renderPerson(){return V`
  ...
  `]}};ie([St({attribute:!1})],Dn.prototype,"hass",void 0),ie([zt()],Dn.prototype,"_config",void 0),ie([zt()],Dn.prototype,"_gaugeReady",void 0),ie([zt()],Dn.prototype,"_tick",void 0),Dn=ie([yt(Mn)],Dn);var Un,Bn,Hn=ht(()=>{Nn="nvision-power-draw-card",jn="nvision-power-draw-card-editor"}),Gn=/* @__PURE__ */dt({NvisionPowerDrawCardEditor:()=>Bn}),Wn=ht(()=>{kt(),Dt(),Ht(),ae(),he(),hi(),Hn(),se(),Un=[{name:"entity",selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:qe,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"effects_min",required:!0,default:0,selector:{number:{min:0,max:1,step:.05}}},{name:"effects_max",required:!0,default:1,selector:{number:{min:0,max:1,step:.05}}}]},{name:"color",selector:{color_rgb:{}}},{name:"icon",selector:{icon:{}}},oe()],Bn=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum watts":"max"===t.name?"Maximum watts":"effects_min"===t.name?"Minimum effect":"effects_max"===t.name?"Maximum effect":"color"===t.name?"Lightning color":"icon"===t.name?"Source icon":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:qe,effects_min:0,effects_max:1,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Un}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Bt(this,"config-changed",{config:t.detail.value})}},ie([zt()],Bn.prototype,"_config",void 0),Bn=ie([yt(jn)],Bn)});kt(),Dt(),hi(),Hn(),se(),Ut({type:Nn,name:"Nvision Power Draw",description:"Power consumption with animated lightning from a plug"});var Vn,Yn,Kn=class extends _t{constructor(...t){super(...t),this._displayIntensity=0,this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Wn(),Gn)),document.createElement(jn)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return"power"===i?.attributes.device_class||e.includes("power")||void 0!==Ze(i?.state)})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Nn}`,entity:n,min:0,max:qe}}setConfig(t){this._config={min:0,max:qe,effects_min:0,effects_max:1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}disconnectedCallback(){this._renderer?.detach(),super.disconnectedCallback()}firstUpdated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}updated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}_lightningColor(){return Ue(this._config?.color,this)}_overMaxColor(){return Ve(this)}_rawValue(){const t=this._config?.entity;return Ze(t?this.hass?.states[t]?.state:void 0)}_overMaxSeverity(){const t=this._rawValue();return void 0===t?0:We(t,this._config?.min??0,this._config?.max??3e3)}_syncLightningTheme(){const t=this._overMaxSeverity()>0?this._overMaxColor():this._lightningColor();this.style.setProperty("--lightning-color",t),this.style.setProperty("--lightning-glow",String(Ge(this._displayIntensity)))}_targetIntensity(){return He(this._rawValue(),this._config??{})}_tickIntensity(t){const e=this._targetIntensity(),i=e-this._displayIntensity;return Math.abs(i)<.001?this._displayIntensity=e:this._displayIntensity+=i*Re*t,this._syncLightningTheme(),this._displayIntensity}_ensureRenderer(){const t=this._canvas;t&&(this._renderer||(this._renderer=new Ne(this,t=>this._buildArcs(t),()=>this._lightningColor(),t=>{this._tickIntensity(t)})),this._renderer.attach(t))}_buildArcs(t){const e=this._canvas;if(!e)return[];const i=ei(this._plug,e,"center"),n=ei(this._entityIcon,e,"center");if(!i||!n)return[];const s=this._overMaxSeverity(),a=s>0?this._overMaxColor():this._lightningColor(),o=[{from:i,to:n,intensity:this._displayIntensity,color:a}];if(s>0){const{width:i,height:r}=e.getBoundingClientRect();Xe(o,n,i,r,s,t,a)}return o}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Power Draw",i=Kt(t);return W`
  ...
  `}};function ks(t){return String(t).padStart(2,"0")}function Cs(t,e){const i=Object.fromEntries(function(t){let e=xs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),xs.set(t,e)),e}(e).formatToParts(new Date(t)).map(t=>[t.type,t.value])),n=bs.indexOf(String(i.weekday))>=0?bs.indexOf(String(i.weekday)):0,s=Number(i.year),a=Number(i.month),o=Number(i.day);return{year:s,month:a,day:o,hour:Number(i.hour)%24,weekday:n,dateKey:`${s}-${ks(a)}-${ks(o)}`,monthKey:`${s}-${ks(a)}`}}function Ss(t,e,i){const n=Cs(As(t,e,i),e);return`${n.year}-${ks(n.month)}-${ks(n.day)}`}function As(t,e,i){const n=Cs(t,e),s=(n.weekday-i+7)%7;return zs(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function zs(t,e,i,n,s,a){const o=Date.UTC(t,e-1,i,n,s,0),r=Object.fromEntries(function(t){let e=ws.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),ws.set(t,e)),e}(a).formatToParts(new Date(o)).map(t=>[t.type,t.value]));return o-(Date.UTC(Number(r.year),Number(r.month)-1,Number(r.day),Number(r.hour),Number(r.minute),0)-o)}function Es(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...Cs(t,e),weekKey:Ss(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function Ps(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>bs[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=Cs(t.startMs,e);let s=zs(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=Cs(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=As(t.startMs,e,i);for(;s<=t.endMs;){const t=Cs(s,e);n.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=Cs(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${ks(a)}`;if(i.push({key:n,label:`${s}-${ks(a)}`}),a+=1,a>12&&(a=1,s+=1),zs(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const o=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const r of o)a.set(r.key,`${new Date(r.start).toLocaleString()} – ${new Date(r.end).toLocaleString()}`);return{keys:o.map(t=>t.key),labels:o.map(t=>t.label),bucketRanges:a}}function Ts(t,e,i,n,s,a,o){return"time"===t?o.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function Os(t){return vs[t&&ys[t]||(t&&t in vs?t:void 0)||"week_hourly"]}function Is(t,e,i,n,s){const a=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(_s[i]),o=(r=a.hours)<=24||r<=48||r<=336?36e5:864e5;var r;const l=Ps(t,a,n,s,o),c=Ps(e,a,n,s,o);return{window:a,bucketMs:o,xAxis:l,yAxis:c,xKeySet:new Set(l.keys),yKeySet:new Set(c.keys),bucketMap:/* @__PURE__ */new Map}}function Ls(t,e,i,n,s,a){if(e.time<t.window.startMs||e.time>t.window.endMs)return;const o=Es(i,e.time,s,t.bucketMs,a),r=Es(n,e.time,s,t.bucketMs,a);if(void 0===o||void 0===r)return;if(!t.xKeySet.has(o)||!t.yKeySet.has(r))return;const l=`${r}|${o}`,c=t.bucketMap.get(l)??[];c.push({time:e.time,value:e.value}),t.bucketMap.set(l,c)}function qs(t,e,i,n,s,a){const o=[],r=t.yAxis.keys.map((s,a)=>t.xAxis.keys.map((r,l)=>{const c=t.bucketMap.get(`${s}|${r}`)??[],h=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e.value,0);case"max":return Math.max(...t.map(t=>t.value));case"min":return Math.min(...t.map(t=>t.value));case"last":{let e=t[0];for(const i of t)i.time>=e.time&&(e=i);return e.value}default:return t.reduce((t,e)=>t+e.value,0)/t.length}}(c,n);return null!==h&&o.push(h),{value:h,count:c.length,rangeLabel:Ts(e,i,r,0,t.xAxis.labels[l],t.yAxis.labels[a],t.xAxis.bucketRanges)}}));let l=s,c=a;if(void 0===l||void 0===c){const t=o.length?Math.min(...o):0,e=o.length?Math.max(...o):1;l=l??t,c=c??(e===t?t+1:e)}return c<=l&&(c=l+1),{xLabels:t.xAxis.labels,yLabels:t.yAxis.labels,xKeys:t.xAxis.keys,yKeys:t.yAxis.keys,cells:r,min:l,max:c}}function Rs(t,e,i){return null===t?0:Math.min(1,Math.max(0,(t-e)/(i-e)))}ie([St({attribute:!1})],Ms.prototype,"hass",void 0),ie([zt()],Ms.prototype,"_config",void 0),Ms=ie([yt(rs)],Ms);var Fs=ht(()=>{_s={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},vs={week_hourly:{x:"hour",y:"day",period:"7d"},two_weeks:{x:"hour",y:"day",period:"14d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_days:{x:"weekday",y:"week",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},quarter:{x:"week",y:"month",period:"90d"},timeline_24h:{x:"time",y:"none",period:"24h"},timeline_48h:{x:"time",y:"none",period:"48h"},year_overview:{x:"week",y:"month",period:"365d"}},ys={timeline:"timeline_24h",custom:"week_hourly"},bs=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],xs=/* @__PURE__ */new Map,ws=/* @__PURE__ */new Map,$s=["day","week","month"]});function Ns(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function js(t){return Ns(t)}function Ds(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function Us(t,e){const i=(...t)=>{for(const e of t){if(null==e)continue;const t=Number(e);if(Number.isFinite(t))return t}};switch(e){case"mean":default:return i(t.mean,t.state);case"sum":return i(t.sum,t.change,t.state);case"max":return i(t.max,t.state,t.sum);case"min":return i(t.min,t.state);case"last":return i(t.state,t.mean);case"count":return i(t.change)}}function Bs(t){if("string"==typeof t){const e=Date.parse(t);return Number.isFinite(e)?e:void 0}return t<1e11?1e3*t:t}var Hs,Gs,Ws,Vs,Ys,Ks,Xs;async function Qs(t,e,i,n,s,a="mean"){const o=js(t),r=function(t){return"max"===t||"last"===t}(a);return function(t,e,i=!1){if(t.length<=e)return t;const n=Math.ceil(t.length/e),s=[];for(let a=0;a<t.length;a+=n){const e=t.slice(a,a+n);e.length&&(i?s.push(e.reduce((t,e)=>e.value>t.value||e.value===t.value&&e.time>t.time?e:t,e[0])):s.push(e[0]))}return s}(function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await o({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!r}),e),s),8e3,r)}async function Zs(t,e,i,n,s,a){const o=js(t),r="sum"===s?["sum","change","state"]:"max"===s?["max","state","sum"]:"min"===s?["min","state"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=Us(n,e);if(null==t||!Number.isFinite(t))continue;const s=Bs(n.start);void 0!==s&&i.push({time:s,value:t})}return i}((await o({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:r}))[e]??[],s)}var Js,ta,ea,ia=ht(()=>{Fs(),Hs="nvision-heat-map-card",Gs="nvision-heat-map-card-editor",Ws="week_hourly",Vs="theme",Ys=[{value:"week_hourly",label:"Week — hour × day"},{value:"two_weeks",label:"Two weeks — hour × day"},{value:"daily_rhythm",label:"Daily rhythm — hour × weekday"},{value:"month_days",label:"Month — weekday × week"},{value:"month_calendar",label:"Quarter calendar — weekday × week"},{value:"quarter",label:"Quarter — week × month"},{value:"timeline_24h",label:"Timeline — 24 hours"},{value:"timeline_48h",label:"Timeline — 48 hours"},{value:"year_overview",label:"Year — week × month"}],Ks=[{value:"theme",label:"Theme"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"},{value:"custom",label:"Custom"}],Xs=[{value:"auto",label:"Auto"},{value:"mean",label:"Mean"},{value:"sum",label:"Sum"},{value:"max",label:"Maximum"},{value:"min",label:"Minimum"},{value:"count",label:"Count"},{value:"last",label:"Last"}]}),na=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>ea}),sa=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ia(),se(),Js=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:Ws,selector:{select:{options:[...Ys],mode:"dropdown"}}},{name:"operation",default:"auto",selector:{select:{options:[...Xs],mode:"dropdown"}}},{name:"color_mode",required:!0,default:Vs,selector:{select:{options:[...Ks],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_cell_values",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}},{name:"dim_low_values",selector:{boolean:{}}}]},oe()],ta=[{type:"grid",name:"",schema:[{name:"color_low",selector:{color_rgb:{}}},{name:"color_high",selector:{color_rgb:{}}}]}],ea=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"View":"color_mode"===t.name?"Color mode":"operation"===t.name?"Operation":"color_low"===t.name?"Low color":"color_high"===t.name?"High color":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Scale":"show_cell_values"===t.name?"Values in cells":"dim_low_values"===t.name?"Dim low values":"show_current"===t.name?"Current value":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:Ws,color_mode:Vs,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,...t,color_mode:"primary"===t.color_mode?"theme":t.color_mode,operation:t.operation??"auto"}}_schema(){return"custom"===this._config?.color_mode?[...Js,...ta]:Js}render(){return this.hass&&this._config?W`
            ...
            <div class="grid-wrap">
              ...
              >
                    ${t.cells.flatMap((a,o)=>{const h=o+1;return[n?W`
                          ...
                          `:K,...a.map((n,a)=>{const o=Rs(n.value,t.min,t.max),d=null!==n.value;return W`
                          <div
    ...
    `}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||this._config.entity||"Heat Map",i=!1!==this._config.show_current?Kt(t):"";return W`
      <ha-card>
        <div class="stage">
          <div
            class="header"
  ...
  `]}};ie([St({attribute:!1})],va.prototype,"hass",void 0),ie([zt()],va.prototype,"_config",void 0),ie([zt()],va.prototype,"_grid",void 0),ie([zt()],va.prototype,"_loading",void 0),ie([zt()],va.prototype,"_error",void 0),ie([zt()],va.prototype,"_popover",void 0),ie([zt()],va.prototype,"_xLabelVisible",void 0),va=ie([yt(Hs)],va);var ya=ht(()=>{ma="nvision-reactor-core-card",pa="nvision-reactor-core-card-editor",ga="auto",fa=["sensor","binary_sensor","switch","light","timer"],_a=["sensor","binary_sensor","switch","light","timer"]});function ba(t){const e=t.split(":").map(Number);return 3===e.length?3600*e[0]+60*e[1]+e[2]:2===e.length?60*e[0]+e[1]:Number(t)||0}function xa(t){return void 0!==t&&"unavailable"!==t&&"unknown"!==t&&("on"===t||"true"===t||"open"===t||"home"===t||"active"===t)}function wa(t,e){const i=e.split(".",1)[0];if("light"===i)return"light";if("timer"===i)return"timer";if("switch"===i||Ds(e))return"toggle";const n=t.states[e]?.state;return void 0!==Ze(n)?"numeric":"other"}function $a(t,e,i,n){const s=Ze(t.states[e]?.state);return void 0===s?.35:Je(s,i,n)}function Ma(t,e){const i=t.states[e];if(!i||"active"!==i.state)return 0;const n=function(t){const e=t.attributes.remaining;if("string"!=typeof e)return;let i=ba(e);if("active"===t.state&&t.attributes.finishes_at){const e=new Date(String(t.attributes.finishes_at)).getTime();i=Math.max((e-Date.now())/1e3,0)}return i}(i),s=function(t){const e=t.attributes.duration;return"string"==typeof e?ba(e):0}(i);return void 0===n||s<=0?.55:1-Math.min(1,Math.max(0,n/s))}function ka(t,e,i,n){const s=t.states[e]?.state,a=wa(t,e),o="light"===a?function(t,e){const i=t.states[e];if(!i||"on"!==i.state)return{lightBrightness:0};const n=os(i);return{lightColor:n?`rgb(${n.join(", ")})`:void 0,lightBrightness:ns(i)}}(t,e):{};return{kind:a,isOn:xa(s),numericNorm:$a(t,e,i,n),lightColor:o.lightColor,lightBrightness:o.lightBrightness??0,timerUrgency:"timer"===a?Ma(t,e):0,unavailable:"unavailable"===s||"unknown"===s}}ya(),hi();var Ca=[.42,.58,.72,.84],Sa=[185,198,215,248,278,312,42],Aa=2*Math.PI;function za(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}function Ea(t,e){const i=Math.min(Ca.length,Math.max(2,Math.ceil(Math.sqrt(e)))),n=t%i,s=Math.ceil(e/i);return{shell:n,slot:Math.floor(t/i)%s,slotsOnShell:s}}function Pa(t,e){const i=(14e-6*e+.31*t)%Sa.length,n=Math.floor(i);return Sa[n]+(Sa[(n+1)%Sa.length]-Sa[n])*(i-n)}function Ta(t,e,i,n){const s=ka(e,t.entityId,i,n);t.kind=s.kind,t.isOn=s.isOn,t.numericNorm=s.numericNorm,t.lightColor=s.lightColor,t.lightBrightness=s.lightBrightness,t.timerUrgency=s.timerUrgency,t.unavailable=s.unavailable}function Oa(t){if("numeric"===t.kind){const e=t.numericNorm;return.15+e*e*5.5}return"timer"===t.kind?.6+2.4*t.timerUrgency:.75+.5*t.seed}function Ia(t,e){switch(e){case"toggle":return.016*t;case"light":return.011*t;case"timer":return.013*t;case"numeric":return.012*t;default:return.01*t}}function La(t,e){e.push({x:t.x,y:t.y,age:0,seed:t.seed})}function qa(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:fa,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function Ra(t,e,i,n,s,a){const o=za(e),r=za(`${e}:y`),l=Ea(s,a),c=t.states[e]?.state,h=l.shell%2==0?1:-1,d={entityId:e,kind:wa(t,e),seed:o,seedY:r,x:0,y:0,phase:o*Aa,shell:l.shell,slot:l.slot,slotsOnShell:l.slotsOnShell,orbitTilt:o*Aa,orbitRyScale:.62+.32*r,baseOrbitSpeed:h*(85e-5+.0011*o),wobbleSpeed:.0016+.0024*r,vx:0,vy:0,isOn:!1,lastState:c,numericNorm:.35,lightBrightness:0,timerUrgency:0,unavailable:"unavailable"===c||"unknown"===c,placed:!1};return Ta(d,t,i,n),d}function Fa(t,e){const i=t/2,n=e/2,s=Math.max(10,.06*t),a=Math.max(10,.06*e),o=Math.max(1,t/2-s),r=Math.max(1,e/2-a);return{cx:i,cy:n,halfW:o,halfH:r,scale:Math.min(t,e),clampX:o,clampY:r}}function Na(t,e,i,n){const{cx:s,cy:a,halfW:o,halfH:r}=Fa(e,i),l=Ca[t.shell%Ca.length],c=t.slot/Math.max(1,t.slotsOnShell)*Aa+.55*t.seed+t.phase,h=o*l,d=r*l*t.orbitRyScale,u=Math.cos(c)*h,m=Math.sin(c)*d,p=t.orbitTilt;let g=s+u*Math.cos(p)-m*Math.sin(p),f=a+u*Math.sin(p)+m*Math.cos(p);const _=.001*n,v=.028+.018*t.seed;return g+=Math.cos(_*t.wobbleSpeed+11*t.seed)*h*v,f+=Math.sin(_*t.wobbleSpeed*1.23+9*t.seedY)*d*v,{x:g,y:f}}function ja(t,e,i,n){const s=Na(t,e,i,n);t.x=s.x,t.y=s.y,t.placed=!0}function Da(t,e,i){const n=Pa(t.seed,e);let s=82,a=58;return t.unavailable&&(s=18,a=42),`hsla(${n}, ${s}%, ${a}%, ${i})`}function Ua(t,e,i,n,s,a,o=.5){t.beginPath(),t.arc(e,i,n*(1+a*o),0,Aa),t.fillStyle=s.replace(/[\d.]+\)$/,.07+.1*a+")"),t.fill(),t.beginPath(),t.arc(e,i,n,0,Aa),t.fillStyle=s,t.fill()}function Ba(t,e,i,n){const s=e.isOn?.012:.007,a=Math.sin(n*s+12*e.seed),o=1+a*(e.isOn?.42:.14),r=Ia(i,"toggle")*o,l=e.isOn?.88:.32,c=e.isOn?(.45+.4*a)*o:(.08+.04*a)*o,h=Pa(e.seed,n),d=e.unavailable?`hsla(${h}, 18%, 42%, ${.4*l})`:`hsla(${h}, ${e.isOn?88:42}%, ${e.isOn?62:38}%, ${l})`;Ua(t,e.x,e.y,r,d,c)}function Ha(t,e,i,n){const s=e.lightBrightness,a=i*(.008+.024*s),o=e.unavailable?.25:e.isOn?.22+.72*s:.18,r=e.lightColor??(e.isOn?"rgb(255, 183, 77)":Da(e,n,.25));Ua(t,e.x,e.y,a,function(t,e){const i=t.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/);return i?`rgba(${i[1]}, ${i[2]}, ${i[3]}, ${e})`:t.match(/hsla?\(([^)]+)\)/)?t.replace(/[\d.]+\)$/,`${e})`):t}(r,o),o)}function Ga(t,e,i,n){const s=e.timerUrgency,a=.005+.048*s,o=Math.sin(n*a+10*e.seed),r=1+o*(.15+.35*s),l=e.unavailable?.25:.35+.25*s,c=(.22+.3*o)*(.3+.7*s)*r,h=Ia(i,"timer")*r,d=Pa(e.seed,n);Ua(t,e.x,e.y,h,`hsla(${d}, 86%, ${58+12*s}%, ${l})`,c)}function Wa(t,e,i,n){const s="numeric"===e.kind?function(t,e){return t*(.006+.028*e)}(i,e.numericNorm):Ia(i,e.kind),a=e.unavailable?.28:.78,o=Da(e,n,a);Ua(t,e.x,e.y,s,o,.65*a)}function Va(t,e,i,n,s,a,o,r){const l=r?.15:1,c=i?.min??0,h=i?.max??100;if(e)for(const d of t)"timer"!==d.kind&&"light"!==d.kind&&"numeric"!==d.kind||Ta(d,e,c,h);!function(t,e,i,n,s,a){const{cx:o,cy:r,scale:l,clampX:c,clampY:h}=Fa(e,i),d=.13*l,u=.0032*a,m=.11*a;for(const p of t){p.phase+=p.baseOrbitSpeed*Oa(p)*n;const l=Na(p,e,i,s);p.vx+=(l.x-p.x)*u*n,p.vy+=(l.y-p.y)*u*n;for(const e of t){if(e===p)continue;const t=p.x-e.x,i=p.y-e.y,s=Math.hypot(t,i);if(s>.5&&s<d){const e=((d-s)/d)**1.5*m*n;p.vx+=t/s*e,p.vy+=i/s*e}}const g=o-p.x,f=r-p.y,_=Math.hypot(g,f);_>.96*Math.min(c,h)&&(p.vx+=g/_*.006*n*a,p.vy+=f/_*.006*n*a),p.vx*=.88,p.vy*=.88,p.x+=p.vx*n*a*16,p.y+=p.vy*n*a*16,p.x=Math.min(o+c,Math.max(o-c,p.x)),p.y=Math.min(r+h,Math.max(r-h,p.y)),p.placed=!0}}(t,n,s,a,o,l)}function Ya(t,e,i,n,s,a){const{cx:o,cy:r,scale:l}=Fa(n,s);t.clearRect(0,0,n,s);const c=t.createRadialGradient(o,r,0,o,r,.72*l);c.addColorStop(0,"hsla(200, 70%, 58%, 0.06)"),c.addColorStop(.35,"hsla(260, 55%, 42%, 0.03)"),c.addColorStop(1,"hsla(0, 0%, 0%, 0)"),t.fillStyle=c,t.fillRect(0,0,n,s),function(t,e,i,n){for(const s of e){const e=s.age/1400,a=i*(.04+.55*e),o=(1-e)**1.4*.09,r=Pa(s.seed,n),l=t.createRadialGradient(s.x,s.y,.15*a,s.x,s.y,a);l.addColorStop(0,`hsla(${r}, 82%, 62%, 0)`),l.addColorStop(.55,`hsla(${r}, 82%, 62%, ${o})`),l.addColorStop(1,`hsla(${r}, 82%, 62%, 0)`),t.beginPath(),t.arc(s.x,s.y,a,0,Aa),t.fillStyle=l,t.fill()}}(t,i,l,a);for(const h of e)switch(h.kind){case"toggle":Ba(t,h,l,a);break;case"light":Ha(t,h,l,a);break;case"timer":Ga(t,h,l,a);break;default:Wa(t,h,l,a)}Ua(t,o,r,.012*l*(.55+.12*Math.sin(.0018*a)),`hsla(${Sa[Math.floor(14e-6*a%Sa.length)]}, 88%, 68%, 0.65)`,.5,.3)}var Ka,Xa,Qa,Za=/* @__PURE__ */dt({NvisionReactorCoreCardEditor:()=>Qa}),Ja=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ya(),se(),Ka=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:ga,selector:{select:{options:[{value:"auto",label:"Auto-discover entities"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},oe()],Xa=[{name:"entities",selector:{entity:{multiple:!0,domain:[..._a]}}}],Qa=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"min"===t.name?"Numeric orbit min":"max"===t.name?"Numeric orbit max":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:ga,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...Ka.slice(0,3),...Xa,...Ka.slice(3)]:Ka}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Bt(this,"config-changed",{config:t.detail.value})}},ie([zt()],Qa.prototype,"_config",void 0),Qa=ie([yt(pa)],Qa)});kt(),Dt(),ya(),se(),Ut({type:ma,name:"Nvision Reactor Core",description:"Orbiting sensor particles with reactor-style pulse effects"});var to=class extends _t{constructor(...t){super(...t),this._frameId=0,this._animating=!1,this._lastFrame=0,this._particles=[],this._pulses=[],this._entityKey="",this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Ja(),Za)),document.createElement(pa)}static getStubConfig(t,e,i){const n=[...e,...i,...Object.keys(t.states)],s=/* @__PURE__ */new Set,a=[];for(const o of n){if(s.has(o))continue;s.add(o);const t=o.split(".",1)[0];if("sensor"!==t&&"binary_sensor"!==t&&"switch"!==t&&"light"!==t&&"timer"!==t||a.push(o),a.length>=8)break}return{type:`custom:${ma}`,mode:ga,entities:a.length?a:void 0,max_particles:32,min:0,max:100}}setConfig(t){this._config={mode:ga,max_particles:32,min:0,max:100,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t},this._entityKey="",this._pulses=[]}getCardSize(){return 2}getGridOptions(){return{columns:6,rows:2}}connectedCallback(){super.connectedCallback(),this._lastFrame=0,this._startAnimation()}disconnectedCallback(){this._stopAnimation(),this._resizeObserver?.disconnect(),this._resizeObserver=void 0,super.disconnectedCallback()}updated(t){(t.has("hass")||t.has("_config"))&&this.hass&&this._config&&this._syncParticles(),this._ensureCanvas()}_canvasSize(){const t=this._canvas;return t?{width:t.clientWidth,height:t.clientHeight}:{width:0,height:0}}_syncParticles(t=performance.now()){if(!this.hass||!this._config)return;const{width:e,height:i}=this._canvasSize(),n=eo(this.hass,this._config).join("|"),s=[this._config.mode,this._config.max_particles,(this._config.domains??[]).join(","),(this._config.exclude??[]).join(","),this._config.min,this._config.max,(this._config.entities??[]).join(","),e,i].join(";");n+s!==this._entityKey&&(this._pulses=[],this._entityKey=n+s),this._particles=function(t,e,i,n,s=0,a=0,o=0){const r=i.min??0,l=i.max??100,c=qa(e,i),h=new Map(t.map(t=>[t.entityId,t])),d=[];for(let u=0;u<c.length;u+=1){const t=c[u],i=h.get(t);if(i){const h=Ea(u,c.length),m=e.states[t]?.state??"";i.shell=h.shell,i.slot=h.slot,i.slotsOnShell=h.slotsOnShell,s>0&&a>0&&ja(i,s,a,o),void 0!==i.lastState&&m!==i.lastState&&La(i,n),i.lastState=m,Ta(i,e,r,l),d.push(i);continue}const m=Ra(e,t,r,l,u,c.length);s>0&&a>0&&ja(m,s,a,o),d.push(m)}return d}(this._particles,this.hass,this._config,this._pulses,e,i,t)}_ensureCanvas(){const t=this._canvas;if(t){if(!this._ctx){if(this._ctx=t.getContext("2d")??void 0,!this._ctx)return;this._resizeObserver=new ResizeObserver(()=>{this._resizeCanvas(),this._syncParticles()}),this._resizeObserver.observe(this._stage??t.parentElement??this)}this._resizeCanvas(),this._syncParticles(),this._animating||(this._lastFrame=0,this._startAnimation())}}_startAnimation(){if(this._animating||!this._ctx)return;this._animating=!0;const t=e=>{if(!this.isConnected||!this._ctx)return void(this._animating=!1);const i=this._lastFrame?Math.min((e-this._lastFrame)/16.67,3):1,n=this._lastFrame?e-this._lastFrame:16.67;this._lastFrame=e,this._draw(i,n,e),this._frameId=requestAnimationFrame(t)};this._frameId=requestAnimationFrame(t)}_stopAnimation(){cancelAnimationFrame(this._frameId),this._animating=!1}_resizeCanvas(){const t=this._canvas;if(!t)return;const e=t.getBoundingClientRect(),i=window.devicePixelRatio||1;t.width=Math.max(1,Math.floor(e.width*i)),t.height=Math.max(1,Math.floor(e.height*i)),this._ctx?.setTransform(i,0,0,i,0,0)}_draw(t,e,i){const n=this._canvas,s=this._ctx;if(!(n&&s&&this.hass&&this._config))return;const a=n.clientWidth,o=n.clientHeight;if(a<=0||o<=0)return;this._particles.length||this._syncParticles(i);const r=window.matchMedia("(prefers-reduced-motion: reduce)").matches;Va(this._particles,this.hass,this._config,a,o,t,i,r),function(t,e){for(let i=t.length-1;i>=0;i-=1)t[i].age+=e,t[i].age>=1400&&t.splice(i,1)}(this._pulses,e),Ya(s,this._particles,this._pulses,a,o,i)}render(){if(!this._config||!this.hass)return K;const t=this._config.name||"Reactor Core",e=this._particles.length||eo(this.hass,this._config).length;return W`
      <ha-card>
        <div class="stage">
          <canvas aria-hidden="true"></canvas>
          <div
    ...
    `]}};function eo(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:[..._a],n=e.max_particles??32;return Object.keys(t.states).filter(t=>i.includes(t.split(".",1)[0])).sort((t,e)=>t.localeCompare(e)).slice(0,n)}ie([St({attribute:!1})],to.prototype,"hass",void 0),ie([zt()],to.prototype,"_config",void 0),ie([It(".stage")],to.prototype,"_stage",void 0),ie([It("canvas")],to.prototype,"_canvas",void 0),to=ie([yt(ma)],to),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");