...
`,Kt=ht(()=>{Bt="nvision-blank-card",Gt="nvision-blank-card-editor"});function Qt(t,e,i,n){var s,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var o=t.length-1;o>=0;o--)(s=t[o])&&(r=(a<3?s(r):a>3?s(e,i,r):s(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r}var Xt=ht(()=>{});function Zt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}var Jt,te,ee,ie=ht(()=>{}),ne=ht(()=>{kt(),Xt(),Jt=class extends _t{},Qt([St({attribute:!1})],Jt.prototype,"hass",void 0)}),se=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ee}),ae=ht(()=>{kt(),Dt(),ie(),ne(),Kt(),Xt(),te=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}}],ee=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${te}
      ...
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Qt([zt()],ee.prototype,"_config",void 0),ee=Qt([yt(Gt)],ee)});kt(),Dt(),Kt(),Xt(),Ut({type:Bt,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var re=class extends _t{static async getConfigElement(){return await Promise.resolve().then(()=>(ae(),se)),document.createElement(Gt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Bt}`,entity:n}}setConfig(t){this._config=t}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Ht(t);return W`
      <ha-card>
        <div class="content">
          ${t?W`<ha-state-icon
                .hass=${this.hass}
  ...
  `]}};Qt([St({attribute:!1})],re.prototype,"hass",void 0),Qt([zt()],re.prototype,"_config",void 0),re=Qt([yt(Bt)],re);var oe=1,le=t=>(...e)=>({_$litDirective$:t,values:e}),ce=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};wt();var he,de,ue,me,ge=le(class extends ce{constructor(t){if(super(t),t.type!==oe||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const n=t[i];return null==n?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const n of this.ft)e[n]??(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in e){const t=e[n];if(null!=t){this.ft.add(n);const e="string"==typeof t&&t.endsWith(" !important");n.includes("-")||e?i.setProperty(n,e?t.slice(0,-11):t,e?"important":""):i[n]=t}}return Y}});function pe(t,e,i){return getComputedStyle(t).getPropertyValue(e).trim()||i}function fe(t,e){if(!t)return e;if(Array.isArray(t)&&t.length>=3)return`rgb(${t[0]}, ${t[1]}, ${t[2]})`;if("string"==typeof t){const e=t.split(",").map(t=>Number(t.trim()));return e.length>=3&&e.every(t=>Number.isFinite(t))?`rgb(${e[0]}, ${e[1]}, ${e[2]})`:t}return e}function _e(t,e,i,n){return fe(t,pe(e,i,n))}function ve(t){he??=document.createElement("canvas"),he.width=1,he.height=1;const e=he.getContext("2d");if(!e)return[41,182,246];e.fillStyle="#000000",e.fillStyle=t,e.fillRect(0,0,1,1);const[i,n,s]=e.getImageData(0,0,1,1).data;return[i,n,s]}function ye([t,e,i]){return`rgb(${t}, ${e}, ${i})`}function be(t,e,i){return[Math.round(t[0]+(e[0]-t[0])*i),Math.round(t[1]+(e[1]-t[1])*i),Math.round(t[2]+(e[2]-t[2])*i)]}function xe(t,e){return e>=0?be(t,[255,255,255],e):be(t,[0,0,0],-e)}function we(t,e){const i=ve(pe(t,"--success-color","#4caf50")),n=ve(pe(t,"--warning-color","#ff9800")),s=ve(pe(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return ye(a<=.5?be(i,n,2*a):be(n,s,2*(a-.5)))}var $e,Me,ke=ht(()=>{de="nvision-activity-card",ue="nvision-activity-card-editor",me={still:"idle",unknown:"idle",on_foot:"on_foot",walking:"walking",running:"running",on_bicycle:"bicycle",in_vehicle:"vehicle",automotive:"vehicle",tilting:"tilting"}}),Ce=/* @__PURE__ */dt({NvisionActivityCardEditor:()=>Me}),Se=ht(()=>{kt(),Dt(),ie(),ne(),ke(),Xt(),$e=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"color",selector:{color_rgb:{}}},{name:"speed",required:!0,default:1,selector:{number:{min:.25,max:3,step:.05}}}],Me=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"color"===t.name?"Figure color":"speed"===t.name?"Animation speed":"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={speed:1,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Qt([zt()],Me.prototype,"_config",void 0),Me=Qt([yt(ue)],Me)});function Ae(t,e,i){const n=.7*i;return V`
  ...
  `]}};Qt([St({attribute:!1})],yn.prototype,"hass",void 0),Qt([zt()],yn.prototype,"_config",void 0),Qt([zt()],yn.prototype,"_gaugeReady",void 0),Qt([Lt("canvas")],yn.prototype,"_canvas",void 0),Qt([Lt(".stage")],yn.prototype,"_stage",void 0),yn=Qt([yt(Ji)],yn);var bn,xn,wn=ht(()=>{fn="nvision-circle-gauge-card",_n="nvision-circle-gauge-card-editor"}),$n=/* @__PURE__ */dt({NvisionCircleGaugeCardEditor:()=>xn}),Mn=ht(()=>{kt(),Dt(),ie(),ne(),wn(),Xt(),bn=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{name:"color",selector:{color_rgb:{}}},{name:"track_color",selector:{color_rgb:{}}},{name:"reverse",selector:{boolean:{}}}],xn=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color"===t.name?"Gauge color":"track_color"===t.name?"Track color":"reverse"===t.name?"Reverse":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,...t}}render(){return this.hass&&this._config?W`
    ...
    `}render(){if(!this._config||!this.hass)return K;const t=this._config.entity,e=t?this.hass.states[t]:void 0,{value:i,valueText:n,unit:s}=this._reading(),a=_e(this._config.color,this,"--primary-color","#03a9f4");const r=function(t,e){return _e(t,e,"--primary-background-color","#e0e0e0")}(this._config.track_color,this),o=this._config.name||e?.attributes.friendly_name||"Circle Gauge";return W`
      <ha-card>
        <div class="body">
          <div class="gauge-wrap">
  ...
  `}};function ps(t){return String(t).padStart(2,"0")}function fs(t,e){const i=new Intl.DateTimeFormat("en-US",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),n=Object.fromEntries(i.formatToParts(new Date(t)).map(t=>[t.type,t.value])),s=ms.indexOf(String(n.weekday))>=0?ms.indexOf(String(n.weekday)):0,a=Number(n.year),r=Number(n.month),o=Number(n.day);return{year:a,month:r,day:o,hour:Number(n.hour)%24,weekday:s,dateKey:`${a}-${ps(r)}-${ps(o)}`,monthKey:`${a}-${ps(r)}`}}function _s(t,e,i){const n=fs(vs(t,e,i),e);return`${n.year}-${ps(n.month)}-${ps(n.day)}`}function vs(t,e,i){const n=fs(t,e),s=(n.weekday-i+7)%7;return ys(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function ys(t,e,i,n,s,a){const r=Date.UTC(t,e-1,i,n,s,0),o=new Intl.DateTimeFormat("en-US",{timeZone:a,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),l=Object.fromEntries(o.formatToParts(new Date(r)).map(t=>[t.type,t.value]));return r-(Date.UTC(Number(l.year),Number(l.month)-1,Number(l.day),Number(l.hour),Number(l.minute),0)-r)}function bs(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...fs(t,e),weekKey:_s(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function xs(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>ms[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=fs(t.startMs,e);let s=ys(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=fs(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=vs(t.startMs,e,i);for(;s<=t.endMs;){const t=fs(s,e);n.push({key:t.weekKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=fs(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${ps(a)}`;if(i.push({key:n,label:`${s}-${ps(a)}`}),a+=1,a>12&&(a=1,s+=1),ys(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const r=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const o of r)a.set(o.key,`${new Date(o.start).toLocaleString()} – ${new Date(o.end).toLocaleString()}`);return{keys:r.map(t=>t.key),labels:r.map(t=>t.label),bucketRanges:a}}function ws(t,e,i,n,s,a,r){return"time"===t?r.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function $s(t,e,i,n){if(t&&"custom"!==t&&us[t]){const e=us[t];return{...e,period:n??e.period}}return{x:e??"hour",y:i??"day",period:n??"7d"}}function Ms(t,e,i,n,s,a,r=0,o,l){const c=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(ds[n]),h=(d=c.hours)<=24||d<=48||d<=336?36e5:864e5;var d;const u=xs(e,c,a,r,h),m=xs(i,c,a,r,h),g=/* @__PURE__ */new Map;for(const y of t){if(y.time<c.startMs||y.time>c.endMs)continue;const t=bs(e,y.time,a,h,r),n=bs(i,y.time,a,h,r);if(void 0===t||void 0===n)continue;if(!u.keys.includes(t)||!m.keys.includes(n))continue;const s=`${n}|${t}`,o=g.get(s)??[];o.push(y.value),g.set(s,o)}const p=[],f=m.keys.map((t,n)=>u.keys.map((a,r)=>{const o=g.get(`${t}|${a}`)??[],l=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e,0);case"max":return Math.max(...t);case"min":return Math.min(...t);case"last":return t[t.length-1];default:return t.reduce((t,e)=>t+e,0)/t.length}}(o,s);return null!==l&&p.push(l),{value:l,count:o.length,rangeLabel:ws(e,i,a,0,u.labels[r],m.labels[n],u.bucketRanges)}}));let _=o,v=l;if(void 0===_||void 0===v){const t=p.length?Math.min(...p):0,e=p.length?Math.max(...p):1;_=_??t,v=v??(e===t?t+1:e)}return v<=_&&(v=_+1),{xLabels:u.labels,yLabels:m.labels,xKeys:u.keys,yKeys:m.keys,cells:f,min:_,max:v}}Qt([St({attribute:!1})],gs.prototype,"hass",void 0),Qt([zt()],gs.prototype,"_config",void 0),gs=Qt([yt(es)],gs);var ks=ht(()=>{ds={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},us={week_hourly:{x:"hour",y:"day",period:"7d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},timeline:{x:"time",y:"none",period:"24h"}},ms=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"]});function Cs(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function Ss(t){return Cs(t)}function As(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function zs(t){return As(t)?"count":"mean"}function Es(t,e){switch(e){case"mean":default:return t.mean??t.state??void 0;case"sum":return t.sum??t.change??void 0;case"max":return t.max??void 0;case"min":return t.min??void 0;case"last":return t.state??t.mean??void 0;case"count":return t.change??void 0}}function Ps(t){return t<1e11?1e3*t:t}async function Ts(t,e,i,n,s){return function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await Ss(t)({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0}),e),s)}async function Is(t,e,i,n,s,a){const r=Ss(t),o="sum"===s?["sum","change"]:"max"===s?["max"]:"min"===s?["min"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=Es(n,e);null!=t&&Number.isFinite(t)&&i.push({time:Ps(n.start),value:t})}return i}((await r({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:o}))[e]??[],s)}var Ls,Os,Rs,Ns,qs,Fs,js,Ds,Us,Hs,Bs,Gs=ht(()=>{}),Ws=ht(()=>{ks(),Ls="nvision-heat-map-card",Os="nvision-heat-map-card-editor",Rs="week_hourly",Ns="primary",qs=[{value:"week_hourly",label:"Week hourly"},{value:"daily_rhythm",label:"Daily rhythm"},{value:"month_calendar",label:"Month calendar"},{value:"timeline",label:"Timeline"},{value:"custom",label:"Custom"}],Fs=[{value:"24h",label:"24 hours"},{value:"48h",label:"48 hours"},{value:"7d",label:"7 days"},{value:"14d",label:"14 days"},{value:"30d",label:"30 days"},{value:"90d",label:"90 days"},{value:"365d",label:"365 days"}],js=[{value:"hour",label:"Hour of day"},{value:"weekday",label:"Day of week"},{value:"day",label:"Day"},{value:"week",label:"Week"},{value:"month",label:"Month"},{value:"time",label:"Time"},{value:"none",label:"None"}],Ds=[{value:"mean",label:"Mean"},{value:"sum",label:"Sum"},{value:"max",label:"Maximum"},{value:"min",label:"Minimum"},{value:"count",label:"Count"},{value:"last",label:"Last"}],Us=[{value:"primary",label:"Primary"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"}]}),Vs=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>Bs}),Ys=ht(()=>{kt(),Dt(),ie(),ne(),Gs(),Ws(),Xt(),Hs=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:Rs,selector:{select:{options:[...qs],mode:"dropdown"}}},{name:"period",required:!0,default:"7d",selector:{select:{options:[...Fs],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"x_axis",selector:{select:{options:[...js],mode:"dropdown"}}},{name:"y_axis",selector:{select:{options:[...js],mode:"dropdown"}}}]},{name:"aggregate",selector:{select:{options:[...Ds],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"min",selector:{number:{step:"any"}}},{name:"max",selector:{number:{step:"any"}}}]},{name:"color_mode",required:!0,default:Ns,selector:{select:{options:[...Us],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}}]}],Bs=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"Preset":"period"===t.name?"Period":"x_axis"===t.name?"X axis":"y_axis"===t.name?"Y axis":"aggregate"===t.name?"Aggregate":"min"===t.name?"Minimum (optional)":"max"===t.name?"Maximum (optional)":"color_mode"===t.name?"Color mode":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Legend":"show_current"===t.name?"Current value":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:Rs,period:"7d",color_mode:Ns,show_axis_labels:!0,show_legend:!0,show_current:!0,...t,aggregate:t.aggregate??zs(t.entity)}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Hs}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){const e=t.detail.value;Zt(this,"config-changed",{config:{...e,aggregate:e.aggregate??zs(e.entity)}})}},Qt([zt()],Bs.prototype,"_config",void 0),Bs=Qt([yt(Os)],Bs)});function Ks(t,e,i){return"semantic"===i?we(t,e):"temperature"===i?function(t,e){const i=ve(pe(t,"--info-color","#2196f3")),n=ve(pe(t,"--warning-color","#ff9800")),s=ve(pe(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return ye(a<=.5?be(i,n,2*a):be(n,s,2*(a-.5)))}(t,e):"var(--primary-color)"}function Qs(t,e,i){if(null===t)return"—";const n="count"===e?String(Math.round(t)):Number.isInteger(t)?String(t):t.toFixed(1);return i?`${n} ${i}`:n}kt(),Dt(),ks(),Gs(),Ws(),Xt(),Ut({type:Ls,name:"Nvision Heat Map",description:"Temporal heat map for sensor history and patterns"});var Xs=class extends _t{constructor(...t){super(...t),this._loading=!1,this._fetchVersion=0}static async getConfigElement(){return await Promise.resolve().then(()=>(Ys(),Vs)),document.createElement(Os)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return e.startsWith("sensor.")||e.startsWith("binary_sensor.")||Number.isFinite(Number(i?.state))})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Ls}`,entity:n,preset:Rs,period:"7d",aggregate:zs(n),color_mode:Ns,show_axis_labels:!0,show_legend:!0,show_current:!0}}_computeLoadKey(){const t=this._config;if(!t?.entity)return"";const e=$s(t.preset,t.x_axis,t.y_axis,t.period);return JSON.stringify({entity:t.entity,preset:t.preset,period:t.period,x_axis:t.x_axis,y_axis:t.y_axis,aggregate:t.aggregate??zs(t.entity),min:t.min,max:t.max,axes:e})}setConfig(t){this._config={preset:Rs,period:"7d",color_mode:Ns,show_axis_labels:!0,show_legend:!0,show_current:!0,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t,aggregate:t.aggregate??zs(t.entity)},this._loadKey=void 0}getCardSize(){const t=this._grid?.yLabels.length??4;return Math.max(3,Math.min(8,Math.ceil(.75*t)+2))}getGridOptions(){const t=this._grid?.yLabels.length??4;return{columns:6,rows:Math.max(3,Math.min(8,Math.ceil(.75*t)+2)),min_rows:3}}updated(t){if(!t.has("_config")&&!t.has("hass"))return;const e=this._computeLoadKey();e&&this.hass&&e!==this._loadKey&&(this._loadKey=e,this._loadData())}async _loadData(){const t=this._config,e=this.hass,i=t?.entity;if(!t||!e||!i)return this._grid=void 0,void(this._error=void 0);try{Cs(e)}catch{return this._error="History unavailable",void(this._grid=void 0)}const n=++this._fetchVersion;this._loading=!0,this._error=void 0;try{const s=$s(t.preset,t.x_axis,t.y_axis,t.period),a=t.aggregate??zs(i),r=await async function(t,e,i,n){const s=/* @__PURE__ */new Date,a=/* @__PURE__ */new Date(s.getTime()-60*i*60*1e3);if(As(e)||"count"===n)return Ts(t,e,a,s,!0);if(i>48)try{const r=await Is(t,e,a,s,n,i>336?"day":"hour");if(r.length>0)return r}catch{}return Ts(t,e,a,s,!1)}(e,i,ds[s.period],a);if(n!==this._fetchVersion)return;this._grid=Ms(r,s.x,s.y,s.period,a,e.config.time_zone||"UTC",1,t.min,t.max)}catch(s){if(n!==this._fetchVersion)return;this._error=function(t,e="Could not load history"){return t instanceof Error||"object"==typeof t&&null!==t&&"message"in t&&"string"==typeof t.message?t.message:e}(s),this._grid=void 0}finally{n===this._fetchVersion&&(this._loading=!1)}}_handleCardAction(t){this.hass&&this._config&&ts(this,this.hass,this._config,t)}_handleHeaderClick(t){t.stopPropagation(),this._handleCardAction("tap")}_handleCardClick(){this._tooltip=void 0,this._handleCardAction("tap")}_handleCellClick(t,e,i,n){t.stopPropagation();const s=this._config,a=s?.entity?this.hass?.states[s.entity]:void 0,r=String(a?.attributes.unit_of_measurement??""),o=Qs(n.value,s?.aggregate,"count"===s?.aggregate?"":r);this._tooltip?.x!==i||this._tooltip?.y!==e?this._tooltip={x:i,y:e,label:n.rangeLabel,value:o,count:n.count}:this._tooltip=void 0}_renderLegend(t){return W`
      <div class="legend" aria-hidden="true">
        ${[0,.5,1].map(e=>W`
            <span
              class="legend-stop"
              style=${ge({background:`color-mix(in srgb, ${Ks(this,e,t)} 85%, var(--card-background-color))`})}
            ></span>
          `)}
      </div>
      ...
      <div class="grid-wrap">
        ...
        >
          ...
          ${t.cells.flatMap((s,l)=>[n?W`
                ...
                `:K,...s.map((n,s)=>{const c=(h=n.value,d=t.min,u=t.max,null===h?0:Math.min(1,Math.max(0,(h-d)/(u-d))));var h,d,u;const m=Ks(this,c,i);return W`
                <button
                  type="button"
                  ...
                  title=${Qs(n.value,e.aggregate,"count"===e.aggregate?"":a)}
    ...
    `}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||this._config.entity||"Heat Map",i=!1!==this._config.show_current?Ht(t):"";return W`
      <ha-card @click=${this._handleCardClick}>
        <div class="stage">
          ...
          ${!1!==this._config.show_legend&&this._grid?this._renderLegend(this._config.color_mode??"primary"):K}
        </div>
      </ha-card>
    `}static{this.styles=[Wt,r`
    :host {
  ...
  `]}};Qt([St({attribute:!1})],Xs.prototype,"hass",void 0),Qt([zt()],Xs.prototype,"_config",void 0),Qt([zt()],Xs.prototype,"_grid",void 0),Qt([zt()],Xs.prototype,"_loading",void 0),Qt([zt()],Xs.prototype,"_error",void 0),Qt([zt()],Xs.prototype,"_tooltip",void 0),Xs=Qt([yt(Ls)],Xs),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");