...
`,ee=ht(()=>{Xt="nvision-blank-card",Qt="nvision-blank-card-editor"});function ie(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var ne,se=ht(()=>{}),ae=ht(()=>{kt(),se(),ne=class extends _t{},ie([St({attribute:!1})],ne.prototype,"hass",void 0)});function oe(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function re(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,ce,he=ht(()=>{}),de=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ce}),ue=ht(()=>{kt(),Dt(),Bt(),ae(),he(),ee(),se(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},oe()],ce=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
  ...
  `]}};ie([St({attribute:!1})],fa.prototype,"hass",void 0),ie([zt()],fa.prototype,"_config",void 0),ie([zt()],fa.prototype,"_grid",void 0),ie([zt()],fa.prototype,"_loading",void 0),ie([zt()],fa.prototype,"_error",void 0),ie([zt()],fa.prototype,"_popover",void 0),ie([zt()],fa.prototype,"_xLabelVisible",void 0),fa=ie([yt(Us)],fa);var _a=ht(()=>{ua="nvision-reactor-core-card",ma="nvision-reactor-core-card-editor",pa="auto",ga=["sensor","binary_sensor"]});hi(),_a();var va=[.42,.58,.72,.84],ya=[185,198,215,248,278,312,42],ba=2*Math.PI;function xa(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}function wa(t,e){if(js(e))return"binary";const i=t.states[e]?.state;return void 0!==Ze(i)?"numeric":"other"}function $a(t,e){const i=t.states[e]?.state;return void 0!==i&&"unavailable"!==i&&"unknown"!==i&&("on"===i||"true"===i||"open"===i||"home"===i)}function Ma(t,e,i,n){const s=Ze(t.states[e]?.state);return void 0===s?.35:Je(s,i,n)}function ka(t,e){const i=Math.min(va.length,Math.max(2,Math.ceil(Math.sqrt(e)))),n=t%i,s=Math.ceil(e/i);return{shell:n,slot:Math.floor(t/i)%s,slotsOnShell:s}}function Ca(t,e){const i=(14e-6*e+.31*t)%ya.length,n=Math.floor(i);return ya[n]+(ya[(n+1)%ya.length]-ya[n])*(i-n)}function Sa(t,e){e.push({x:t.x,y:t.y,age:0,seed:t.seed})}function Aa(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:ga,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function za(t,e,i,n,s,a){const o=xa(e),r=xa(`${e}:y`),l=ka(s,a),c=wa(t,e),h=Ma(t,e,i,n),d=t.states[e]?.state,u=l.shell%2==0?1:-1;return{entityId:e,kind:c,seed:o,seedY:r,x:0,y:0,phase:o*ba,shell:l.shell,slot:l.slot,slotsOnShell:l.slotsOnShell,orbitTilt:o*ba,orbitRyScale:.62+.32*r,orbitSpeed:u*(55e-5+75e-5*o),wobbleSpeed:.0016+.0024*r,binaryOn:$a(t,e),lastState:d,numericNorm:h,unavailable:"unavailable"===d||"unknown"===d,placed:!1}}function Ea(t,e){const i=t/2,n=e/2,s=Math.max(10,.06*t),a=Math.max(10,.06*e),o=Math.max(1,t/2-s),r=Math.max(1,e/2-a);return{cx:i,cy:n,halfW:o,halfH:r,scale:Math.min(t,e),clampX:o,clampY:r}}function Pa(t,e,i,n){const{cx:s,cy:a,halfW:o,halfH:r}=Ea(e,i),l=va[t.shell%va.length],c=t.slot/Math.max(1,t.slotsOnShell)*ba+.55*t.seed+t.phase,h=o*l,d=r*l*t.orbitRyScale,u=Math.cos(c)*h,m=Math.sin(c)*d,p=t.orbitTilt;let g=s+u*Math.cos(p)-m*Math.sin(p),f=a+u*Math.sin(p)+m*Math.cos(p);const _=.001*n,v=.035+.025*t.seed;g+=Math.cos(_*t.wobbleSpeed+11*t.seed)*h*v,f+=Math.sin(_*t.wobbleSpeed*1.23+9*t.seedY)*d*v,t.x=g,t.y=f,t.placed=!0}function Ta(t,e,i){const n=Ca(t.seed,e);let s=82,a=58;return"binary"===t.kind?(s=t.binaryOn?96:58,a=t.binaryOn?70:38):t.unavailable&&(s=18,a=42),`hsla(${n}, ${s}%, ${a}%, ${i})`}function Oa(t,e,i,n,s,a,o=.5){t.beginPath(),t.arc(e,i,n*(1+a*o),0,ba),t.fillStyle=s.replace(/[\d.]+\)$/,.07+.1*a+")"),t.fill(),t.beginPath(),t.arc(e,i,n,0,ba),t.fillStyle=s,t.fill()}function La(t,e,i,n,s,a){const o=a?.15:1;for(const r of t)r.phase+=r.orbitSpeed*n*o,Pa(r,e,i,s);!function(t,e,i,n){const{cx:s,cy:a,scale:o,clampX:r,clampY:l}=Ea(e,i),c=.11*o;for(const h of t){let e=h.x,i=h.y;for(const s of t){if(s===h)continue;const t=e-s.x,a=i-s.y,r=Math.hypot(t,a);if(r>.5&&r<c){const s=(c-r)/c*o*.018*n;e+=t/r*s,i+=a/r*s}}h.x=Math.min(s+r,Math.max(s-r,e)),h.y=Math.min(a+l,Math.max(a-l,i))}}(t,e,i,o)}function Ia(t,e,i,n,s,a){const{cx:o,cy:r,scale:l}=Ea(n,s);t.clearRect(0,0,n,s);const c=t.createRadialGradient(o,r,0,o,r,.72*l);c.addColorStop(0,"hsla(200, 70%, 58%, 0.06)"),c.addColorStop(.35,"hsla(260, 55%, 42%, 0.03)"),c.addColorStop(1,"hsla(0, 0%, 0%, 0)"),t.fillStyle=c,t.fillRect(0,0,n,s),function(t,e,i,n){for(const s of e){const e=s.age/1400,a=i*(.022+.42*e),o=.52*(1-e),r=Ca(s.seed,n);t.beginPath(),t.arc(s.x,s.y,a,0,ba),t.strokeStyle=`hsla(${r}, 88%, 64%, ${o})`,t.lineWidth=1.2+2.2*(1-e),t.stroke()}}(t,i,l,a);for(const h of e){const e="binary"===h.kind?.022*l:"numeric"===h.kind?.011*l+h.numericNorm*l*.007:.013*l;let i=h.unavailable?.28:.78;"binary"===h.kind&&(i=h.binaryOn?.55+.35*Math.sin(.012*a+12*h.seed):.35);const n=Ta(h,a,i);Oa(t,h.x,h.y,e,n,i)}Oa(t,o,r,.012*l*(.55+.12*Math.sin(.0018*a)),`hsla(${ya[Math.floor(14e-6*a%ya.length)]}, 88%, 68%, 0.65)`,.5,.3)}var qa,Ra,Fa,Na=/* @__PURE__ */dt({NvisionReactorCoreCardEditor:()=>Fa}),ja=ht(()=>{kt(),Dt(),Bt(),ae(),he(),_a(),se(),qa=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:pa,selector:{select:{options:[{value:"auto",label:"Auto-discover sensors"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},oe()],Ra=[{name:"entities",selector:{entity:{multiple:!0,domain:["sensor","binary_sensor"]}}}],Fa=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"min"===t.name?"Numeric trail min":"max"===t.name?"Numeric trail max":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:pa,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...qa.slice(0,3),...Ra,...qa.slice(3)]:qa}render(){return this.hass&&this._config?G`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],Fa.prototype,"_config",void 0),Fa=ie([yt(ma)],Fa)});kt(),Dt(),_a(),se(),Ht({type:ua,name:"Nvision Reactor Core",description:"Orbiting sensor particles with reactor-style pulse effects"});var Da=class extends _t{constructor(...t){super(...t),this._frameId=0,this._animating=!1,this._lastFrame=0,this._particles=[],this._pulses=[],this._entityKey="",this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(ja(),Na)),document.createElement(ma)}static getStubConfig(t,e,i){const n=[...e,...i,...Object.keys(t.states)],s=/* @__PURE__ */new Set,a=[];for(const o of n){if(s.has(o))continue;s.add(o);const t=o.split(".",1)[0];if("sensor"!==t&&"binary_sensor"!==t||a.push(o),a.length>=8)break}return{type:`custom:${ua}`,mode:pa,entities:a.length?a:void 0,max_particles:32,min:0,max:100}}setConfig(t){this._config={mode:pa,max_particles:32,min:0,max:100,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t},this._entityKey="",this._pulses=[]}getCardSize(){return 2}getGridOptions(){return{columns:6,rows:2}}connectedCallback(){super.connectedCallback(),this._lastFrame=0,this._startAnimation()}disconnectedCallback(){this._stopAnimation(),this._resizeObserver?.disconnect(),this._resizeObserver=void 0,super.disconnectedCallback()}updated(t){(t.has("hass")||t.has("_config"))&&this.hass&&this._config&&this._syncParticles(),this._ensureCanvas()}_canvasSize(){const t=this._canvas;return t?{width:t.clientWidth,height:t.clientHeight}:{width:0,height:0}}_syncParticles(t=performance.now()){if(!this.hass||!this._config)return;const{width:e,height:i}=this._canvasSize(),n=Ha(this.hass,this._config).join("|"),s=[this._config.mode,this._config.max_particles,(this._config.domains??[]).join(","),(this._config.exclude??[]).join(","),this._config.min,this._config.max,(this._config.entities??[]).join(","),e,i].join(";");n+s!==this._entityKey&&(this._pulses=[],this._entityKey=n+s),this._particles=function(t,e,i,n,s=0,a=0,o=0){const r=i.min??0,l=i.max??100,c=Aa(e,i),h=new Map(t.map(t=>[t.entityId,t])),d=[];for(let u=0;u<c.length;u+=1){const t=c[u],i=h.get(t);if(i){const h=ka(u,c.length),m=wa(e,t),p=Ma(e,t,r,l),g=$a(e,t),f=e.states[t]?.state??"";i.shell=h.shell,i.slot=h.slot,i.slotsOnShell=h.slotsOnShell,s>0&&a>0&&Pa(i,s,a,o),void 0!==i.lastState&&f!==i.lastState&&Sa(i,n),i.lastState=f,i.kind=m,i.numericNorm=p,i.binaryOn=g,i.unavailable="unavailable"===e.states[t]?.state||"unknown"===e.states[t]?.state,d.push(i);continue}const m=za(e,t,r,l,u,c.length);s>0&&a>0&&Pa(m,s,a,o),d.push(m)}return d}(this._particles,this.hass,this._config,this._pulses,e,i,t)}_ensureCanvas(){const t=this._canvas;if(t){if(!this._ctx){if(this._ctx=t.getContext("2d")??void 0,!this._ctx)return;this._resizeObserver=new ResizeObserver(()=>{this._resizeCanvas(),this._syncParticles()}),this._resizeObserver.observe(this._stage??t.parentElement??this)}this._resizeCanvas(),this._syncParticles(),this._animating||(this._lastFrame=0,this._startAnimation())}}_startAnimation(){if(this._animating||!this._ctx)return;this._animating=!0;const t=e=>{if(!this.isConnected||!this._ctx)return void(this._animating=!1);const i=this._lastFrame?Math.min((e-this._lastFrame)/16.67,3):1,n=this._lastFrame?e-this._lastFrame:16.67;this._lastFrame=e,this._draw(i,n,e),this._frameId=requestAnimationFrame(t)};this._frameId=requestAnimationFrame(t)}_stopAnimation(){cancelAnimationFrame(this._frameId),this._animating=!1}_resizeCanvas(){const t=this._canvas;if(!t)return;const e=t.getBoundingClientRect(),i=window.devicePixelRatio||1;t.width=Math.max(1,Math.floor(e.width*i)),t.height=Math.max(1,Math.floor(e.height*i)),this._ctx?.setTransform(i,0,0,i,0,0)}_draw(t,e,i){const n=this._canvas,s=this._ctx;if(!(n&&s&&this.hass&&this._config))return;const a=n.clientWidth,o=n.clientHeight;if(a<=0||o<=0)return;this._particles.length||this._syncParticles(i);const r=window.matchMedia("(prefers-reduced-motion: reduce)").matches;La(this._particles,a,o,t,i,r),function(t,e){for(let i=t.length-1;i>=0;i-=1)t[i].age+=e,t[i].age>=1400&&t.splice(i,1)}(this._pulses,e),Ia(s,this._particles,this._pulses,a,o,i)}render(){if(!this._config||!this.hass)return K;const t=this._config.name||"Reactor Core",e=this._particles.length||Ha(this.hass,this._config).length;return G`
      <ha-card>
        <div class="stage">
          <canvas aria-hidden="true"></canvas>
          <div
    ...
    `]}};function Ha(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:["sensor","binary_sensor"],n=e.max_particles??32;return Object.keys(t.states).filter(t=>i.includes(t.split(".",1)[0])).sort((t,e)=>t.localeCompare(e)).slice(0,n)}ie([St({attribute:!1})],Da.prototype,"hass",void 0),ie([zt()],Da.prototype,"_config",void 0),ie([Lt(".stage")],Da.prototype,"_stage",void 0),ie([Lt("canvas")],Da.prototype,"_canvas",void 0),Da=ie([yt(ua)],Da),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");