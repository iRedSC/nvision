...
`,Kt=ht(()=>{Ht="nvision-blank-card",Gt="nvision-blank-card-editor"});function Xt(t,e,i,n){var s,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var o=t.length-1;o>=0;o--)(s=t[o])&&(r=(a<3?s(r):a>3?s(e,i,r):s(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r}var Qt=ht(()=>{});function Zt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}var Jt,te,ee,ie=ht(()=>{}),ne=ht(()=>{kt(),Qt(),Jt=class extends _t{},Xt([St({attribute:!1})],Jt.prototype,"hass",void 0)}),se=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ee}),ae=ht(()=>{kt(),Ut(),ie(),ne(),Kt(),Qt(),te=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}}],ee=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?V`
      ...
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Xt([zt()],ee.prototype,"_config",void 0),ee=Xt([yt(Gt)],ee)});kt(),Ut(),Kt(),Qt(),Dt({type:Ht,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var re=class extends _t{static async getConfigElement(){return await Promise.resolve().then(()=>(ae(),se)),document.createElement(Gt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Ht}`,entity:n}}setConfig(t){this._config=t}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Bt(t);return V`
      <ha-card>
        <div class="content">
          ${t?V`<ha-state-icon
                .hass=${this.hass}
  ...
  `]}};Xt([St({attribute:!1})],qn.prototype,"hass",void 0),Xt([zt()],qn.prototype,"_config",void 0),Xt([zt()],qn.prototype,"_gaugeReady",void 0),Xt([zt()],qn.prototype,"_tick",void 0),qn=Xt([yt(bn)],qn);var Fn,Nn,jn=ht(()=>{On="nvision-power-draw-card",Rn="nvision-power-draw-card-editor"}),Un=/* @__PURE__ */dt({NvisionPowerDrawCardEditor:()=>Nn}),Dn=ht(()=>{kt(),Ut(),ie(),ne(),ri(),jn(),Qt(),Fn=[{name:"entity",selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:Le,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"effects_min",required:!0,default:0,selector:{number:{min:0,max:1,step:.05}}},{name:"effects_max",required:!0,default:1,selector:{number:{min:0,max:1,step:.05}}}]},{name:"color",selector:{color_rgb:{}}},{name:"icon",selector:{icon:{}}}],Nn=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum watts":"max"===t.name?"Maximum watts":"effects_min"===t.name?"Minimum effect":"effects_max"===t.name?"Maximum effect":"color"===t.name?"Lightning color":"icon"===t.name?"Source icon":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:Le,effects_min:0,effects_max:1,...t}}render(){return this.hass&&this._config?V`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Zt(this,"config-changed",{config:t.detail.value})}},Xt([zt()],Nn.prototype,"_config",void 0),Nn=Xt([yt(Rn)],Nn)});kt(),Ut(),ri(),jn(),Qt(),Dt({type:On,name:"Nvision Power Draw",description:"Power consumption with animated lightning from a plug"});var Bn,Hn,Gn=class extends _t{constructor(...t){super(...t),this._displayIntensity=0}static async getConfigElement(){return await Promise.resolve().then(()=>(Dn(),Un)),document.createElement(Rn)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return"power"===i?.attributes.device_class||e.includes("power")||void 0!==Ke(i?.state)})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${On}`,entity:n,min:0,max:Le}}setConfig(t){this._config={min:0,max:Le,effects_min:0,effects_max:1,...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}disconnectedCallback(){this._renderer?.detach(),super.disconnectedCallback()}firstUpdated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}updated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}_lightningColor(){return Ne(this._config?.color,this)}_overMaxColor(){return He(this)}_rawValue(){const t=this._config?.entity;return Ke(t?this.hass?.states[t]?.state:void 0)}_overMaxSeverity(){const t=this._rawValue();return void 0===t?0:Be(t,this._config?.min??0,this._config?.max??3e3)}_syncLightningTheme(){const t=this._overMaxSeverity()>0?this._overMaxColor():this._lightningColor();this.style.setProperty("--lightning-color",t),this.style.setProperty("--lightning-glow",String(De(this._displayIntensity)))}_targetIntensity(){return Ue(this._rawValue(),this._config??{})}_tickIntensity(t){const e=this._targetIntensity(),i=e-this._displayIntensity;return Math.abs(i)<.001?this._displayIntensity=e:this._displayIntensity+=i*Ie*t,this._syncLightningTheme(),this._displayIntensity}_ensureRenderer(){const t=this._canvas;t&&(this._renderer||(this._renderer=new Re(this,t=>this._buildArcs(t),()=>this._lightningColor(),t=>{this._tickIntensity(t)})),this._renderer.attach(t))}_buildArcs(t){const e=this._canvas;if(!e)return[];const i=Qe(this._plug,e,"center"),n=Qe(this._entityIcon,e,"center");if(!i||!n)return[];const s=this._overMaxSeverity(),a=s>0?this._overMaxColor():this._lightningColor(),r=[{from:i,to:n,intensity:this._displayIntensity,color:a}];if(s>0){const{width:i,height:o}=e.getBoundingClientRect();We(r,n,i,o,s,t,a)}return r}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Power Draw",i=Bt(t);return V`
  ...
  `}};function ws(t){return String(t).padStart(2,"0")}function $s(t,e){const i=Object.fromEntries(function(t){let e=ys.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),ys.set(t,e)),e}(e).formatToParts(new Date(t)).map(t=>[t.type,t.value])),n=vs.indexOf(String(i.weekday))>=0?vs.indexOf(String(i.weekday)):0,s=Number(i.year),a=Number(i.month),r=Number(i.day);return{year:s,month:a,day:r,hour:Number(i.hour)%24,weekday:n,dateKey:`${s}-${ws(a)}-${ws(r)}`,monthKey:`${s}-${ws(a)}`}}function Ms(t,e,i){const n=$s(ks(t,e,i),e);return`${n.year}-${ws(n.month)}-${ws(n.day)}`}function ks(t,e,i){const n=$s(t,e),s=(n.weekday-i+7)%7;return Cs(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function Cs(t,e,i,n,s,a){const r=Date.UTC(t,e-1,i,n,s,0),o=Object.fromEntries(function(t){let e=bs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),bs.set(t,e)),e}(a).formatToParts(new Date(r)).map(t=>[t.type,t.value]));return r-(Date.UTC(Number(o.year),Number(o.month)-1,Number(o.day),Number(o.hour),Number(o.minute),0)-r)}function Ss(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...$s(t,e),weekKey:Ms(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function As(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>vs[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=$s(t.startMs,e);let s=Cs(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=$s(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=ks(t.startMs,e,i);for(;s<=t.endMs;){const t=$s(s,e);n.push({key:t.weekKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=$s(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${ws(a)}`;if(i.push({key:n,label:`${s}-${ws(a)}`}),a+=1,a>12&&(a=1,s+=1),Cs(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const r=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const o of r)a.set(o.key,`${new Date(o.start).toLocaleString()} – ${new Date(o.end).toLocaleString()}`);return{keys:r.map(t=>t.key),labels:r.map(t=>t.label),bucketRanges:a}}function zs(t,e,i,n,s,a,r){return"time"===t?r.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function Es(t){return fs[t&&_s[t]||(t&&t in fs?t:void 0)||"week_hourly"]}function Ps(t,e,i,n,s,a,r=0,o,l){const c=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(ps[n]),h=(d=c.hours)<=24||d<=48||d<=336?36e5:864e5;var d;const u=As(e,c,a,r,h),m=As(i,c,a,r,h),g=new Set(u.keys),p=new Set(m.keys),f=/* @__PURE__ */new Map;for(const x of t){if(x.time<c.startMs||x.time>c.endMs)continue;const t=Ss(e,x.time,a,h,r),n=Ss(i,x.time,a,h,r);if(void 0===t||void 0===n)continue;if(!g.has(t)||!p.has(n))continue;const s=`${n}|${t}`,o=f.get(s)??[];o.push(x.value),f.set(s,o)}const _=[],v=m.keys.map((t,n)=>u.keys.map((a,r)=>{const o=f.get(`${t}|${a}`)??[],l=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e,0);case"max":return Math.max(...t);case"min":return Math.min(...t);case"last":return t[t.length-1];default:return t.reduce((t,e)=>t+e,0)/t.length}}(o,s);return null!==l&&_.push(l),{value:l,count:o.length,rangeLabel:zs(e,i,a,0,u.labels[r],m.labels[n],u.bucketRanges)}}));let y=o,b=l;if(void 0===y||void 0===b){const t=_.length?Math.min(..._):0,e=_.length?Math.max(..._):1;y=y??t,b=b??(e===t?t+1:e)}return b<=y&&(b=y+1),{xLabels:u.labels,yLabels:m.labels,xKeys:u.keys,yKeys:m.keys,cells:v,min:y,max:b}}Xt([St({attribute:!1})],xs.prototype,"hass",void 0),Xt([zt()],xs.prototype,"_config",void 0),xs=Xt([yt(as)],xs);var Ts=ht(()=>{ps={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},fs={week_hourly:{x:"hour",y:"day",period:"7d"},two_weeks:{x:"hour",y:"day",period:"14d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_days:{x:"day",y:"week",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},quarter:{x:"week",y:"month",period:"90d"},timeline_24h:{x:"time",y:"none",period:"24h"},timeline_48h:{x:"time",y:"none",period:"48h"},year_overview:{x:"week",y:"month",period:"365d"}},_s={timeline:"timeline_24h",custom:"week_hourly"},vs=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],ys=/* @__PURE__ */new Map,bs=/* @__PURE__ */new Map});function Ls(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function Is(t){return Ls(t)}function Os(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function Rs(t){return Os(t)?"count":"mean"}function qs(t,e){switch(e){case"mean":default:return t.mean??t.state??void 0;case"sum":return t.sum??t.change??void 0;case"max":return t.max??void 0;case"min":return t.min??void 0;case"last":return t.state??t.mean??void 0;case"count":return t.change??void 0}}function Fs(t){return t<1e11?1e3*t:t}var Ns,js,Us,Ds,Bs,Hs;async function Gs(t,e,i,n,s){return function(t,e){if(t.length<=e)return t;const i=Math.ceil(t.length/e),n=[];for(let s=0;s<t.length;s+=i)n.push(t[s]);return n}(function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await Is(t)({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!0}),e),s),8e3)}async function Vs(t,e,i,n,s,a){const r=Is(t),o="sum"===s?["sum","change"]:"max"===s?["max"]:"min"===s?["min"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=qs(n,e);null!=t&&Number.isFinite(t)&&i.push({time:Fs(n.start),value:t})}return i}((await r({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:o}))[e]??[],s)}var Ws,Ys,Ks,Xs=ht(()=>{Ts(),Ns="nvision-heat-map-card",js="nvision-heat-map-card-editor",Us="week_hourly",Ds="theme",Bs=[{value:"week_hourly",label:"Week — hour × day"},{value:"two_weeks",label:"Two weeks — hour × day"},{value:"daily_rhythm",label:"Daily rhythm — hour × weekday"},{value:"month_days",label:"Month — day × week"},{value:"month_calendar",label:"Quarter calendar — weekday × week"},{value:"quarter",label:"Quarter — week × month"},{value:"timeline_24h",label:"Timeline — 24 hours"},{value:"timeline_48h",label:"Timeline — 48 hours"},{value:"year_overview",label:"Year — week × month"}],Hs=[{value:"theme",label:"Theme"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"},{value:"custom",label:"Custom"}]}),Qs=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>Ks}),Zs=ht(()=>{kt(),Ut(),ie(),ne(),Xs(),Qt(),Ws=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:Us,selector:{select:{options:[...Bs],mode:"dropdown"}}},{name:"color_mode",required:!0,default:Ds,selector:{select:{options:[...Hs],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_cell_values",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}}]}],Ys=[{type:"grid",name:"",schema:[{name:"color_low",selector:{color_rgb:{}}},{name:"color_high",selector:{color_rgb:{}}}]}],Ks=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"View":"color_mode"===t.name?"Color mode":"color_low"===t.name?"Low color":"color_high"===t.name?"High color":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Scale":"show_cell_values"===t.name?"Values in cells":"show_current"===t.name?"Current value":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:Us,color_mode:Ds,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,...t,color_mode:"primary"===t.color_mode?"theme":t.color_mode}}_schema(){return"custom"===this._config?.color_mode?[...Ws,...Ys]:Ws}render(){return this.hass&&this._config?V`
    ...
    `}_renderGrid(t){const e=this._config,i=Js(e.color_mode),n=!1!==e.show_axis_labels,s=!0===e.show_cell_values,a=!1!==e.show_legend,r=e.entity?this.hass?.states[e.entity]:void 0,o=String(r?.attributes.unit_of_measurement??""),l=Rs(e.entity),c=n?2:1,h=n?2:1,d=this._xLabelVisible??t.xLabels.map(()=>!0);return V`
  ...
  `]}};Xt([St({attribute:!1})],aa.prototype,"hass",void 0),Xt([zt()],aa.prototype,"_config",void 0),Xt([zt()],aa.prototype,"_grid",void 0),Xt([zt()],aa.prototype,"_loading",void 0),Xt([zt()],aa.prototype,"_error",void 0),Xt([zt()],aa.prototype,"_popover",void 0),Xt([zt()],aa.prototype,"_xLabelVisible",void 0),aa=Xt([yt(Ns)],aa),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");