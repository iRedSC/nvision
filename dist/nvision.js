...
`,Kt=ht(()=>{Ht="nvision-blank-card",Gt="nvision-blank-card-editor"});function Xt(t,e,i,n){var s,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var o=t.length-1;o>=0;o--)(s=t[o])&&(r=(a<3?s(r):a>3?s(e,i,r):s(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r}var Qt=ht(()=>{});function Zt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}var Jt,te,ee,ie=ht(()=>{}),ne=ht(()=>{kt(),Qt(),Jt=class extends _t{},Xt([St({attribute:!1})],Jt.prototype,"hass",void 0)}),se=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ee}),ae=ht(()=>{kt(),Dt(),ie(),ne(),Kt(),Qt(),te=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}}],ee=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?V`
  ...
  `}};function $s(t){return String(t).padStart(2,"0")}function Ms(t,e){const i=Object.fromEntries(function(t){let e=ys.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),ys.set(t,e)),e}(e).formatToParts(new Date(t)).map(t=>[t.type,t.value])),n=vs.indexOf(String(i.weekday))>=0?vs.indexOf(String(i.weekday)):0,s=Number(i.year),a=Number(i.month),r=Number(i.day);return{year:s,month:a,day:r,hour:Number(i.hour)%24,weekday:n,dateKey:`${s}-${$s(a)}-${$s(r)}`,monthKey:`${s}-${$s(a)}`}}function ks(t,e,i){const n=Ms(Cs(t,e,i),e);return`${n.year}-${$s(n.month)}-${$s(n.day)}`}function Cs(t,e,i){const n=Ms(t,e),s=(n.weekday-i+7)%7;return Ss(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function Ss(t,e,i,n,s,a){const r=Date.UTC(t,e-1,i,n,s,0),o=Object.fromEntries(function(t){let e=bs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),bs.set(t,e)),e}(a).formatToParts(new Date(r)).map(t=>[t.type,t.value]));return r-(Date.UTC(Number(o.year),Number(o.month)-1,Number(o.day),Number(o.hour),Number(o.minute),0)-r)}function As(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...Ms(t,e),weekKey:ks(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function zs(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>vs[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=Ms(t.startMs,e);let s=Ss(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=Ms(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=Cs(t.startMs,e,i);for(;s<=t.endMs;){const t=Ms(s,e);n.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=Ms(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${$s(a)}`;if(i.push({key:n,label:`${s}-${$s(a)}`}),a+=1,a>12&&(a=1,s+=1),Ss(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const r=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const o of r)a.set(o.key,`${new Date(o.start).toLocaleString()} – ${new Date(o.end).toLocaleString()}`);return{keys:r.map(t=>t.key),labels:r.map(t=>t.label),bucketRanges:a}}function Es(t,e,i,n,s,a,r){return"time"===t?r.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function Ps(t){return fs[t&&_s[t]||(t&&t in fs?t:void 0)||"week_hourly"]}function Ts(t,e,i,n,s,a,r=0,o,l){const c=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(ps[n]),h=(d=c.hours)<=24||d<=48||d<=336?36e5:864e5;var d;const u=zs(e,c,a,r,h),m=zs(i,c,a,r,h),g=new Set(u.keys),p=new Set(m.keys),f=/* @__PURE__ */new Map;for(const x of t){if(x.time<c.startMs||x.time>c.endMs)continue;const t=As(e,x.time,a,h,r),n=As(i,x.time,a,h,r);if(void 0===t||void 0===n)continue;if(!g.has(t)||!p.has(n))continue;const s=`${n}|${t}`,o=f.get(s)??[];o.push({time:x.time,value:x.value}),f.set(s,o)}const _=[],v=m.keys.map((t,n)=>u.keys.map((a,r)=>{const o=f.get(`${t}|${a}`)??[],l=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e.value,0);case"max":return Math.max(...t.map(t=>t.value));case"min":return Math.min(...t.map(t=>t.value));case"last":{let e=t[0];for(const i of t)i.time>=e.time&&(e=i);return e.value}default:return t.reduce((t,e)=>t+e.value,0)/t.length}}(o,s);return null!==l&&_.push(l),{value:l,count:o.length,rangeLabel:Es(e,i,a,0,u.labels[r],m.labels[n],u.bucketRanges)}}));let y=o,b=l;if(void 0===y||void 0===b){const t=_.length?Math.min(..._):0,e=_.length?Math.max(..._):1;y=y??t,b=b??(e===t?t+1:e)}return b<=y&&(b=y+1),{xLabels:u.labels,yLabels:m.labels,xKeys:u.keys,yKeys:m.keys,cells:v,min:y,max:b}}function Ls(t,e,i){return null===t?0:Math.min(1,Math.max(0,(t-e)/(i-e)))}Xt([St({attribute:!1})],ws.prototype,"hass",void 0),Xt([zt()],ws.prototype,"_config",void 0),ws=Xt([yt(as)],ws);var Is=ht(()=>{ps={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},fs={week_hourly:{x:"hour",y:"day",period:"7d"},two_weeks:{x:"hour",y:"day",period:"14d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_days:{x:"weekday",y:"week",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},quarter:{x:"week",y:"month",period:"90d"},timeline_24h:{x:"time",y:"none",period:"24h"},timeline_48h:{x:"time",y:"none",period:"48h"},year_overview:{x:"week",y:"month",period:"365d"}},_s={timeline:"timeline_24h",custom:"week_hourly"},vs=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],ys=/* @__PURE__ */new Map,bs=/* @__PURE__ */new Map,xs=["day","week","month"]});function Os(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function Rs(t){return Os(t)}function qs(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function Fs(t,e){const i=(...t)=>{for(const e of t){if(null==e)continue;const t=Number(e);if(Number.isFinite(t))return t}};switch(e){case"mean":default:return i(t.mean,t.state);case"sum":return i(t.sum,t.change,t.state);case"max":return i(t.max,t.state,t.sum);case"min":return i(t.min,t.state);case"last":return i(t.state,t.mean);case"count":return i(t.change)}}function Ns(t){if("string"==typeof t){const e=Date.parse(t);return Number.isFinite(e)?e:void 0}return t<1e11?1e3*t:t}var js,Ds,Us,Bs,Hs,Gs,Vs;async function Ws(t,e,i,n,s,a="mean"){const r=Rs(t),o=function(t){return"max"===t||"last"===t}(a);return function(t,e,i=!1){if(t.length<=e)return t;const n=Math.ceil(t.length/e),s=[];for(let a=0;a<t.length;a+=n){const e=t.slice(a,a+n);e.length&&(i?s.push(e.reduce((t,e)=>e.value>t.value||e.value===t.value&&e.time>t.time?e:t,e[0])):s.push(e[0]))}return s}(function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await r({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!o}),e),s),8e3,o)}async function Ys(t,e,i,n,s,a){const r=Rs(t),o="sum"===s?["sum","change","state"]:"max"===s?["max","state","sum"]:"min"===s?["min","state"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=Fs(n,e);if(null==t||!Number.isFinite(t))continue;const s=Ns(n.start);void 0!==s&&i.push({time:s,value:t})}return i}((await r({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:o}))[e]??[],s)}var Ks,Xs,Qs,Zs=ht(()=>{Is(),js="nvision-heat-map-card",Ds="nvision-heat-map-card-editor",Us="week_hourly",Bs="theme",Hs=[{value:"week_hourly",label:"Week — hour × day"},{value:"two_weeks",label:"Two weeks — hour × day"},{value:"daily_rhythm",label:"Daily rhythm — hour × weekday"},{value:"month_days",label:"Month — weekday × week"},{value:"month_calendar",label:"Quarter calendar — weekday × week"},{value:"quarter",label:"Quarter — week × month"},{value:"timeline_24h",label:"Timeline — 24 hours"},{value:"timeline_48h",label:"Timeline — 48 hours"},{value:"year_overview",label:"Year — week × month"}],Gs=[{value:"theme",label:"Theme"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"},{value:"custom",label:"Custom"}],Vs=[{value:"auto",label:"Auto"},{value:"mean",label:"Mean"},{value:"sum",label:"Sum"},{value:"max",label:"Maximum"},{value:"min",label:"Minimum"},{value:"count",label:"Count"},{value:"last",label:"Last"}]}),Js=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>Qs}),ta=ht(()=>{kt(),Dt(),ie(),ne(),Zs(),Qt(),Ks=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:Us,selector:{select:{options:[...Hs],mode:"dropdown"}}},{name:"operation",default:"auto",selector:{select:{options:[...Vs],mode:"dropdown"}}},{name:"color_mode",required:!0,default:Bs,selector:{select:{options:[...Gs],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_cell_values",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}},{name:"dim_low_values",selector:{boolean:{}}}]}],Xs=[{type:"grid",name:"",schema:[{name:"color_low",selector:{color_rgb:{}}},{name:"color_high",selector:{color_rgb:{}}}]}],Qs=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"View":"color_mode"===t.name?"Color mode":"operation"===t.name?"Operation":"color_low"===t.name?"Low color":"color_high"===t.name?"High color":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Scale":"show_cell_values"===t.name?"Values in cells":"dim_low_values"===t.name?"Dim low values":"show_current"===t.name?"Current value":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:Us,color_mode:Bs,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,...t,color_mode:"primary"===t.color_mode?"theme":t.color_mode,operation:t.operation??"auto"}}_schema(){return"custom"===this._config?.color_mode?[...Ks,...Xs]:Ks}render(){return this.hass&&this._config?V`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){const e=t.detail.value;Zt(this,"config-changed",{config:{...e,color_mode:"primary"===e.color_mode?"theme":e.color_mode}})}},Xt([zt()],Qs.prototype,"_config",void 0),Qs=Xt([yt(Ds)],Qs)});function ea(t){return t&&"primary"!==t?t:"theme"}kt(),Dt(),Is(),Zs(),Qt(),Ut({type:js,name:"Nvision Heat Map",description:"Temporal heat map for sensor history and patterns"});function ia(t,e,i,n,s){if(!s)return"rgba(0, 0, 0, 0.05)";const a=function(t,e,i,n){const s=ea(i);return"semantic"===s?we(t,e):"temperature"===s?$e(t,e):"custom"===s?ke(t,e,n.color_low,n.color_high):Me(t,e)}(t,e,i,n),r=!0===n.dim_low_values?e*e*100:100*e;return`color-mix(in srgb, ${a} ${Math.min(100,Math.max(6,r))}%, var(--card-background-color))`}function na(t,e,i,n=!1){if(null===t)return"—";const s="count"===e?String(Math.round(t)):Number.isInteger(t)?String(t):n?t.toFixed(0):t.toFixed(1);return i&&"count"!==e?n?s:`${s} ${i}`:s}function sa(t,e,i){return na(t,e,i,!0)}var aa=null;function ra(t,e){return aa??=document.createElement("canvas").getContext("2d"),aa?(aa.font=e,aa.measureText(t).width):6*t.length}var oa=class extends _t{constructor(...t){super(...t),this._loading=!1,this._fetchVersion=0,this._measureFrame=0}static async getConfigElement(){return await Promise.resolve().then(()=>(ta(),Js)),document.createElement(Ds)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return e.startsWith("sensor.")||e.startsWith("binary_sensor.")||Number.isFinite(Number(i?.state))})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${js}`,entity:n,preset:Us,operation:"auto",color_mode:Bs,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1}}_entityAttributes(){const t=this._config?.entity;if(t&&this.hass)return this.hass.states[t]?.attributes}_resolveAggregate(t){const e=this._config?.operation;if(e&&"auto"!==e)return e;const i=this._config?.entity,n=this._entityAttributes();return s=t.x,a=t.y,r=function(t,e){return qs(t)?"count":function(t,e){return!!function(t){return"string"==typeof t?.start&&"string"==typeof t?.end&&void 0!==t?.value}(e)||!!e?.last_reset||!(!t||!/_today$/i.test(t))}(t,e)?"max":function(t){const e=t?.state_class;return"total_increasing"===e||"total"===e}(e)?"last":"mean"}(i,n),"count"===r?"count":xs.includes(s)||xs.includes(a)?"max":r;var s,a,r}_computeLoadKey(){const t=this._config;if(!t?.entity)return"";const e=Ps(t.preset),i=this._entityAttributes();return JSON.stringify({entity:t.entity,preset:t.preset,operation:t.operation??"auto",stateClass:i?.state_class,aggregate:this._resolveAggregate(e),axes:e})}setConfig(t){this._config={preset:Us,operation:"auto",color_mode:Bs,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t,color_mode:ea(t.color_mode)},this._loadKey=void 0}getCardSize(){const t=this._grid?.yLabels.length??4;return Math.max(3,Math.min(8,Math.ceil(.75*t)+2))}getGridOptions(){const t=this._grid?.yLabels.length??4;return{columns:6,rows:Math.max(3,Math.min(8,Math.ceil(.75*t)+2)),min_rows:3}}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(()=>this._scheduleXLabelMeasure())}disconnectedCallback(){this._resizeObserver?.disconnect(),cancelAnimationFrame(this._measureFrame),super.disconnectedCallback()}updated(t){if(t.has("_config")||t.has("hass")){const t=this._computeLoadKey();t&&this.hass&&t!==this._loadKey&&(this._loadKey=t,this._loadData())}t.has("_grid")&&(this._xLabelVisible=void 0),this._grid&&!1!==this._config?.show_axis_labels&&this._scheduleXLabelMeasure()}_scheduleXLabelMeasure(){cancelAnimationFrame(this._measureFrame),this._measureFrame=requestAnimationFrame(()=>this._updateXLabelVisibility())}_observeGridWrap(t){this._resizeObserver&&t!==this._observedWrap&&(this._observedWrap&&this._resizeObserver.unobserve(this._observedWrap),this._observedWrap=t,this._resizeObserver.observe(t))}_updateXLabelVisibility(){const t=this._grid,e=this.shadowRoot;if(!t||!e||!1===this._config?.show_axis_labels)return;const i=e.querySelector(".grid-wrap"),n=e.querySelector(".data-grid .cell")??e.querySelector(".timeline-grid .cell");if(!i||!n)return;this._observeGridWrap(i);const s=e.querySelectorAll(".data-grid .cell, .timeline-grid .cell");let a=n.getBoundingClientRect().width;if(s.length>1){const t=s[0].getBoundingClientRect();a=s[1].getBoundingClientRect().left-t.left}const r=e.querySelector(".axis.x"),o=r?getComputedStyle(r).font:"500 10px Roboto, sans-serif",l=function(t,e,i,n=6){if(e<=0||!t.length)return t.map(()=>!0);const s=t.map(()=>!1);let a=-1/0;for(let r=0;r<t.length;r++){const o=t[r];if(!o)continue;const l=ra(o,i),c=(r+.5)*e;c-l/2>=a+n&&(s[r]=!0,a=c+l/2)}return s}(t.xLabels,a,o);(function(t,e){return!(!t||!e||t.length!==e.length)&&t.every((t,i)=>t===e[i])})(l,this._xLabelVisible)||(this._xLabelVisible=l)}async _loadData(){const t=this._config,e=this.hass,i=t?.entity;if(!t||!e||!i)return this._grid=void 0,void(this._error=void 0);try{Os(e)}catch{return this._error="History unavailable",void(this._grid=void 0)}const n=++this._fetchVersion;this._loading=!0,this._error=void 0;try{const s=Ps(t.preset),a=this._resolveAggregate(s),r=await async function(t,e,i,n){const s=/* @__PURE__ */new Date,a=/* @__PURE__ */new Date(s.getTime()-60*i*60*1e3);if(qs(e)||"count"===n)return Ws(t,e,a,s,!0,n);if(i>=24&&("max"===n||"sum"===n))try{const r=await Ys(t,e,a,s,n,i>336?"day":"hour");if(function(t,e){return!!t.length&&("max"!==e&&"sum"!==e||t.some(t=>t.value>0))}(r,n))return r}catch{}if(i>=24&&"mean"===n)try{const r=await Ys(t,e,a,s,n,i>336?"day":"hour");if(r.length>0)return r}catch{}return Ws(t,e,a,s,!1,n)}(e,i,ps[s.period],a);if(n!==this._fetchVersion)return;if(await new Promise(t=>{"function"!=typeof requestIdleCallback?setTimeout(t,0):requestIdleCallback(()=>t(),{timeout:120})}),n!==this._fetchVersion)return;this._grid=Ts(r,s.x,s.y,s.period,a,e.config.time_zone||"UTC",1)}catch(s){if(n!==this._fetchVersion)return;this._error=function(t,e="Could not load history"){return t instanceof Error||"object"==typeof t&&null!==t&&"message"in t&&"string"==typeof t.message?t.message:e}(s),this._grid=void 0}finally{n===this._fetchVersion&&(this._loading=!1)}}_handleHeaderClick(t){t.stopPropagation(),this.hass&&this._config&&ss(this,this.hass,this._config,"tap")}_showPopover(t,e){const i=t.currentTarget,n=i.closest(".grid-wrap");if(!n)return;const s=i.getBoundingClientRect(),a=n.getBoundingClientRect(),r=this._config,o=r.entity?this.hass?.states[r.entity]:void 0,l=String(o?.attributes.unit_of_measurement??""),c=this._resolveAggregate(Ps(r.preset));this._popover={anchorX:s.left-a.left+s.width/2,anchorY:s.top-a.top,label:e.rangeLabel,value:na(e.value,c,"count"===c?"":l),count:e.count}}_hidePopover(){this._popover=void 0}_renderLegend(t){const e=this._config,i=ea(e.color_mode),n=e.entity?this.hass?.states[e.entity]:void 0,s=String(n?.attributes.unit_of_measurement??""),a=this._resolveAggregate(Ps(e.preset)),r=Ce(this,i,e.color_low,e.color_high),o=(t.min+t.max)/2;return V`
    ...
    `}_renderCell(t,e,i,n,s,a,r){const o=Ls(t.value,n.min,n.max),l=null!==t.value;return V`
      <div
    ...
    `:K}_renderGrid(t){const e=this._config,i=ea(e.color_mode),n=!1!==e.show_axis_labels,s=!0===e.show_cell_values,a=!1!==e.show_legend,r=e.entity?this.hass?.states[e.entity]:void 0,o=String(r?.attributes.unit_of_measurement??""),l=this._resolveAggregate(Ps(e.preset)),c=n?2:1,h=this._xLabelVisible??t.xLabels.map(()=>!0);if(function(t){return 1===t.yKeys.length&&""===t.yKeys[0]}(t))return this._renderTimelineGrid(t,e,i,n,s,a,l,o,h);const d=n?`auto repeat(${t.xLabels.length}, minmax(0, 1fr))`:`repeat(${t.xLabels.length}, minmax(0, 1fr))`;return V`
      <div class="heatmap-body">
        <div class="cells-legend-row">
            ...
            <div class="grid-wrap">
              ...
              >
                    ${t.cells.flatMap((a,r)=>{const h=r+1;return[n?V`
                          ...
                          `:K,...a.map((n,a)=>{const r=Ls(n.value,t.min,t.max),d=null!==n.value;return V`
                          <div
