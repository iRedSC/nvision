...
`,ee=ht(()=>{Xt="nvision-blank-card",Qt="nvision-blank-card-editor"});function ie(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var ne,se=ht(()=>{}),ae=ht(()=>{kt(),se(),ne=class extends _t{},ie([St({attribute:!1})],ne.prototype,"hass",void 0)});function oe(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function re(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,ce,he=ht(()=>{}),de=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ce}),ue=ht(()=>{kt(),Dt(),Bt(),ae(),he(),ee(),se(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},oe()],ce=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
      ...
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],ce.prototype,"_config",void 0),ce=ie([yt(Qt)],ce)});kt(),Dt(),ee(),se(),Ht({type:Xt,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var me=class extends _t{constructor(...t){super(...t),this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(ue(),de)),document.createElement(Qt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Xt}`,entity:n}}setConfig(t){this._config={tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Kt(t);return G`
      <ha-card>
        <div
          class="content"
          role="button"
  ...
  `]}};ie([St({attribute:!1})],me.prototype,"hass",void 0),ie([zt()],me.prototype,"_config",void 0),me=ie([yt(Xt)],me);var pe=1,ge=t=>(...e)=>({_$litDirective$:t,values:e}),fe=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};wt();var _e,ve,ye,be,xe=ge(class extends fe{constructor(t){if(super(t),t.type!==pe||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const n=t[i];return null==n?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const n of this.ft)e[n]??(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in e){const t=e[n];if(null!=t){this.ft.add(n);const e="string"==typeof t&&t.endsWith(" !important");n.includes("-")||e?i.setProperty(n,e?t.slice(0,-11):t,e?"important":""):i[n]=t}}return Y}});function we(t,e,i){return getComputedStyle(t).getPropertyValue(e).trim()||i}function $e(t,e){if(!t)return e;if(Array.isArray(t)&&t.length>=3)return`rgb(${t[0]}, ${t[1]}, ${t[2]})`;if("string"==typeof t){const e=t.split(",").map(t=>Number(t.trim()));return e.length>=3&&e.every(t=>Number.isFinite(t))?`rgb(${e[0]}, ${e[1]}, ${e[2]})`:t}return e}function Me(t,e,i,n){return $e(t,we(e,i,n))}function ke(t){_e??=document.createElement("canvas"),_e.width=1,_e.height=1;const e=_e.getContext("2d");if(!e)return[41,182,246];e.fillStyle="#000000",e.fillStyle=t,e.fillRect(0,0,1,1);const[i,n,s]=e.getImageData(0,0,1,1).data;return[i,n,s]}function Ce([t,e,i]){return`rgb(${t}, ${e}, ${i})`}function Se(t,e,i){return[Math.round(t[0]+(e[0]-t[0])*i),Math.round(t[1]+(e[1]-t[1])*i),Math.round(t[2]+(e[2]-t[2])*i)]}function Ae(t,e){return e>=0?Se(t,[255,255,255],e):Se(t,[0,0,0],-e)}function ze(t,e){const i=ke(we(t,"--success-color","#4caf50")),n=ke(we(t,"--warning-color","#ff9800")),s=ke(we(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return Ce(a<=.5?Se(i,n,2*a):Se(n,s,2*(a-.5)))}var Ee,Pe,Te=ht(()=>{ve="nvision-activity-card",ye="nvision-activity-card-editor",be={still:"idle",unknown:"idle",on_foot:"on_foot",walking:"walking",running:"running",on_bicycle:"bicycle",in_vehicle:"vehicle",automotive:"vehicle",tilting:"tilting"}}),Oe=/* @__PURE__ */dt({NvisionActivityCardEditor:()=>Pe}),Le=ht(()=>{kt(),Dt(),Bt(),ae(),he(),Te(),se(),Ee=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"color",selector:{color_rgb:{}}},{name:"speed",required:!0,default:1,selector:{number:{min:.25,max:3,step:.05}}},oe()],Pe=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"color"===t.name?"Figure color":"speed"===t.name?"Animation speed":"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={speed:1,...t}}render(){return this.hass&&this._config?G`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],Pe.prototype,"_config",void 0),Pe=ie([yt(ye)],Pe)});function Ie(t,e,i){const n=.7*i;return V`
  ...
  `}kt(),Dt(),Te(),se(),Ht({type:ve,name:"Nvision Activity",description:"Animated figure that reacts to detected activity (walking, running, cycling, driving…)"});var qe,Re,Fe,Ne,je=class extends _t{constructor(...t){super(...t),this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Le(),Oe)),document.createElement(ye)}static getStubConfig(t,e,i){const n=e.find(t=>t.toLowerCase().includes("activity"))||e.find(t=>t.startsWith("sensor."))||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${ve}`,entity:n}}setConfig(t){this._config={speed:1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 4}getGridOptions(){return{columns:6,rows:4}}_renderScene(t){return"bicycle"===t?this._renderCyclist():"vehicle"===t?this._renderCar():this._renderPerson()}_renderPerson(){return V`
            ...
            <div class="grid-wrap">
              ...
              >
                    ${t.cells.flatMap((a,o)=>{const h=o+1;return[n?G`
                          ...
                          `:K,...a.map((n,a)=>{const o=qs(n.value,t.min,t.max),d=null!==n.value;return G`
                          <div
  ...
  `]}};ie([St({attribute:!1})],fa.prototype,"hass",void 0),ie([zt()],fa.prototype,"_config",void 0),ie([zt()],fa.prototype,"_grid",void 0),ie([zt()],fa.prototype,"_loading",void 0),ie([zt()],fa.prototype,"_error",void 0),ie([zt()],fa.prototype,"_popover",void 0),ie([zt()],fa.prototype,"_xLabelVisible",void 0),fa=ie([yt(Us)],fa);var _a=ht(()=>{ua="nvision-reactor-core-card",ma="nvision-reactor-core-card-editor",pa="auto",ga=["sensor","binary_sensor"]});hi(),_a();var va=[.42,.58,.72,.84],ya=[185,198,215,248,278,312,42],ba=2*Math.PI;function xa(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}function wa(t,e){if(js(e))return"binary";const i=t.states[e]?.state;return void 0!==Ze(i)?"numeric":"other"}function $a(t,e){const i=t.states[e]?.state;return void 0!==i&&"unavailable"!==i&&"unknown"!==i&&("on"===i||"true"===i||"open"===i||"home"===i)}function Ma(t,e,i,n){const s=Ze(t.states[e]?.state);return void 0===s?.35:Je(s,i,n)}function ka(t,e){return"binary"===t?0:"numeric"===t?Math.round(4+12*e):8}function Ca(t,e){const i=Math.min(va.length,Math.max(2,Math.ceil(Math.sqrt(e)))),n=t%i,s=Math.ceil(e/i);return{shell:n,slot:Math.floor(t/i)%s,slotsOnShell:s}}function Sa(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:ga,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function Aa(t,e,i,n,s,a){const o=xa(e),r=xa(`${e}:y`),l=Ca(s,a),c=wa(t,e),h=Ma(t,e,i,n),d=t.states[e]?.state,u=l.shell%2==0?1:-1;return{entityId:e,kind:c,seed:o,seedY:r,x:0,y:0,phase:o*ba,shell:l.shell,slot:l.slot,slotsOnShell:l.slotsOnShell,orbitTilt:o*ba,orbitRyScale:.62+.32*r,orbitSpeed:u*(55e-5+75e-5*o),wobbleSpeed:.0016+.0024*r,trail:[],trailCapacity:ka(c,h),binaryOn:$a(t,e),flash:0,lastState:d,numericNorm:h,unavailable:"unavailable"===d||"unknown"===d,placed:!1}}function za(t,e){const i=t/2,n=e/2,s=Math.max(10,.06*t),a=Math.max(10,.06*e);return{cx:i,cy:n,halfW:Math.max(1,t/2-s),halfH:Math.max(1,e/2-a),scale:Math.min(t,e)}}function Ea(t,e,i,n){const{cx:s,cy:a,halfW:o,halfH:r}=za(e,i),l=va[t.shell%va.length],c=t.slot/Math.max(1,t.slotsOnShell)*ba+.55*t.seed+t.phase,h=o*l,d=r*l*t.orbitRyScale,u=Math.cos(c)*h,m=Math.sin(c)*d,p=t.orbitTilt;let g=s+u*Math.cos(p)-m*Math.sin(p),f=a+u*Math.sin(p)+m*Math.cos(p);const _=.001*n,v=.035+.025*t.seed;g+=Math.cos(_*t.wobbleSpeed+11*t.seed)*h*v,f+=Math.sin(_*t.wobbleSpeed*1.23+9*t.seedY)*d*v,t.x=g,t.y=f,t.placed=!0}function Pa(t,e,i){const n=(14e-6*e+.31*t.seed)%ya.length,s=Math.floor(n),a=ya[s]+(ya[(s+1)%ya.length]-ya[s])*(n-s);let o=82,r=58;return"binary"===t.kind?(o=t.binaryOn?96:58,r=t.binaryOn?70:38):t.unavailable&&(o=18,r=42),`hsla(${a}, ${o}%, ${r}%, ${i})`}function Ta(t){if(t.trailCapacity<=0)return void(t.trail=[]);const e=t.trail[t.trail.length-1];e&&Math.hypot(t.x-e.x,t.y-e.y)<2.5||(t.trail.push({x:t.x,y:t.y}),t.trail.length>t.trailCapacity&&t.trail.shift())}function Oa(t,e,i){const n=e.trail;if(!(n.length<2))for(let s=1;s<n.length;s+=1){const a=s/n.length;t.beginPath(),t.moveTo(n[s-1].x,n[s-1].y),t.lineTo(n[s].x,n[s].y),t.strokeStyle=Pa(e,i,.06+.34*a),t.lineWidth=.8+1.6*a,t.stroke()}}function La(t,e,i,n,s,a,o=.5){t.beginPath(),t.arc(e,i,n*(1+a*o),0,ba),t.fillStyle=s.replace(/[\d.]+\)$/,.07+.1*a+")"),t.fill(),t.beginPath(),t.arc(e,i,n,0,ba),t.fillStyle=s,t.fill()}function Ia(t,e,i,n,s){const{cx:a,cy:o,scale:r}=za(i,n),l=Math.min(va.length,Math.max(2,Math.ceil(Math.sqrt(Math.max(1,e.length)))));t.clearRect(0,0,i,n),function(t,e,i,n,s){const{cx:a,cy:o,halfW:r,halfH:l}=za(e,i),c=ya[Math.floor(1e-5*s%ya.length)];for(let h=0;h<n;h+=1){const e=va[h%va.length];t.beginPath(),t.ellipse(a,o,r*e,l*e*.78,0,0,ba),t.strokeStyle=`hsla(${c}, 55%, 55%, 0.07)`,t.lineWidth=1,t.stroke()}}(t,i,n,l,s);for(const c of e)Oa(t,c,s);for(const c of e){const e=c.flash,i=("binary"===c.kind?.022*r:"numeric"===c.kind?.011*r+c.numericNorm*r*.007:.013*r)*(1+.45*e);let n=c.unavailable?.28:.78;"binary"===c.kind&&(n=c.binaryOn?.55+.35*Math.sin(.012*s+12*c.seed):.35),n=Math.min(1,n+.55*e);const a=Pa(c,s,n);La(t,c.x,c.y,i,a,n)}La(t,a,o,.012*r*(.55+.12*Math.sin(.0018*s)),`hsla(${ya[Math.floor(14e-6*s%ya.length)]}, 88%, 68%, 0.65)`,.5,.3)}function qa(t){for(const e of t)e.trail=[]}var Ra,Fa,Na,ja=/* @__PURE__ */dt({NvisionReactorCoreCardEditor:()=>Na}),Da=ht(()=>{kt(),Dt(),Bt(),ae(),he(),_a(),se(),Ra=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:pa,selector:{select:{options:[{value:"auto",label:"Auto-discover sensors"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},oe()],Fa=[{name:"entities",selector:{entity:{multiple:!0,domain:["sensor","binary_sensor"]}}}],Na=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"min"===t.name?"Numeric trail min":"max"===t.name?"Numeric trail max":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:pa,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...Ra.slice(0,3),...Fa,...Ra.slice(3)]:Ra}render(){return this.hass&&this._config?G`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],Na.prototype,"_config",void 0),Na=ie([yt(ma)],Na)});kt(),Dt(),_a(),se(),Ht({type:ua,name:"Nvision Reactor Core",description:"Orbiting sensor particles with reactor-style glow trails"});var Ha=class extends _t{constructor(...t){super(...t),this._frameId=0,this._animating=!1,this._lastFrame=0,this._particles=[],this._entityKey="",this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Da(),ja)),document.createElement(ma)}static getStubConfig(t,e,i){const n=[...e,...i,...Object.keys(t.states)],s=/* @__PURE__ */new Set,a=[];for(const o of n){if(s.has(o))continue;s.add(o);const t=o.split(".",1)[0];if("sensor"!==t&&"binary_sensor"!==t||a.push(o),a.length>=8)break}return{type:`custom:${ua}`,mode:pa,entities:a.length?a:void 0,max_particles:32,min:0,max:100}}setConfig(t){this._config={mode:pa,max_particles:32,min:0,max:100,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t},this._entityKey="",qa(this._particles)}getCardSize(){return 2}getGridOptions(){return{columns:6,rows:2}}connectedCallback(){super.connectedCallback(),this._lastFrame=0,this._startAnimation()}disconnectedCallback(){this._stopAnimation(),this._resizeObserver?.disconnect(),this._resizeObserver=void 0,super.disconnectedCallback()}updated(t){(t.has("hass")||t.has("_config"))&&this.hass&&this._config&&this._syncParticles(),this._ensureCanvas()}_canvasSize(){const t=this._canvas;return t?{width:t.clientWidth,height:t.clientHeight}:{width:0,height:0}}_syncParticles(t=performance.now()){if(!this.hass||!this._config)return;const{width:e,height:i}=this._canvasSize(),n=Ua(this.hass,this._config).join("|"),s=[this._config.mode,this._config.max_particles,(this._config.domains??[]).join(","),(this._config.exclude??[]).join(","),this._config.min,this._config.max,(this._config.entities??[]).join(","),e,i].join(";");n+s!==this._entityKey&&(qa(this._particles),this._entityKey=n+s),this._particles=function(t,e,i,n=0,s=0,a=0){const o=i.min??0,r=i.max??100,l=Sa(e,i),c=new Map(t.map(t=>[t.entityId,t])),h=[];for(let d=0;d<l.length;d+=1){const t=l[d],i=c.get(t);if(i){const c=Ca(d,l.length),u=wa(e,t),m=Ma(e,t,o,r),p=$a(e,t),g=e.states[t]?.state??"";i.shell=c.shell,i.slot=c.slot,i.slotsOnShell=c.slotsOnShell,void 0!==i.lastState&&g!==i.lastState&&(i.flash=1),i.lastState=g,i.kind=u,i.numericNorm=m,i.binaryOn=p,i.trailCapacity=ka(u,m),i.unavailable="unavailable"===e.states[t]?.state||"unknown"===e.states[t]?.state,i.trail.length>i.trailCapacity&&(i.trail=i.trail.slice(-i.trailCapacity)),n>0&&s>0&&Ea(i,n,s,a),h.push(i);continue}const u=Aa(e,t,o,r,d,l.length);n>0&&s>0&&Ea(u,n,s,a),h.push(u)}return h}(this._particles,this.hass,this._config,e,i,t)}_ensureCanvas(){const t=this._canvas;if(t){if(!this._ctx){if(this._ctx=t.getContext("2d")??void 0,!this._ctx)return;this._resizeObserver=new ResizeObserver(()=>{this._resizeCanvas(),qa(this._particles),this._syncParticles()}),this._resizeObserver.observe(this._stage??t.parentElement??this)}this._resizeCanvas(),this._syncParticles(),this._animating||(this._lastFrame=0,this._startAnimation())}}_startAnimation(){if(this._animating||!this._ctx)return;this._animating=!0;const t=e=>{if(!this.isConnected||!this._ctx)return void(this._animating=!1);const i=this._lastFrame?Math.min((e-this._lastFrame)/16.67,3):1;this._lastFrame=e,this._draw(i,e),this._frameId=requestAnimationFrame(t)};this._frameId=requestAnimationFrame(t)}_stopAnimation(){cancelAnimationFrame(this._frameId),this._animating=!1}_resizeCanvas(){const t=this._canvas;if(!t)return;const e=t.getBoundingClientRect(),i=window.devicePixelRatio||1;t.width=Math.max(1,Math.floor(e.width*i)),t.height=Math.max(1,Math.floor(e.height*i)),this._ctx?.setTransform(i,0,0,i,0,0)}_draw(t,e){const i=this._canvas,n=this._ctx;if(!(i&&n&&this.hass&&this._config))return;const s=i.clientWidth,a=i.clientHeight;if(s<=0||a<=0)return;this._particles.length||this._syncParticles(e);const o=window.matchMedia("(prefers-reduced-motion: reduce)").matches;!function(t,e,i,n,s,a){const o=a?.15:1;for(const r of t)r.phase+=r.orbitSpeed*n*o,Ea(r,e,i,s),r.flash>0&&(r.flash=Math.max(0,r.flash-.0045*n)),r.placed&&Ta(r)}(this._particles,s,a,t,e,o),Ia(n,this._particles,s,a,e)}render(){if(!this._config||!this.hass)return K;const t=this._config.name||"Reactor Core",e=this._particles.length||Ua(this.hass,this._config).length;return G`
      <ha-card>
        <div class="stage">
          <canvas aria-hidden="true"></canvas>
          <div
    ...
    `]}};function Ua(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:["sensor","binary_sensor"],n=e.max_particles??32;return Object.keys(t.states).filter(t=>i.includes(t.split(".",1)[0])).sort((t,e)=>t.localeCompare(e)).slice(0,n)}ie([St({attribute:!1})],Ha.prototype,"hass",void 0),ie([zt()],Ha.prototype,"_config",void 0),ie([Lt(".stage")],Ha.prototype,"_stage",void 0),ie([Lt("canvas")],Ha.prototype,"_canvas",void 0),Ha=ie([yt(ua)],Ha),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");