...
`,ee=ht(()=>{Xt="nvision-blank-card",Qt="nvision-blank-card-editor"});function ie(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var ne,se=ht(()=>{}),ae=ht(()=>{kt(),se(),ne=class extends _t{},ie([St({attribute:!1})],ne.prototype,"hass",void 0)});function oe(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function re(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,ce,he=ht(()=>{}),de=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ce}),ue=ht(()=>{kt(),jt(),Ht(),ae(),he(),ee(),se(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},oe()],ce=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${le}
      ...
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],ce.prototype,"_config",void 0),ce=ie([yt(Qt)],ce)});kt(),jt(),ee(),se(),Bt({type:Xt,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var me=class extends _t{constructor(...t){super(...t),this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(ue(),de)),document.createElement(Qt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Xt}`,entity:n}}setConfig(t){this._config={tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return K;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Kt(t);return G`
      <ha-card>
        <div
          class="content"
          role="button"
  ...
  `]}};ie([St({attribute:!1})],me.prototype,"hass",void 0),ie([zt()],me.prototype,"_config",void 0),me=ie([yt(Xt)],me);var pe=1,ge=t=>(...e)=>({_$litDirective$:t,values:e}),fe=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};wt();var _e,ve,ye,be,xe=ge(class extends fe{constructor(t){if(super(t),t.type!==pe||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const n=t[i];return null==n?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const n of this.ft)e[n]??(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in e){const t=e[n];if(null!=t){this.ft.add(n);const e="string"==typeof t&&t.endsWith(" !important");n.includes("-")||e?i.setProperty(n,e?t.slice(0,-11):t,e?"important":""):i[n]=t}}return Y}});function we(t,e,i){return getComputedStyle(t).getPropertyValue(e).trim()||i}function $e(t,e){if(!t)return e;if(Array.isArray(t)&&t.length>=3)return`rgb(${t[0]}, ${t[1]}, ${t[2]})`;if("string"==typeof t){const e=t.split(",").map(t=>Number(t.trim()));return e.length>=3&&e.every(t=>Number.isFinite(t))?`rgb(${e[0]}, ${e[1]}, ${e[2]})`:t}return e}function Me(t,e,i,n){return $e(t,we(e,i,n))}function ke(t){_e??=document.createElement("canvas"),_e.width=1,_e.height=1;const e=_e.getContext("2d");if(!e)return[41,182,246];e.fillStyle="#000000",e.fillStyle=t,e.fillRect(0,0,1,1);const[i,n,s]=e.getImageData(0,0,1,1).data;return[i,n,s]}function Ce([t,e,i]){return`rgb(${t}, ${e}, ${i})`}function Se(t,e,i){return[Math.round(t[0]+(e[0]-t[0])*i),Math.round(t[1]+(e[1]-t[1])*i),Math.round(t[2]+(e[2]-t[2])*i)]}function Ae(t,e){return e>=0?Se(t,[255,255,255],e):Se(t,[0,0,0],-e)}function ze(t,e){const i=ke(we(t,"--success-color","#4caf50")),n=ke(we(t,"--warning-color","#ff9800")),s=ke(we(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return Ce(a<=.5?Se(i,n,2*a):Se(n,s,2*(a-.5)))}var Ee,Pe,Te=ht(()=>{ve="nvision-activity-card",ye="nvision-activity-card-editor",be={still:"idle",unknown:"idle",on_foot:"on_foot",walking:"walking",running:"running",on_bicycle:"bicycle",in_vehicle:"vehicle",automotive:"vehicle",tilting:"tilting"}}),Oe=/* @__PURE__ */dt({NvisionActivityCardEditor:()=>Pe}),Ie=ht(()=>{kt(),jt(),Ht(),ae(),he(),Te(),se(),Ee=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"color",selector:{color_rgb:{}}},{name:"speed",required:!0,default:1,selector:{number:{min:.25,max:3,step:.05}}},oe()],Pe=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"color"===t.name?"Figure color":"speed"===t.name?"Animation speed":"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={speed:1,...t}}render(){return this.hass&&this._config?G`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],Pe.prototype,"_config",void 0),Pe=ie([yt(ye)],Pe)});function Le(t,e,i){const n=.7*i;return V`
  ...
  `}kt(),jt(),Te(),se(),Bt({type:ve,name:"Nvision Activity",description:"Animated figure that reacts to detected activity (walking, running, cycling, driving…)"});var qe,Re,Fe,Ne,De=class extends _t{constructor(...t){super(...t),this._actions=new Yt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Ie(),Oe)),document.createElement(ye)}static getStubConfig(t,e,i){const n=e.find(t=>t.toLowerCase().includes("activity"))||e.find(t=>t.startsWith("sensor."))||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${ve}`,entity:n}}setConfig(t){this._config={speed:1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 4}getGridOptions(){return{columns:6,rows:4}}_renderScene(t){return"bicycle"===t?this._renderCyclist():"vehicle"===t?this._renderCar():this._renderPerson()}_renderPerson(){return V`
  ...
  `]}};ie([St({attribute:!1})],va.prototype,"hass",void 0),ie([zt()],va.prototype,"_config",void 0),ie([zt()],va.prototype,"_grid",void 0),ie([zt()],va.prototype,"_loading",void 0),ie([zt()],va.prototype,"_error",void 0),ie([zt()],va.prototype,"_popover",void 0),ie([zt()],va.prototype,"_xLabelVisible",void 0),va=ie([yt(Hs)],va);var ya=ht(()=>{ma="nvision-reactor-core-card",pa="nvision-reactor-core-card-editor",ga="auto",fa=["sensor","binary_sensor","switch","light","timer"],_a=["sensor","binary_sensor","switch","light","timer"]});function ba(t){const e=t.split(":").map(Number);return 3===e.length?3600*e[0]+60*e[1]+e[2]:2===e.length?60*e[0]+e[1]:Number(t)||0}function xa(t){return void 0!==t&&"unavailable"!==t&&"unknown"!==t&&("on"===t||"true"===t||"open"===t||"home"===t||"active"===t)}function wa(t,e){const i=e.split(".",1)[0];if("light"===i)return"light";if("timer"===i)return"timer";if("switch"===i||js(e))return"toggle";const n=t.states[e]?.state;return void 0!==Ze(n)?"numeric":"other"}function $a(t,e,i,n){const s=Ze(t.states[e]?.state);return void 0===s?.35:Je(s,i,n)}function Ma(t,e){const i=t.states[e];if(!i||"active"!==i.state)return 0;const n=function(t){const e=t.attributes.remaining;if("string"!=typeof e)return;let i=ba(e);if("active"===t.state&&t.attributes.finishes_at){const e=new Date(String(t.attributes.finishes_at)).getTime();i=Math.max((e-Date.now())/1e3,0)}return i}(i),s=function(t){const e=t.attributes.duration;return"string"==typeof e?ba(e):0}(i);return void 0===n||s<=0?.55:1-Math.min(1,Math.max(0,n/s))}function ka(t,e,i,n){const s=t.states[e]?.state,a=wa(t,e),o="light"===a?function(t,e){const i=t.states[e];if(!i||"on"!==i.state)return{lightBrightness:0};const n=os(i);return{lightColor:n?`rgb(${n.join(", ")})`:void 0,lightBrightness:ns(i)}}(t,e):{};return{kind:a,isOn:xa(s),numericNorm:$a(t,e,i,n),lightColor:o.lightColor,lightBrightness:o.lightBrightness??0,timerUrgency:"timer"===a?Ma(t,e):0,unavailable:"unavailable"===s||"unknown"===s}}ya(),hi();var Ca=[.42,.58,.72,.84],Sa=[185,198,215,248,278,312,42],Aa=2*Math.PI,za=.34,Ea=1.1,Pa=.06;function Ta(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}function Oa(t,e){const i=Math.min(Ca.length,Math.max(2,Math.ceil(Math.sqrt(e)))),n=t%i,s=Math.ceil(e/i);return{shell:n,slot:Math.floor(t/i)%s,slotsOnShell:s}}function Ia(t,e){const i=(14e-6*e+.31*t)%Sa.length,n=Math.floor(i);return Sa[n]+(Sa[(n+1)%Sa.length]-Sa[n])*(i-n)}function La(t,e,i,n){const s=ka(e,t.entityId,i,n);t.kind=s.kind,t.isOn=s.isOn,t.numericNorm=s.numericNorm,t.lightColor=s.lightColor,t.lightBrightness=s.lightBrightness,t.timerUrgency=s.timerUrgency,t.unavailable=s.unavailable}function qa(t,e){const i=Ra(t,e),n=.014*e;return Math.min(3.4,Math.max(.5,n/Math.max(i,.004*e)))}function Ra(t,e){return"numeric"===t.kind?Fa(e,t.numericNorm):Na(e,t.kind)}function Fa(t,e){return t*(.006+.028*e)}function Na(t,e){switch(e){case"toggle":return.016*t;case"light":return.011*t;case"timer":return.013*t;case"numeric":return.012*t;default:return.01*t}}function Da(t,e){e.push({x:t.x,y:t.y,age:0,seed:t.seed})}function ja(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:fa,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function Ba(t,e,i,n,s,a){const o=Ta(e),r=Ta(`${e}:y`),l=Oa(s,a),c=t.states[e]?.state,h={entityId:e,kind:wa(t,e),seed:o,seedY:r,x:0,y:0,phase:o*Aa,shell:l.shell,slot:l.slot,slotsOnShell:l.slotsOnShell,orbitTilt:o*Aa,orbitRyScale:.62+.32*r,baseOrbitSpeed:85e-5+.0011*o,wobbleSpeed:.0016+.0024*r,pathDrift:0,isOn:!1,lastState:c,numericNorm:.35,lightBrightness:0,timerUrgency:0,unavailable:"unavailable"===c||"unknown"===c,placed:!1};return La(h,t,i,n),h}function Ua(t,e){const i=t/2,n=Math.min(.22*e,72),s=(e-n)/2,a=Math.max(10,.06*t),o=Math.max(10,.06*e+.35*n),r=Math.max(1,t/2-a),l=Math.max(1,(e-n)/2-o);return{cx:i,cy:s,halfW:r,halfH:l,scale:Math.min(t,e),clampX:r,clampY:l}}function Ha(t,e,i,n){const{cx:s,cy:a,halfW:o,halfH:r}=Ua(e,i),l=Ca[t.shell%Ca.length],c=t.slot/Math.max(1,t.slotsOnShell)*Aa+.55*t.seed+t.phase,h=o*l,d=r*l*t.orbitRyScale,u=Math.cos(c)*h,m=Math.sin(c)*d,p=t.orbitTilt;let g=s+u*Math.cos(p)-m*Math.sin(p),f=a+u*Math.sin(p)+m*Math.cos(p);const _=.001*n,v=.028+.018*t.seed;return g+=Math.cos(_*t.wobbleSpeed+11*t.seed)*h*v,f+=Math.sin(_*t.wobbleSpeed*1.23+9*t.seedY)*d*v,{x:g,y:f}}function Wa(t,e,i,n){const s=Ha(t,e,i,n),a=Ha(t,e,i,n+24),o=a.x-s.x,r=a.y-s.y,l=Math.hypot(o,r);return l<.01?{x:1,y:0}:{x:o/l,y:r/l}}function Ga(t,e,i,n){const s=Ha(t,e,i,n);t.x=s.x,t.y=s.y,t.pathDrift=0,t.placed=!0}function Va(t,e,i){const n=Ia(t.seed,e);let s=82,a=58;return t.unavailable&&(s=18,a=42),`hsla(${n}, ${s}%, ${a}%, ${i})`}function Ya(t,e){for(const i of e)t.beginPath(),t.arc(i.x,i.y,i.radius,0,Aa),t.fillStyle=i.color,t.fill()}function Ka(t,e,i,n,s,a=.5){const o=i*(1+s*a),r={core:{x:t,y:e,radius:i,color:n}};return o>1.02*i&&(r.halo={x:t,y:e,radius:o,color:n.replace(/[\d.]+\)$/,.07+.1*s+")")}),r}function Xa(t,e,i){switch(t.kind){case"toggle":return function(t,e,i){const n=Na(e,"toggle"),s=t.isOn?.009:.007,a=(Math.sin(i*s+12*t.seed)+1)/2,o=Ia(t.seed,i),r=t.unavailable?18:t.isOn?38+50*a:38,l=t.unavailable?42:t.isOn?36+22*a:36,c=`hsla(${o}, ${r}%, ${l}%, ${t.unavailable?.18:t.isOn?za+.44*a:za})`,h=t.unavailable?1.08*n:t.isOn?n*(Ea+.4*a):n*Ea,d=`hsla(${o}, ${r}%, ${Math.max(l-6,40)}%, ${t.isOn?Pa+.12*a:Pa})`;return{halo:h>1.02*n?{x:t.x,y:t.y,radius:h,color:d}:void 0,core:{x:t.x,y:t.y,radius:n,color:c}}}(t,e,i);case"light":return function(t,e,i){const n=t.lightBrightness,s=Na(e,"light"),a=t.unavailable?.25:t.isOn?.55+.35*n:.18,o=t.lightColor??(t.isOn?"rgb(255, 183, 77)":Va(t,i,.25)),r=Qa(o,a),l=t.unavailable?1.08*s:t.isOn?s*(1.35+2.15*n):1.08*s,c=Qa(o,t.isOn?.08+.16*n:.05);return{halo:l>1.02*s?{x:t.x,y:t.y,radius:l,color:c}:void 0,core:{x:t.x,y:t.y,radius:s,color:r}}}(t,e,i);case"timer":return function(t,e,i){const n=t.timerUrgency,s=Na(e,"timer"),a=.005+.048*n,o=Math.sin(i*a+10*t.seed),r=(o+1)/2,l=r*o*(24+36*n),c=(Ia(t.seed,i)+l+360)%360,h=52+6*n,d=.38+.24*n,u=t.unavailable?18:38+50*r,m=t.unavailable?42:36+r*(h-36),p=`hsla(${c}, ${u}%, ${m}%, ${t.unavailable?.25:za+r*(d-za)})`,g=t.unavailable?1.08*s:s*(Ea+r*(.35+.45*n)),f=`hsla(${c}, ${u}%, ${Math.max(m-4,40)}%, ${Pa+r*(.08+.12*n)})`;return{halo:g>1.02*s?{x:t.x,y:t.y,radius:g,color:f}:void 0,core:{x:t.x,y:t.y,radius:s,color:p}}}(t,e,i);default:return function(t,e,i){const n="numeric"===t.kind?Fa(e,t.numericNorm):Na(e,t.kind),s=t.unavailable?.28:.78,a=Va(t,i,s);return Ka(t.x,t.y,n,a,.65*s)}(t,e,i)}}function Qa(t,e){const i=t.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/);return i?`rgba(${i[1]}, ${i[2]}, ${i[3]}, ${e})`:t.match(/hsla?\(([^)]+)\)/)?t.replace(/[\d.]+\)$/,`${e})`):t}function Za(t,e,i,n,s,a){const{cx:o,cy:r,scale:l,clampX:c,clampY:h}=Ua(e,i),d=.012*l,u=.003*l,m=.05*a,p=.024*a,g=.09*l,f=t.map(t=>function(t,e){const i=Ra(t,e);return"toggle"===t.kind?t.isOn?1.55*i:i*Ea:"light"===t.kind?t.isOn?i*(1.2+1.4*t.lightBrightness):1.08*i:"timer"===t.kind?1.45*i:1.3*i}(t,l));for(let v=0;v<t.length;v+=1){const e=t[v];e.phase+=e.baseOrbitSpeed*qa(e,l)*n}const _=t.map(t=>{return{target:Ha(t,e,i,s),normal:(n=Wa(t,e,i,s),{x:-n.y,y:n.x})};var n});for(let v=0;v<t.length;v+=1){const e=t[v],{target:i,normal:s}=_[v],a=f[v],y=Math.max(a,u)/d,b=m*Math.min(1.35,Math.max(.4,1/Math.sqrt(y)));let x=-e.pathDrift*b*n;const w=i.x+s.x*e.pathDrift,$=i.y+s.y*e.pathDrift;for(let o=0;o<t.length;o+=1){if(o===v)continue;const e=t[o],i=_[o],r=f[o],c=a+r,h=c+.014*l,d=w-(i.target.x+i.normal.x*e.pathDrift),m=$-(i.target.y+i.normal.y*e.pathDrift),g=Math.hypot(d,m);if(g<=.5||g>=h)continue;const b=(h-g)/(h-.65*c),M=Math.max(0,c-g),k=(b**1.2+M/c*2.5)*p*(Math.max(r,u)/Math.max(a,u))*n,C=d/g*s.x+m/g*s.y;x+=C*k,M>0&&(x+=C*(M/c)*.35*(1/y)*n)}e.pathDrift+=x,e.pathDrift=Math.min(g,Math.max(-g,e.pathDrift));let M=i.x+s.x*e.pathDrift,k=i.y+s.y*e.pathDrift;M=Math.min(o+c,Math.max(o-c,M)),k=Math.min(r+h,Math.max(r-h,k)),e.x=M,e.y=k,e.pathDrift=(M-i.x)*s.x+(k-i.y)*s.y,e.placed=!0}}function Ja(t,e,i,n,s,a,o=[]){const{cx:r,cy:l,scale:c}=Ua(n,s);t.clearRect(0,0,n,s);const h=t.createRadialGradient(r,l,0,r,l,.72*c);h.addColorStop(0,"hsla(200, 70%, 58%, 0.06)"),h.addColorStop(.35,"hsla(260, 55%, 42%, 0.03)"),h.addColorStop(1,"hsla(0, 0%, 0%, 0)"),t.fillStyle=h,t.fillRect(0,0,n,s),function(t,e,i,n){for(const s of e){const e=s.age/1400,a=i*(.03+.48*e),o=(1-e)**1.2*.11,r=Ia(s.seed,n);t.beginPath(),t.arc(s.x,s.y,a,0,Aa),t.strokeStyle=`hsla(${r}, 86%, 64%, ${o})`,t.lineWidth=1+1.4*(1-e),t.stroke()}}(t,i,c,a);const d=[],u=[];for(const m of e){const t=Xa(m,c,a);t.halo&&d.push(t.halo),u.push(t.core)}Ya(t,d),o.length&&function(t,e,i,n){for(const s of e){const e=`hsla(${Ia(s.seed,n)}, 78%, 62%, 0.42)`;t.beginPath(),t.moveTo(s.fromX,s.fromY),t.lineTo(s.toX,s.toY),t.strokeStyle=e,t.lineWidth=1,t.stroke(),t.beginPath(),t.arc(s.toX,s.toY,.0045*i,0,Aa),t.fillStyle=e.replace(/[\d.]+\)$/,"0.65)"),t.fill()}}(t,o,c,a),Ya(t,u);!function(t,e,i,n,s,a,o=.5){const r=Ka(e,i,n,s,a,o);r.halo&&Ya(t,[r.halo]),Ya(t,[r.core])}(t,r,l,.012*c*(.55+.12*Math.sin(.0018*a)),`hsla(${Sa[Math.floor(14e-6*a%Sa.length)]}, 88%, 68%, 0.65)`,.5,.3)}var to,eo,io,no=/* @__PURE__ */dt({NvisionReactorCoreCardEditor:()=>io}),so=ht(()=>{kt(),jt(),Ht(),ae(),he(),ya(),se(),to=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:ga,selector:{select:{options:[{value:"auto",label:"Auto-discover entities"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},oe()],eo=[{name:"entities",selector:{entity:{multiple:!0,domain:[..._a]}}}],io=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"min"===t.name?"Numeric orbit min":"max"===t.name?"Numeric orbit max":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:ga,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...to.slice(0,3),...eo,...to.slice(3)]:to}render(){return this.hass&&this._config?G`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
    ...
    `]}};ie([St({attribute:!1})],ao.prototype,"hass",void 0),ie([zt()],ao.prototype,"_config",void 0),ie([zt()],ao.prototype,"_slotIds",void 0),ie([It(".stage")],ao.prototype,"_stage",void 0),ie([It("canvas")],ao.prototype,"_canvas",void 0),ao=ie([yt(ma)],ao),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");