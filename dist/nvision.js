...
`,Qt=ht(()=>{Dt="nvision-blank-card",Gt="nvision-blank-card-editor"});function Xt(t,e,i,n){var s,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var o=t.length-1;o>=0;o--)(s=t[o])&&(r=(a<3?s(r):a>3?s(e,i,r):s(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r}var Zt=ht(()=>{});function Jt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}var Kt,te,ee,ie=ht(()=>{}),ne=ht(()=>{At(),Zt(),Kt=class extends _t{},Xt([kt({attribute:!1})],Kt.prototype,"hass",void 0)}),se=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ee}),ae=ht(()=>{At(),Ut(),ie(),ne(),Qt(),Zt(),te=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}}],ee=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
  ...
  `]}};Xt([kt({attribute:!1})],Si.prototype,"hass",void 0),Xt([zt()],Si.prototype,"_config",void 0),Xt([Lt("canvas")],Si.prototype,"_canvas",void 0),Si=Xt([yt(Ye)],Si);var zi=ht(()=>{fi="nvision-waveform-card",_i="nvision-waveform-card-editor",vi=.72,yi=.78,bi=.45,xi="line",wi="balanced",$i="wave",Mi={line:"line",circle:"ring",grid:"field"},Ai=[{value:"line",label:"Line"},{value:"ring",label:"Ring"},{value:"field",label:"Field"}],Ci=[{value:"compact",label:"Compact"},{value:"balanced",label:"Balanced"},{value:"expansive",label:"Expansive"}],ki=[{value:"wave",label:"Wave"},{value:"echo",label:"Echo"},{value:"pulse",label:"Pulse"},{value:"stream",label:"Stream"},{value:"spectrum",label:"Spectrum"},{value:"cascade",label:"Cascade"}]});zi();var Ei={compact:{dotScale:.88,span:.94,phaseSpeed:.92},balanced:{dotScale:1,span:.98,phaseSpeed:1},expansive:{dotScale:1.08,span:1,phaseSpeed:1.08}},Pi={line:{compact:16,balanced:24,expansive:32},ring:{compact:18,balanced:24,expansive:32},field:{compact:16,balanced:25,expansive:36}};function Ti(t){return t*t*(3-2*t)}function Ii(t,e){const i=Math.max(.08,t),n=Ti(i);return e*(.28+.16*(1-n)+.22*n+.26*Math.max(0,i-.5)**2)}function Li(t){return.42+.68*Ti(Math.max(.08,t))}function Oi(t){return"ring"===t.layout?t.index/t.count*Math.PI*2:.38*t.index}function qi(t,e,i){const{dot:n,index:s,phase:a,intensity:r,variant:o}=t;if(r<=.38)return{x:e,y:i};const l=(a+1.4*o)*(1+.18*r),c=s+.47*o,h=r*r;let d=function(t){const{phase:e,intensity:i,dot:n,variant:s}=t;if(i<=.28)return 0;const a=Ti(i),r=(e+1.2*s)*(1+.15*i),o=t.index+.47*s,l=t.width*a*(.04+.22*Math.max(0,i-.55));return Math.sin(r*(3.1+2.4*n.seed)+.85*o)*l+Math.cos(r*(5.6+.35*o)+n.phase)*l*a*.65}(t),u=Math.sin(l*(2.2+2*n.seed)+1.15*c)*t.height*h*.14;if(r>.45){const e=(r-.45)**2;u+=Math.sin(8.2*l+2.1*c)*t.height*e*.2,d+=Math.cos(7.4*l+1.7*c+n.phase+o)*t.height*e*.16}if("ring"===t.layout){const n=e-t.width/2,s=i-t.height/2,a=Math.atan2(s,n),r={x:-Math.sin(a),y:Math.cos(a)},o={x:Math.cos(a),y:Math.sin(a)};return{x:e+r.x*d+o.x*u,y:i+r.y*d+o.y*u}}return{x:e+d,y:i+u}}function Ri(t){const e=function(t){return t.layout?t.layout:t.shape?Mi[t.shape]??"line":xi}(t),i=function(t){if(t.size)return t.size;const e=t.dot_count;if(void 0!==e){if(e<=18)return"compact";if(e>=30)return"expansive"}return wi}(t),n=function(t){return t.motion?t.motion:t.overlap_dots?"echo":$i}(t),s=Ei[i];return{layout:e,size:i,motion:n,dotCount:Pi[e][i],dotScale:s.dotScale,span:s.span,phaseSpeed:s.phaseSpeed,dualLayer:"echo"===n}}function Fi(t){return Array.from({length:t},(e,i)=>({phase:i/t*Math.PI*2,seed:.618033988749895*i%1}))}function Ni(t){return.5*t}function ji(t){const{phase:e,intensity:i,height:n,baseX:s,baseY:a,variant:r}=t,o=Ii(i,n),l=Ti(i),c=e+1.85*r,h=Oi(t),d=Li(i);return{x:s,y:a+(Math.sin(c*d-h)*o+Math.sin(c*d*.5-.5*h)*o*l*.55),radiusMul:.88+.32*l,alphaMul:.72+.3*l}}var Ui={wave:ji,pulse:function(t){const{dot:e,index:i,phase:n,intensity:s,baseX:a,baseY:r,variant:o}=t,l=Ti(s),c=Math.floor(i/4),h=Math.sin(.75*n+1.15*c+.6*o);return{x:a,y:r+Math.sin(n+6.28*e.seed)*t.height*.04*(.5+.65*l),radiusMul:.72+(.28+.45*l)*(.5+.5*h),alphaMul:.55+(.25+.35*l)*(.5+.5*h)}},stream:function(t){const{phase:e,intensity:i,height:n,baseX:s,baseY:a,variant:r}=t,o=Ti(i),l=Ii(i,n),c=e+1.2*r,h=Oi(t),d=Li(i);return{x:s+Math.sin(c*d*.58+.35*h)*l*(.75+.85*o),y:a+Math.sin(c*d-h)*l*.65,radiusMul:.86+.26*o,alphaMul:.68+.3*o}},spectrum:function(t){const{dot:e,index:i,phase:n,intensity:s,height:a,baseX:r,baseY:o}=t,l=Ti(s),c=a*(.14+.34*l),h=.5*(.55*Math.sin(.9*n+8.4*e.seed)+.45*Math.sin(1.7*n+.42*i+e.phase)+1);return{x:r,y:o-h*c*(.35+1.05*l),radiusMul:.78+h*l*.35,alphaMul:.58+h*l*.38}},echo:function(t){const e=ji(t);return t.variant?{...e,radiusMul:.9*e.radiusMul,alphaMul:.62*e.alphaMul}:e},cascade:function(t){const{index:e,count:i,phase:n,intensity:s,baseX:a,baseY:r,variant:o}=t,l=Ti(s),c=Ii(s,t.height),h=i<=1?1:e/(i-1),d=n+1.4*o,u=Oi(t),g=Li(s),m=.45+h*(.55+.4*l);return{x:a,y:r+Math.sin(d*g*1.1-1.5*u)*c*m,radiusMul:.82+.28*l*m,alphaMul:.64+.34*l*m}}};function Bi(t,e,i,n,s,a,r,o,l){const c=Math.min(r,o),h=function(t,e,i,n,s,a){const r=Math.min(n,s),o=.04*r;switch(t){case"ring":{const t=n/2,o=s/2,l=.06*r,c=(Math.min(n,s)/2-l)*(.92+.06*a),h=(e+.5)/i*Math.PI*2-Math.PI/2;return{x:t+Math.cos(h)*c,y:o+Math.sin(h)*c}}case"field":{const t=Math.ceil(Math.sqrt(i)),o=Math.ceil(i/t),l=.04*r,c=.04*r,h=.028*r*a,d=(n-2*l-h*(t-1))/t,u=(s-2*c-h*(o-1))/o;return{x:l+e%t*(d+h)+d/2,y:c+Math.floor(e/t)*(u+h)+u/2}}default:{const t=n-o,r=(t-o)*a;return{x:(o+t-r)/2+(i<=1?.5:e/(i-1))*r,y:Ni(s)}}}}(t.layout,i,n,r,o,t.span),d=(0,Ui[t.motion])({dot:e,index:i,count:n,phase:s,intensity:a,scale:c,baseX:h.x,baseY:h.y,width:r,height:o,variant:l,layout:t.layout});return function(t,e){let{x:i,y:n}=e;const{layout:s,baseX:a,baseY:r,width:o,height:l}=t;if("ring"===s){const t=o/2,e=l/2,s=i-a,c=n-r,h=Math.atan2(r-e,a-t),d={x:-Math.sin(h),y:Math.cos(h)},u={x:Math.cos(h),y:Math.sin(h)};i=a+d.x*c+u.x*s,n=r+d.y*c+u.y*s}return({x:i,y:n}=qi(t,i,n)),{...e,x:i,y:n}}({dot:e,index:i,count:n,phase:s,intensity:a,scale:c,baseX:h.x,baseY:h.y,width:r,height:o,variant:l,layout:t.layout},d)}function Hi(t,e,i,n){const s=.04*i,a=.58*i;let r=1;t<a&&(r=t<=s?.06:.06+.94*Ti((t-s)/(a-s)));const o=.5*n,l=.42*n,c=Math.abs(e-o);let h=1;return t<a&&c<l&&(h=.08+.92*Ti(c/l)),r*h}function Di(t,e,i,n,s,a){if("ring"===a)return 1;const r=Math.max(4,.06*s),o=Math.max(3,.04*s),l=Math.min(1,Math.max(0,t/r)),c=Math.min(1,Math.max(0,(i-t)/r)),h=Math.min(1,Math.max(0,e/o)),d=Math.min(1,Math.max(0,(n-e)/o));return"line"===a?Math.min(l,c):Math.min(l,c,h,d)}var Gi,Wi,Vi=/* @__PURE__ */dt({NvisionWaveformCardEditor:()=>Wi}),Yi=ht(()=>{At(),Ut(),ie(),ne(),zi(),Zt(),Gi=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{name:"color",selector:{color_rgb:{}}},{type:"grid",name:"",schema:[{name:"layout",required:!0,default:xi,selector:{select:{options:[...Ai],mode:"dropdown"}}},{name:"size",required:!0,default:wi,selector:{select:{options:[...Ci],mode:"dropdown"}}}]},{name:"motion",required:!0,default:$i,selector:{select:{options:[...ki],mode:"dropdown"}}},{name:"shake_speed",required:!0,default:bi,selector:{number:{min:.15,max:1.5,step:.05}}}],Wi=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color"===t.name?"Waveform color":"layout"===t.name?"Layout":"size"===t.name?"Size":"motion"===t.name?"Motion":"shake_speed"===t.name?"Shake speed":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,layout:xi,size:wi,motion:$i,shake_speed:bi,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Gi}
  ...
  `]}};Xt([kt({attribute:!1})],Ji.prototype,"hass",void 0),Xt([zt()],Ji.prototype,"_config",void 0),Xt([Lt(".stage")],Ji.prototype,"_stage",void 0),Xt([Lt("canvas")],Ji.prototype,"_canvas",void 0),Ji=Xt([yt(fi)],Ji);var Ki,tn,en=ht(()=>{Xi="nvision-air-quality-card",Zi="nvision-air-quality-card-editor"}),nn=/* @__PURE__ */dt({NvisionAirQualityCardEditor:()=>tn}),sn=ht(()=>{At(),Ut(),ie(),ne(),en(),Zt(),Ki=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"color_good",selector:{color_rgb:{}}},{name:"color_warning",selector:{color_rgb:{}}}]},{type:"grid",name:"",schema:[{name:"color_bad",selector:{color_rgb:{}}},{name:"color_mist",selector:{color_rgb:{}}}]},{type:"grid",name:"",schema:[{name:"color_clear",selector:{color_rgb:{}}},{name:"color_sky",selector:{color_rgb:{}}}]}],tn=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color_good"===t.name?"Good gauge color":"color_warning"===t.name?"Moderate gauge color":"color_bad"===t.name?"Poor gauge color":"color_mist"===t.name?"Mist color":"color_clear"===t.name?"Clear glow color":"color_sky"===t.name?"Sky glow color":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Ki}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:Q}_valueChanged(t){Jt(this,"config-changed",{config:t.detail.value})}},Xt([zt()],tn.prototype,"_config",void 0),tn=Xt([yt(Zi)],tn)});At(),Ut(),en(),Zt(),Bt({type:Xi,name:"Nvision Air Quality",description:"Gauge with gradient arc, mist when air is poor, crisp glow when clear"});var an=40*Math.PI,rn=.38,on=.62;function ln(t){return t>=rn?0:(rn-t)/rn}function cn(t){return t<=on?0:(t-on)/.38}function hn(t,e){return{good:_e(t?.color_good,e,"--success-color","#4caf50"),warning:_e(t?.color_warning,e,"--warning-color","#ff9800"),bad:_e(t?.color_bad,e,"--error-color","#f44336"),mist:_e(t?.color_mist,e,"--secondary-text-color","#888888"),clear:_e(t?.color_clear,e,"--success-color","#4caf50"),sky:_e(t?.color_sky,e,"--info-color","#2196f3")}}function dn(t){if(void 0===t||"unavailable"===t||"unknown"===t)return;const e=Number(t);return Number.isFinite(e)?e:void 0}function un(t,e,i){return i<=e?0:Math.min(1,Math.max(0,(t-e)/(i-e)))}var gn,mn,pn=0,fn=class extends _t{constructor(...t){super(...t),this._gaugeReady=!1,this._gradientId="aq-gradient-"+ ++pn,this._frameId=0,this._animating=!1,this._lastFrame=0,this._phase=0,this._displayValue=0,this._targetValue=0,this._mist=[]}static async getConfigElement(){return await Promise.resolve().then(()=>(sn(),nn)),document.createElement(Zi)}static getStubConfig(t,e,i){const n=e.find(e=>function(t,e){const i=t.states[e];if(!i)return!1;const n=i.attributes?.device_class;return"aqi"===n||"pm25"===n||"pm10"===n||/aqi|air_quality|pm2/i.test(e)}(t,e))||e.find(e=>void 0!==dn(t.states[e]?.state))||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Xi}`,entity:n,min:0,max:100}}setConfig(t){this._config={min:0,max:100,...t}}getCardSize(){return 4}getGridOptions(){return{columns:6,rows:2}}connectedCallback(){super.connectedCallback(),this._ctx&&(this._lastFrame=0,this._startAnimation())}disconnectedCallback(){this._stopAnimation(),this._resizeObserver?.disconnect(),super.disconnectedCallback()}firstUpdated(){requestAnimationFrame(()=>{this._gaugeReady=!0})}updated(t){(t.has("hass")||t.has("_config"))&&(this._syncValue(),this._applyEffectLevels(this._badness(this._targetValue))),this._ensureCanvas()}_range(){return{min:this._config?.min??0,max:this._config?.max??100}}_syncValue(){const t=this._config?.entity,e=dn(t?this.hass?.states[t]?.state:void 0),{min:i,max:n}=this._range();this._targetValue=void 0!==e?Math.min(n,Math.max(i,e)):i}_tickValue(t){const e=this._targetValue-this._displayValue;return Math.abs(e)<.05?this._displayValue=this._targetValue:this._displayValue+=.08*e*t,this._displayValue}_badness(t){const{min:e,max:i}=this._range();return un(t,e,i)}_applyEffectLevels(t){this._stage?.style.setProperty("--haze",String(cn(t))),this._stage?.style.setProperty("--clarity",String(ln(t)))}_ensureCanvas(){const t=this._canvas;t&&!this._ctx&&(this._ctx=t.getContext("2d")??void 0,this._ctx&&(this._resizeObserver=new ResizeObserver(()=>this._resizeCanvas()),this._resizeObserver.observe(t.parentElement??this),this._resizeCanvas(),this._lastFrame=0,this._startAnimation()))}_startAnimation(){if(this._animating)return;this._animating=!0;const t=e=>{if(!this.isConnected||!this._ctx)return void(this._animating=!1);const i=this._lastFrame?Math.min((e-this._lastFrame)/16.67,3):1;this._lastFrame=e,this._draw(i),this._frameId=requestAnimationFrame(t)};this._frameId=requestAnimationFrame(t)}_stopAnimation(){cancelAnimationFrame(this._frameId),this._animating=!1}_resizeCanvas(){const t=this._canvas;if(!t)return;const e=t.getBoundingClientRect(),i=window.devicePixelRatio||1;t.width=Math.max(1,Math.floor(e.width*i)),t.height=Math.max(1,Math.floor(e.height*i)),this._ctx?.setTransform(i,0,0,i,0,0)}_ensureMist(t,e,i){const n=Math.floor(16*i);for(;this._mist.length<n;)this._mist.push({x:Math.random()*t,y:Math.random()*e,radius:18+42*Math.random(),vx:.22*(Math.random()-.5),vy:-.04-.18*Math.random(),alpha:.04+.1*Math.random()});this._mist.length>n&&(this._mist.length=n)}_drawMist(t,e,i,n,s,a){if(!(n<.08)){this._ensureMist(e,i,n);for(const r of this._mist){r.x+=r.vx*s,r.y+=r.vy*s,r.y+r.radius<0&&(r.y=i+r.radius,r.x=Math.random()*e),r.x<-r.radius&&(r.x=e+r.radius),r.x>e+r.radius&&(r.x=-r.radius);const o=t.createRadialGradient(r.x,r.y,0,r.x,r.y,r.radius);o.addColorStop(0,a),o.addColorStop(1,"rgba(0,0,0,0)"),t.beginPath(),t.arc(r.x,r.y,r.radius,0,2*Math.PI),t.fillStyle=o,t.globalAlpha=r.alpha*n*1.4,t.fill()}t.globalAlpha=1}}_drawClearGlow(t,e,i,n,s,a){if(n<.2)return;const r=.5*e,o=.36*i,l=.94+.06*Math.sin(.5*this._phase),c=.62*Math.min(e,i)*l,h=t.createRadialGradient(r,o,0,r,o,c);h.addColorStop(0,s),h.addColorStop(.55,a),h.addColorStop(1,"rgba(0,0,0,0)"),t.fillStyle=h,t.globalAlpha=n*n*.1,t.fillRect(0,0,e,i);const d=t.createLinearGradient(0,0,0,.55*i);d.addColorStop(0,a),d.addColorStop(1,"rgba(0,0,0,0)"),t.fillStyle=d,t.globalAlpha=.06*n,t.fillRect(0,0,e,i),t.globalAlpha=1}_draw(t){const e=this._canvas,i=this._ctx;if(!e||!i)return;const n=e.clientWidth,s=e.clientHeight;if(n<=0||s<=0)return;this._syncValue();const a=this._tickValue(t),r=this._badness(a),o=ln(r),l=cn(r);this._phase+=.025*t,this._applyEffectLevels(r);const c=hn(this._config,this);i.clearRect(0,0,n,s),this._drawClearGlow(i,n,s,o,c.clear,c.sky),this._drawMist(i,n,s,l,t,c.mist)}_renderGauge(t,e,i,n,s,a){const{min:r,max:o}=this._range(),l=function(t,e,i){return 180*un(t,e,i)}(t,r,o),c=this._gaugeReady?an*(1-l/180):an;return V`
    ...
    `}render(){if(!this._config||!this.hass)return Q;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=dn(t?.state),i=e??this._targetValue,n=this._config.name||t?.attributes.friendly_name||"Air Quality",s=t?.attributes.unit_of_measurement??"",a=void 0!==e?String(Math.round(10*e)/10):"—",r=hn(this._config,this);return W`
      <ha-card
  ...
  `]}};Xt([kt({attribute:!1})],fn.prototype,"hass",void 0),Xt([zt()],fn.prototype,"_config",void 0),Xt([zt()],fn.prototype,"_gaugeReady",void 0),Xt([Lt("canvas")],fn.prototype,"_canvas",void 0),Xt([Lt(".stage")],fn.prototype,"_stage",void 0),fn=Xt([yt(Xi)],fn);var _n,vn,yn=ht(()=>{gn="nvision-circle-gauge-card",mn="nvision-circle-gauge-card-editor"}),bn=/* @__PURE__ */dt({NvisionCircleGaugeCardEditor:()=>vn}),xn=ht(()=>{At(),Ut(),ie(),ne(),yn(),Zt(),_n=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{name:"color",selector:{color_rgb:{}}},{name:"track_color",selector:{color_rgb:{}}},{name:"reverse",selector:{boolean:{}}}],vn=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color"===t.name?"Gauge color":"track_color"===t.name?"Track color":"reverse"===t.name?"Reverse":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${_n}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:Q}_valueChanged(t){Jt(this,"config-changed",{config:t.detail.value})}},Xt([zt()],vn.prototype,"_config",void 0),vn=Xt([yt(mn)],vn)});At(),Ut(),yn(),Zt(),Bt({type:gn,name:"Nvision Circle Gauge",description:"Full-circle gauge with the value centered, ideal for timers"});var wn=2*Math.PI*40;function $n(t){if(void 0===t||"unavailable"===t||"unknown"===t)return;const e=Number(t);return Number.isFinite(e)?e:void 0}function Mn(t){const e=t.split(":").map(Number);return 3===e.length?3600*e[0]+60*e[1]+e[2]:2===e.length?60*e[0]+e[1]:Number(t)||0}function An(t){const e=t.attributes.duration;return"string"==typeof e?Mn(e):0}function Cn(t,e,i){return"idle"===t.state&&void 0===e?"Idle":void 0===e?"—":"idle"===t.state&&0===e?"Idle":function(t,e){const i=Math.max(0,Math.floor(t)),n=Math.floor(i/3600),s=Math.floor(i%3600/60),a=i%60,r={};if(n&&(r.hours=n),s&&(r.minutes=s),(a||!n&&!s)&&(r.seconds=a),e?.language&&"undefined"!=typeof Intl&&"DurationFormat"in Intl)return new Intl.DurationFormat(e.language,{style:"narrow",hoursDisplay:n?"always":"auto"}).format(r);const o=[];return n&&o.push(`${n}h`),s&&o.push(`${s}m`),(a||0===o.length)&&o.push(`${a}s`),o.join(" ")}(e,i)}function kn(t){return t?.startsWith("timer.")??!1}var Sn,zn,En=class extends _t{constructor(...t){super(...t),this._gaugeReady=!1,this._tick=0,this._rescaleOnConnect=!1}static async getConfigElement(){return await Promise.resolve().then(()=>(xn(),bn)),document.createElement(mn)}static getStubConfig(t,e,i){const n=e.find(t=>t.startsWith("timer."))||e.find(e=>function(t,e){const i=t.states[e];return!(!i||!kn(e)&&void 0===$n(i.state))}(t,e))||e[0]||i[0]||Object.keys(t.states)[0],s=t.states[n],a=s&&kn(n)&&An(s)||100;return{type:`custom:${gn}`,entity:n,min:0,max:a}}setConfig(t){this._config={min:0,max:100,...t}}getCardSize(){return 4}getGridOptions(){return{columns:6,rows:3}}connectedCallback(){super.connectedCallback(),this._syncTimerInterval(),this._rescaleOnConnect&&requestAnimationFrame(()=>{this._rescaleTextSvg(),this._rescaleOnConnect=!1})}disconnectedCallback(){this._clearTimerInterval(),super.disconnectedCallback()}firstUpdated(){requestAnimationFrame(()=>{this._gaugeReady=!0,this._rescaleTextSvg()})}updated(t){(t.has("hass")||t.has("_config"))&&this._syncTimerInterval(),(t.has("hass")||t.has("_config")||t.has("_tick")||t.has("_gaugeReady"))&&requestAnimationFrame(()=>this._rescaleTextSvg())}_range(){return{min:this._config?.min??0,max:this._config?.max??100}}_clearTimerInterval(){void 0!==this._timerInterval&&(clearInterval(this._timerInterval),this._timerInterval=void 0)}_syncTimerInterval(){this._clearTimerInterval();const t=this._config?.entity,e=t?this.hass?.states[t]:void 0;e&&kn(t)&&"active"===e.state&&(this._timerInterval=window.setInterval(()=>{this._tick+=1},1e3))}_reading(){this._tick;const t=this._config?.entity,e=t?this.hass?.states[t]:void 0,{min:i,max:n}=this._range();if(!e)return{value:i,valueText:"—",unit:""};if(kn(t)){const t=An(e),s=function(t){const e=t.attributes.remaining;if("string"!=typeof e)return;let i=Mn(e);if("active"===t.state&&t.attributes.finishes_at){const e=new Date(String(t.attributes.finishes_at)).getTime();i=Math.max((e-Date.now())/1e3,0)}return i}(e),a=n>i?n:t||n;return{value:s??("idle"===e.state?a:i),valueText:Cn(e,s??t,this.hass?.locale),unit:""}}const s=$n(e.state),a=s??i;if(this.hass?.formatEntityStateToParts){const t=this.hass.formatEntityStateToParts(e);return{value:a,valueText:t.find(t=>"value"===t.type)?.value??(void 0!==s?String(s):"—"),unit:t.find(t=>"unit"===t.type)?.value??""}}const r=String(e.attributes.unit_of_measurement??"");return{value:a,valueText:void 0!==s?String(s):"—",unit:r}}_rescaleTextSvg(){if(!this.isConnected)return void(this._rescaleOnConnect=!0);const t=this.shadowRoot?.querySelector(".text"),e=t?.querySelector(".text-group");if(!t||!e)return;const i=e.getBBox();0===i.width&&0===i.height||t.setAttribute("viewBox",`${i.x} ${i.y} ${i.width} ${i.height}`)}_renderGauge(t,e,i,n,s){const{min:a,max:r}=this._range(),o=this._config?.entity,l=o?this.hass?.states[o]:void 0,c=l&&kn(o)?An(l):r,h=function(t,e,i){return i<=e?0:Math.min(1,Math.max(0,(t-e)/(i-e)))}(t,a,kn(o)&&c>a?c:r),d=this._config?.reverse?1-h:h;return V`
      <svg viewBox="-50 -50 100 100" class="gauge">
        ...
        <circle
          ...
          stroke=${n}
          stroke-dasharray=${wn}
          style=${me({strokeDashoffset:`${this._gaugeReady?wn*(1-d):this._config?.reverse?0:wn}`})}
          transform="rotate(-90)"
        />
      </svg>
      <svg class="text">
  ...
  `]}};Xt([kt({attribute:!1})],En.prototype,"hass",void 0),Xt([zt()],En.prototype,"_config",void 0),Xt([zt()],En.prototype,"_gaugeReady",void 0),Xt([zt()],En.prototype,"_tick",void 0),En=Xt([yt(gn)],En);var Pn,Tn,In=ht(()=>{Sn="nvision-power-draw-card",zn="nvision-power-draw-card-editor"}),Ln=/* @__PURE__ */dt({NvisionPowerDrawCardEditor:()=>Tn}),On=ht(()=>{At(),Ut(),ie(),ne(),Ke(),In(),Zt(),Pn=[{name:"entity",selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:Se,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"effects_min",required:!0,default:0,selector:{number:{min:0,max:1,step:.05}}},{name:"effects_max",required:!0,default:1,selector:{number:{min:0,max:1,step:.05}}}]},{name:"color",selector:{color_rgb:{}}},{name:"icon",selector:{icon:{}}}],Tn=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum watts":"max"===t.name?"Maximum watts":"effects_min"===t.name?"Minimum effect":"effects_max"===t.name?"Maximum effect":"color"===t.name?"Lightning color":"icon"===t.name?"Source icon":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:Se,effects_min:0,effects_max:1,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Pn}
  ...
  `]}};Xt([kt({attribute:!1})],Fn.prototype,"hass",void 0),Xt([zt()],Fn.prototype,"_config",void 0),Xt([Lt("canvas")],Fn.prototype,"_canvas",void 0),Xt([Lt(".plug")],Fn.prototype,"_plug",void 0),Xt([Lt(".entity-icon")],Fn.prototype,"_entityIcon",void 0),Fn=Xt([yt(Sn)],Fn);var Nn,jn,Un=ht(()=>{qn="nvision-power-glance-card",Rn="nvision-power-glance-card-editor"}),Bn=/* @__PURE__ */dt({NvisionPowerGlanceCardEditor:()=>jn}),Hn=ht(()=>{At(),Ut(),ie(),ne(),Ke(),Un(),Zt(),Nn=[{name:"entities",selector:{entity:{multiple:!0,domain:"sensor"}}},{name:"columns",default:3,selector:{number:{min:1,max:6,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:Se,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"effects_min",required:!0,default:0,selector:{number:{min:0,max:1,step:.05}}},{name:"effects_max",required:!0,default:1,selector:{number:{min:0,max:1,step:.05}}}]},{name:"color",selector:{color_rgb:{}}},{name:"icon",selector:{icon:{}}}],jn=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"columns"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.columns"):"min"===t.name?"Minimum watts":"max"===t.name?"Maximum watts":"effects_min"===t.name?"Minimum effect":"effects_max"===t.name?"Maximum effect":"color"===t.name?"Lightning color":"icon"===t.name?"Source icon":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={entities:[],columns:3,min:0,max:Se,effects_min:0,effects_max:1,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Nn}
  ...
  `]}};Xt([kt({attribute:!1})],Dn.prototype,"hass",void 0),Xt([zt()],Dn.prototype,"_config",void 0),Xt([Lt("canvas")],Dn.prototype,"_canvas",void 0),Xt([Lt(".plug")],Dn.prototype,"_plug",void 0),Xt([function(t){return(e,i)=>Et(e,i,{get(){return(this.renderRoot??(Ot??=document.createDocumentFragment())).querySelectorAll(t)}})}(".entity-icon")],Dn.prototype,"_entityIcons",void 0),Dn=Xt([yt(qn)],Dn),wt();var Gn=le(class extends ce{constructor(t){if(super(t),t.type!==oe||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=/* @__PURE__ */new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const n of this.st)n in e||(i.remove(n),this.st.delete(n));for(const n in e){const t=!!e[n];t===this.st.has(n)||this.nt?.has(n)||(t?(i.add(n),this.st.add(n)):(i.remove(n),this.st.delete(n)))}return Y}});function Wn(t){const e=t.attributes.brightness;return e&&"on"===t.state?`brightness(${(e+245)/5}%)`:""}function Vn(t){const e=Math.max(1e3,Math.min(4e4,t))/100;let i,n,s;return e<=66?(i=255,n=Math.min(255,Math.max(0,99.4708025861*Math.log(e)-161.1195681661)),s=e<=19?0:Math.min(255,Math.max(0,138.5177312231*Math.log(e-10)-305.0447927307))):(i=Math.min(255,Math.max(0,329.698727446*(e-60)**-.1332047592)),n=Math.min(255,Math.max(0,288.1221695283*(e-60)**-.0755148492)),s=255),[Math.round(i),Math.round(n),Math.round(s)]}function Yn(t){if("on"!==t.state)return;const e=t.attributes.rgb_color;if(e)return e;const i=t.attributes.color_temp_kelvin;if("number"==typeof i)return Vn(i);const n=t.attributes.color_temp;if("number"==typeof n&&n>0)return Vn(Math.round(1e6/n));const s=t.attributes.hs_color;return s?function(t,e,i){const n=e/100,s=i/100,a=(1-Math.abs(2*s-1))*n,r=t/60,o=a*(1-Math.abs(r%2-1));let l=0,c=0,h=0;r>=0&&r<1?(l=a,c=o):r<2?(l=o,c=a):r<3?(c=a,h=o):r<4?(c=o,h=a):r<5?(l=o,h=a):(l=a,h=o);const d=s-a/2;return[Math.round(255*(l+d)),Math.round(255*(c+d)),Math.round(255*(h+d))]}(s[0],s[1],50):void 0}ie();var Qn={tap:"toggle",hold:"more-info",double_tap:"none"},Xn={tap:"tap_action",hold:"hold_action",double_tap:"double_tap_action"};function Zn(t,e,i,n){const s=i[Xn[n]],a=s?.action??Qn[n];if("none"===a)return;const r=s?.entity??i.entity;if(r)switch(a){case"toggle":return void e.callService("homeassistant","toggle",{entity_id:r});case"more-info":return void Jt(t,"hass-more-info",{entityId:r});case"navigate":return void(s?.navigation_path&&Jt(t,"hass-navigate",{navigation_path:s.navigation_path}));case"url":return void(s?.url_path&&window.open(s.url_path));case"call-service":if(s?.service){const[t,i]=s.service.split(".",2);e.callService(t,i,s.service_data,s.target)}return;default:return}}var Jn,Kn,ts,es,is="nvision-light-glow-stack";var ns,ss,as=ht(()=>{Jn="nvision-light-card",Kn="nvision-light-card-editor",ts=.72,es=.62}),rs=/* @__PURE__ */dt({NvisionLightCardEditor:()=>ss}),os=ht(()=>{At(),Ut(),ie(),ne(),as(),Zt(),ns=[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{type:"grid",name:"",schema:[{name:"glow_size",required:!0,default:165,selector:{number:{min:20,max:300,step:5,unit_of_measurement:"%"}}},{name:"glow_intensity",required:!0,default:ts,selector:{number:{min:0,max:1,step:.05}}}]},{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}],ss=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"glow_size"===t.name?"Glow size":"glow_intensity"===t.name?"Glow intensity":"interactions"===t.name?"Interactions":"hold_action"===t.name||"double_tap_action"===t.name?`${this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)} (${this.hass.localize("ui.panel.lovelace.editor.card.config.optional")})`:this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={tap_action:{action:"toggle"},hold_action:{action:"more-info"},glow_size:165,glow_intensity:ts,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${ns}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:Q}_valueChanged(t){Jt(this,"config-changed",{config:t.detail.value})}},Xt([zt()],ss.prototype,"_config",void 0),ss=Xt([yt(Kn)],ss)});At(),Ut(),ie(),as(),Zt(),Bt({type:Jn,name:"Nvision Light",description:"Light control with ambient color glow"}),function(t){if("undefined"==typeof document||document.getElementById(is))return;const e=document.createElement("style");e.id=is,e.textContent=`\n    hui-card:has(${t}),\n    .card:has(${t}) {\n      position: relative;\n      z-index: 0;\n      overflow: visible;\n    }\n\n    hui-card:not(:has(${t})),\n    .card:not(:has(${t})) {\n      position: relative;\n      z-index: 1;\n    }\n\n    section:has(${t}) {\n      position: relative;\n      z-index: 0;\n    }\n\n    section:not(:has(${t})) {\n      position: relative;\n      z-index: 1;\n    }\n\n    section .meta {\n      position: relative;\n      z-index: 2;\n    }\n\n    .preview:has(${t}) {\n      overflow: visible;\n    }\n  `,document.head.appendChild(e)}(Jn);var ls=class extends _t{constructor(...t){super(...t),this._holdTriggered=!1}static async getConfigElement(){return await Promise.resolve().then(()=>(os(),rs)),document.createElement(Kn)}static getStubConfig(t,e,i){const n=e.find(t=>t.startsWith("light."))||i.find(t=>t.startsWith("light."))||Object.keys(t.states).find(t=>t.startsWith("light."))||e[0]||i[0]||"";return{type:`custom:${Jn}`,entity:n,glow_size:165,glow_intensity:ts}}setConfig(t){if(!t.entity||"light"!==t.entity.split(".")[0])throw new Error("Specify an entity from within the light domain");this._config={tap_action:{action:"toggle"},hold_action:{action:"more-info"},glow_size:165,glow_intensity:ts,...t}}getCardSize(){return 5}getGridOptions(){return{columns:6,rows:5,min_rows:3}}render(){if(!this._config||!this.hass)return Q;const t=this._config.entity?this.hass.states[this._config.entity]:void 0;if(!t)return W`
        <ha-card>
          <div class="warning">Entity not found: ${this._config.entity}</div>
        </ha-card>
      `;const e=Math.round((t.attributes.brightness||0)/255*100),i="on"===t.state,n="unavailable"===t.state||"unknown"===t.state,s=function(t){const e=t.attributes.supported_features;if("number"==typeof e&&1&e)return!0;const i=t.attributes.supported_color_modes;return Boolean(i?.some(t=>"onoff"!==t))}(t),a=function(t){const e=Yn(t);return e?`rgb(${e.join(", ")})`:"on"===t.state?"var(--state-light-active-color, var(--state-active-color, #ffb74d))":"transparent"}(t),r=function(t){if("on"!==t.state)return 0;const e=t.attributes.brightness;return"number"!=typeof e?1:Math.max(0,Math.min(1,e/255))}(t),o=this._config.glow_size??165,l=(this._config.glow_intensity??.72)*r,c=o*es,h=this._config.name||t.attributes.friendly_name||this._config.entity,d={filter:Wn(t),color:i&&t.attributes.rgb_color?`rgb(${t.attributes.rgb_color.join(",")})`:""},u={"--bulb-color":a,"--nv-glow-size":`${o}%`,"--nv-glow-intensity":String(l),"--nv-glow-spread":`${c}px`};return W`
      <div
        class=${Gn({stage:!0,"state-on":i,"state-off":!i})}
        style=${me(u)}
      >
        <div class="glow-backdrop" aria-hidden="true"></div>
        <div class="glow-ambient" aria-hidden="true"></div>

        <ha-card class=${Gn({"state-on":i,"state-off":!i})}>
          <ha-icon-button
            class="more-info"
          ...
          <div id="controls">
            <div id="slider">
              ...
              ></round-slider>
              <ha-icon-button
                class=${Gn({"light-button":!0,"state-on":i,"state-unavailable":n})}
                style=${me(d)}
    ...
    `}_handleMoreInfo(){this._config?.entity&&Jt(this,"hass-more-info",{entityId:this._config.entity})}_handleTap(t){if(this._holdTriggered)return this._holdTriggered=!1,void t.preventDefault();this.hass&&this._config&&Zn(this,this.hass,this._config,"tap")}_handleDoubleTap(t){t.preventDefault(),this.hass&&this._config&&Zn(this,this.hass,this._config,"double_tap")}_handleHoldStart(){window.clearTimeout(this._holdTimer),this._holdTriggered=!1,this._holdTimer=window.setTimeout(()=>{this._holdTriggered=!0,this.hass&&this._config&&Zn(this,this.hass,this._config,"hold")},500)}_handleHoldEnd(){window.clearTimeout(this._holdTimer)}_dragBrightness(t){const e=this.shadowRoot?.querySelector(".brightness");e&&(e.innerHTML=`${t.detail.value}<span class="unit"> %</span>`,e.classList.add("show_brightness")),window.clearTimeout(this._brightnessTimeout),this._brightnessTimeout=window.setTimeout(()=>{e?.classList.remove("show_brightness")},500)}_setBrightness(t){this.hass&&this._config?.entity&&this.hass.callService("light","turn_on",{entity_id:this._config.entity,brightness_pct:t.detail.value})}static{this.styles=r`
    :host {
      display: block;
      height: 100%;
      overflow: visible;
  ...
  `}};Xt([kt({attribute:!1})],ls.prototype,"hass",void 0),Xt([zt()],ls.prototype,"_config",void 0),ls=Xt([yt(Jn)],ls),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");