...
`,ee=ht(()=>{Xt="nvision-blank-card",Qt="nvision-blank-card-editor"});function ie(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var ne,se=ht(()=>{}),ae=ht(()=>{kt(),se(),ne=class extends _t{},ie([St({attribute:!1})],ne.prototype,"hass",void 0)});function oe(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function re(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,ce,he=ht(()=>{}),de=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ce}),ue=ht(()=>{kt(),Dt(),Bt(),ae(),he(),ee(),se(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},oe()],ce=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
      ...
      ></ha-form>
    `:Y}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],ce.prototype,"_config",void 0),ce=ie([yt(Qt)],ce)});kt(),Dt(),ee(),se(),Ht({type:Xt,name:"Nvision Blank",description:"Neutral starting point for nvision cards"});var me=class extends _t{constructor(...t){super(...t),this._actions=new Kt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(ue(),de)),document.createElement(Qt)}static getStubConfig(t,e,i){const n=e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Xt}`,entity:n}}setConfig(t){this._config={tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Nvision",i=Yt(t);return W`
      <ha-card>
        <div
          class="content"
          role="button"
  ...
  `]}};ie([St({attribute:!1})],me.prototype,"hass",void 0),ie([zt()],me.prototype,"_config",void 0),me=ie([yt(Xt)],me);var pe=1,ge=t=>(...e)=>({_$litDirective$:t,values:e}),fe=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};wt();var _e,ve,ye,be,xe=ge(class extends fe{constructor(t){if(super(t),t.type!==pe||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const n=t[i];return null==n?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const n of this.ft)e[n]??(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in e){const t=e[n];if(null!=t){this.ft.add(n);const e="string"==typeof t&&t.endsWith(" !important");n.includes("-")||e?i.setProperty(n,e?t.slice(0,-11):t,e?"important":""):i[n]=t}}return K}});function we(t,e,i){return getComputedStyle(t).getPropertyValue(e).trim()||i}function $e(t,e){if(!t)return e;if(Array.isArray(t)&&t.length>=3)return`rgb(${t[0]}, ${t[1]}, ${t[2]})`;if("string"==typeof t){const e=t.split(",").map(t=>Number(t.trim()));return e.length>=3&&e.every(t=>Number.isFinite(t))?`rgb(${e[0]}, ${e[1]}, ${e[2]})`:t}return e}function Me(t,e,i,n){return $e(t,we(e,i,n))}function ke(t){_e??=document.createElement("canvas"),_e.width=1,_e.height=1;const e=_e.getContext("2d");if(!e)return[41,182,246];e.fillStyle="#000000",e.fillStyle=t,e.fillRect(0,0,1,1);const[i,n,s]=e.getImageData(0,0,1,1).data;return[i,n,s]}function Ce([t,e,i]){return`rgb(${t}, ${e}, ${i})`}function Se(t,e,i){return[Math.round(t[0]+(e[0]-t[0])*i),Math.round(t[1]+(e[1]-t[1])*i),Math.round(t[2]+(e[2]-t[2])*i)]}function Ae(t,e){return e>=0?Se(t,[255,255,255],e):Se(t,[0,0,0],-e)}function ze(t,e){const i=ke(we(t,"--success-color","#4caf50")),n=ke(we(t,"--warning-color","#ff9800")),s=ke(we(t,"--error-color","#f44336")),a=Math.min(1,Math.max(0,e));return Ce(a<=.5?Se(i,n,2*a):Se(n,s,2*(a-.5)))}var Ee,Pe,Te=ht(()=>{ve="nvision-activity-card",ye="nvision-activity-card-editor",be={still:"idle",unknown:"idle",on_foot:"on_foot",walking:"walking",running:"running",on_bicycle:"bicycle",in_vehicle:"vehicle",automotive:"vehicle",tilting:"tilting"}}),Ie=/* @__PURE__ */dt({NvisionActivityCardEditor:()=>Pe}),Le=ht(()=>{kt(),Dt(),Bt(),ae(),he(),Te(),se(),Ee=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"color",selector:{color_rgb:{}}},{name:"speed",required:!0,default:1,selector:{number:{min:.25,max:3,step:.05}}},oe()],Pe=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"color"===t.name?"Figure color":"speed"===t.name?"Animation speed":"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={speed:1,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:Y}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],Pe.prototype,"_config",void 0),Pe=ie([yt(ye)],Pe)});function Oe(t,e,i){const n=.7*i;return V`
  ...
  `}kt(),Dt(),Te(),se(),Ht({type:ve,name:"Nvision Activity",description:"Animated figure that reacts to detected activity (walking, running, cycling, driving…)"});var Re,qe,Fe,Ne,je=class extends _t{constructor(...t){super(...t),this._actions=new Kt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Le(),Ie)),document.createElement(ye)}static getStubConfig(t,e,i){const n=e.find(t=>t.toLowerCase().includes("activity"))||e.find(t=>t.startsWith("sensor."))||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${ve}`,entity:n}}setConfig(t){this._config={speed:1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 4}getGridOptions(){return{columns:6,rows:4}}_renderScene(t){return"bicycle"===t?this._renderCyclist():"vehicle"===t?this._renderCar():this._renderPerson()}_renderPerson(){return V`
  ...
  `]}};ie([St({attribute:!1})],hn.prototype,"hass",void 0),ie([zt()],hn.prototype,"_config",void 0),ie([Lt(".stage")],hn.prototype,"_stage",void 0),ie([Lt("canvas")],hn.prototype,"_canvas",void 0),hn=ie([yt(Si)],hn);var dn,un,mn=ht(()=>{ln="nvision-air-quality-card",cn="nvision-air-quality-card-editor"}),pn=/* @__PURE__ */dt({NvisionAirQualityCardEditor:()=>un}),gn=ht(()=>{kt(),Dt(),Bt(),ae(),he(),mn(),se(),dn=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"color_good",selector:{color_rgb:{}}},{name:"color_warning",selector:{color_rgb:{}}}]},{type:"grid",name:"",schema:[{name:"color_bad",selector:{color_rgb:{}}},{name:"color_mist",selector:{color_rgb:{}}}]},{type:"grid",name:"",schema:[{name:"color_clear",selector:{color_rgb:{}}},{name:"color_sky",selector:{color_rgb:{}}}]},oe()],un=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color_good"===t.name?"Good gauge color":"color_warning"===t.name?"Moderate gauge color":"color_bad"===t.name?"Poor gauge color":"color_mist"===t.name?"Mist color":"color_clear"===t.name?"Clear glow color":"color_sky"===t.name?"Sky glow color":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,...t}}render(){return this.hass&&this._config?W`
    ...
    `}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=wn(t?.state),i=e??this._targetValue,n=this._config.name||t?.attributes.friendly_name||"Air Quality",s=t?.attributes.unit_of_measurement??"",a=void 0!==e?String(Math.round(10*e)/10):"—",o=xn(this._config,this);return W`
      <ha-card
  ...
  `]}};ie([St({attribute:!1})],Sn.prototype,"hass",void 0),ie([zt()],Sn.prototype,"_config",void 0),ie([zt()],Sn.prototype,"_gaugeReady",void 0),ie([Lt("canvas")],Sn.prototype,"_canvas",void 0),ie([Lt(".stage")],Sn.prototype,"_stage",void 0),Sn=ie([yt(ln)],Sn);var An,zn,En=ht(()=>{Mn="nvision-circle-gauge-card",kn="nvision-circle-gauge-card-editor"}),Pn=/* @__PURE__ */dt({NvisionCircleGaugeCardEditor:()=>zn}),Tn=ht(()=>{kt(),Dt(),Bt(),ae(),he(),En(),se(),An=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{name:"color",selector:{color_rgb:{}}},{name:"track_color",selector:{color_rgb:{}}},{name:"reverse",selector:{boolean:{}}},oe("toggle")],zn=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color"===t.name?"Gauge color":"track_color"===t.name?"Track color":"reverse"===t.name?"Reverse":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,...t}}render(){return this.hass&&this._config?W`
    ...
    `}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity,e=t?this.hass.states[t]:void 0,{value:i,valueText:n,unit:s}=this._reading(),a=Me(this._config.color,this,"--primary-color","#03a9f4");const o=function(t,e){return Me(t,e,"--primary-background-color","#e0e0e0")}(this._config.track_color,this),r=this._config.name||e?.attributes.friendly_name||"Circle Gauge";return W`
      <ha-card>
        <div
          class="body"
          role="button"
  ...
  `]}};ie([St({attribute:!1})],Dn.prototype,"hass",void 0),ie([zt()],Dn.prototype,"_config",void 0),ie([zt()],Dn.prototype,"_gaugeReady",void 0),ie([zt()],Dn.prototype,"_tick",void 0),Dn=ie([yt(Mn)],Dn);var Hn,Un,Bn=ht(()=>{Nn="nvision-power-draw-card",jn="nvision-power-draw-card-editor"}),Gn=/* @__PURE__ */dt({NvisionPowerDrawCardEditor:()=>Un}),Wn=ht(()=>{kt(),Dt(),Bt(),ae(),he(),hi(),Bn(),se(),Hn=[{name:"entity",selector:{entity:{domain:"sensor"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:Re,selector:{number:{step:"any"}}}]},{type:"grid",name:"",schema:[{name:"effects_min",required:!0,default:0,selector:{number:{min:0,max:1,step:.05}}},{name:"effects_max",required:!0,default:1,selector:{number:{min:0,max:1,step:.05}}}]},{name:"color",selector:{color_rgb:{}}},{name:"icon",selector:{icon:{}}},oe()],Un=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum watts":"max"===t.name?"Maximum watts":"effects_min"===t.name?"Minimum effect":"effects_max"===t.name?"Maximum effect":"color"===t.name?"Lightning color":"icon"===t.name?"Source icon":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:Re,effects_min:0,effects_max:1,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:Y}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],Un.prototype,"_config",void 0),Un=ie([yt(jn)],Un)});kt(),Dt(),hi(),Bn(),se(),Ht({type:Nn,name:"Nvision Power Draw",description:"Power consumption with animated lightning from a plug"});var Vn,Kn,Yn=class extends _t{constructor(...t){super(...t),this._displayIntensity=0,this._actions=new Kt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(Wn(),Gn)),document.createElement(jn)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return"power"===i?.attributes.device_class||e.includes("power")||void 0!==Ze(i?.state)})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${Nn}`,entity:n,min:0,max:Re}}setConfig(t){this._config={min:0,max:Re,effects_min:0,effects_max:1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 1}getGridOptions(){return{columns:6,rows:1}}disconnectedCallback(){this._renderer?.detach(),super.disconnectedCallback()}firstUpdated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}updated(){this._syncLightningTheme(),requestAnimationFrame(()=>this._ensureRenderer())}_lightningColor(){return He(this._config?.color,this)}_overMaxColor(){return Ve(this)}_rawValue(){const t=this._config?.entity;return Ze(t?this.hass?.states[t]?.state:void 0)}_overMaxSeverity(){const t=this._rawValue();return void 0===t?0:We(t,this._config?.min??0,this._config?.max??3e3)}_syncLightningTheme(){const t=this._overMaxSeverity()>0?this._overMaxColor():this._lightningColor();this.style.setProperty("--lightning-color",t),this.style.setProperty("--lightning-glow",String(Ge(this._displayIntensity)))}_targetIntensity(){return Be(this._rawValue(),this._config??{})}_tickIntensity(t){const e=this._targetIntensity(),i=e-this._displayIntensity;return Math.abs(i)<.001?this._displayIntensity=e:this._displayIntensity+=i*qe*t,this._syncLightningTheme(),this._displayIntensity}_ensureRenderer(){const t=this._canvas;t&&(this._renderer||(this._renderer=new Ne(this,t=>this._buildArcs(t),()=>this._lightningColor(),t=>{this._tickIntensity(t)})),this._renderer.attach(t))}_buildArcs(t){const e=this._canvas;if(!e)return[];const i=ei(this._plug,e,"center"),n=ei(this._entityIcon,e,"center");if(!i||!n)return[];const s=this._overMaxSeverity(),a=s>0?this._overMaxColor():this._lightningColor(),o=[{from:i,to:n,intensity:this._displayIntensity,color:a}];if(s>0){const{width:i,height:r}=e.getBoundingClientRect();Xe(o,n,i,r,s,t,a)}return o}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||"Power Draw",i=Yt(t);return W`
  ...
  `}};function Ms(t){return String(t).padStart(2,"0")}function ks(t,e){const i=Object.fromEntries(function(t){let e=bs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),bs.set(t,e)),e}(e).formatToParts(new Date(t)).map(t=>[t.type,t.value])),n=ys.indexOf(String(i.weekday))>=0?ys.indexOf(String(i.weekday)):0,s=Number(i.year),a=Number(i.month),o=Number(i.day);return{year:s,month:a,day:o,hour:Number(i.hour)%24,weekday:n,dateKey:`${s}-${Ms(a)}-${Ms(o)}`,monthKey:`${s}-${Ms(a)}`}}function Cs(t,e,i){const n=ks(Ss(t,e,i),e);return`${n.year}-${Ms(n.month)}-${Ms(n.day)}`}function Ss(t,e,i){const n=ks(t,e),s=(n.weekday-i+7)%7;return As(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function As(t,e,i,n,s,a){const o=Date.UTC(t,e-1,i,n,s,0),r=Object.fromEntries(function(t){let e=xs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),xs.set(t,e)),e}(a).formatToParts(new Date(o)).map(t=>[t.type,t.value]));return o-(Date.UTC(Number(r.year),Number(r.month)-1,Number(r.day),Number(r.hour),Number(r.minute),0)-o)}function zs(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...ks(t,e),weekKey:Cs(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function Es(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>ys[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=ks(t.startMs,e);let s=As(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=ks(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=Ss(t.startMs,e,i);for(;s<=t.endMs;){const t=ks(s,e);n.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=ks(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${Ms(a)}`;if(i.push({key:n,label:`${s}-${Ms(a)}`}),a+=1,a>12&&(a=1,s+=1),As(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const o=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const r of o)a.set(r.key,`${new Date(r.start).toLocaleString()} – ${new Date(r.end).toLocaleString()}`);return{keys:o.map(t=>t.key),labels:o.map(t=>t.label),bucketRanges:a}}function Ps(t,e,i,n,s,a,o){return"time"===t?o.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function Ts(t){return _s[t&&vs[t]||(t&&t in _s?t:void 0)||"week_hourly"]}function Is(t,e,i,n,s){const a=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(fs[i]),o=(r=a.hours)<=24||r<=48||r<=336?36e5:864e5;var r;const l=Es(t,a,n,s,o),c=Es(e,a,n,s,o);return{window:a,bucketMs:o,xAxis:l,yAxis:c,xKeySet:new Set(l.keys),yKeySet:new Set(c.keys),bucketMap:/* @__PURE__ */new Map}}function Ls(t,e,i,n,s,a){if(e.time<t.window.startMs||e.time>t.window.endMs)return;const o=zs(i,e.time,s,t.bucketMs,a),r=zs(n,e.time,s,t.bucketMs,a);if(void 0===o||void 0===r)return;if(!t.xKeySet.has(o)||!t.yKeySet.has(r))return;const l=`${r}|${o}`,c=t.bucketMap.get(l)??[];c.push({time:e.time,value:e.value}),t.bucketMap.set(l,c)}function Os(t,e,i,n,s,a){const o=[],r=t.yAxis.keys.map((s,a)=>t.xAxis.keys.map((r,l)=>{const c=t.bucketMap.get(`${s}|${r}`)??[],h=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e.value,0);case"max":return Math.max(...t.map(t=>t.value));case"min":return Math.min(...t.map(t=>t.value));case"last":{let e=t[0];for(const i of t)i.time>=e.time&&(e=i);return e.value}default:return t.reduce((t,e)=>t+e.value,0)/t.length}}(c,n);return null!==h&&o.push(h),{value:h,count:c.length,rangeLabel:Ps(e,i,r,0,t.xAxis.labels[l],t.yAxis.labels[a],t.xAxis.bucketRanges)}}));let l=s,c=a;if(void 0===l||void 0===c){const t=o.length?Math.min(...o):0,e=o.length?Math.max(...o):1;l=l??t,c=c??(e===t?t+1:e)}return c<=l&&(c=l+1),{xLabels:t.xAxis.labels,yLabels:t.yAxis.labels,xKeys:t.xAxis.keys,yKeys:t.yAxis.keys,cells:r,min:l,max:c}}function Rs(t,e,i){return null===t?0:Math.min(1,Math.max(0,(t-e)/(i-e)))}ie([St({attribute:!1})],$s.prototype,"hass",void 0),ie([zt()],$s.prototype,"_config",void 0),$s=ie([yt(os)],$s);var qs=ht(()=>{fs={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},_s={week_hourly:{x:"hour",y:"day",period:"7d"},two_weeks:{x:"hour",y:"day",period:"14d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_days:{x:"weekday",y:"week",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},quarter:{x:"week",y:"month",period:"90d"},timeline_24h:{x:"time",y:"none",period:"24h"},timeline_48h:{x:"time",y:"none",period:"48h"},year_overview:{x:"week",y:"month",period:"365d"}},vs={timeline:"timeline_24h",custom:"week_hourly"},ys=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],bs=/* @__PURE__ */new Map,xs=/* @__PURE__ */new Map,ws=["day","week","month"]});function Fs(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function Ns(t){return Fs(t)}function js(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function Ds(t,e){const i=(...t)=>{for(const e of t){if(null==e)continue;const t=Number(e);if(Number.isFinite(t))return t}};switch(e){case"mean":default:return i(t.mean,t.state);case"sum":return i(t.sum,t.change,t.state);case"max":return i(t.max,t.state,t.sum);case"min":return i(t.min,t.state);case"last":return i(t.state,t.mean);case"count":return i(t.change)}}function Hs(t){if("string"==typeof t){const e=Date.parse(t);return Number.isFinite(e)?e:void 0}return t<1e11?1e3*t:t}var Us,Bs,Gs,Ws,Vs,Ks,Ys;async function Xs(t,e,i,n,s,a="mean"){const o=Ns(t),r=function(t){return"max"===t||"last"===t}(a);return function(t,e,i=!1){if(t.length<=e)return t;const n=Math.ceil(t.length/e),s=[];for(let a=0;a<t.length;a+=n){const e=t.slice(a,a+n);e.length&&(i?s.push(e.reduce((t,e)=>e.value>t.value||e.value===t.value&&e.time>t.time?e:t,e[0])):s.push(e[0]))}return s}(function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await o({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!r}),e),s),8e3,r)}async function Qs(t,e,i,n,s,a){const o=Ns(t),r="sum"===s?["sum","change","state"]:"max"===s?["max","state","sum"]:"min"===s?["min","state"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=Ds(n,e);if(null==t||!Number.isFinite(t))continue;const s=Hs(n.start);void 0!==s&&i.push({time:s,value:t})}return i}((await o({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:r}))[e]??[],s)}var Zs,Js,ta,ea=ht(()=>{qs(),Us="nvision-heat-map-card",Bs="nvision-heat-map-card-editor",Gs="week_hourly",Ws="theme",Vs=[{value:"week_hourly",label:"Week — hour × day"},{value:"two_weeks",label:"Two weeks — hour × day"},{value:"daily_rhythm",label:"Daily rhythm — hour × weekday"},{value:"month_days",label:"Month — weekday × week"},{value:"month_calendar",label:"Quarter calendar — weekday × week"},{value:"quarter",label:"Quarter — week × month"},{value:"timeline_24h",label:"Timeline — 24 hours"},{value:"timeline_48h",label:"Timeline — 48 hours"},{value:"year_overview",label:"Year — week × month"}],Ks=[{value:"theme",label:"Theme"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"},{value:"custom",label:"Custom"}],Ys=[{value:"auto",label:"Auto"},{value:"mean",label:"Mean"},{value:"sum",label:"Sum"},{value:"max",label:"Maximum"},{value:"min",label:"Minimum"},{value:"count",label:"Count"},{value:"last",label:"Last"}]}),ia=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>ta}),na=ht(()=>{kt(),Dt(),Bt(),ae(),he(),ea(),se(),Zs=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:Gs,selector:{select:{options:[...Vs],mode:"dropdown"}}},{name:"operation",default:"auto",selector:{select:{options:[...Ys],mode:"dropdown"}}},{name:"color_mode",required:!0,default:Ws,selector:{select:{options:[...Ks],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_cell_values",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}},{name:"dim_low_values",selector:{boolean:{}}}]},oe()],Js=[{type:"grid",name:"",schema:[{name:"color_low",selector:{color_rgb:{}}},{name:"color_high",selector:{color_rgb:{}}}]}],ta=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"View":"color_mode"===t.name?"Color mode":"operation"===t.name?"Operation":"color_low"===t.name?"Low color":"color_high"===t.name?"High color":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Scale":"show_cell_values"===t.name?"Values in cells":"dim_low_values"===t.name?"Dim low values":"show_current"===t.name?"Current value":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:Gs,color_mode:Ws,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,...t,color_mode:"primary"===t.color_mode?"theme":t.color_mode,operation:t.operation??"auto"}}_schema(){return"custom"===this._config?.color_mode?[...Zs,...Js]:Zs}render(){return this.hass&&this._config?W`
    ...
    `}_renderCell(t,e,i,n,s,a,o){const r=Rs(t.value,n.min,n.max),l=null!==t.value;return W`
      <div
            ...
            <div class="grid-wrap">
              ...
              >
                    ${t.cells.flatMap((a,o)=>{const h=o+1;return[n?W`
                          ...
                          `:Y,...a.map((n,a)=>{const o=Rs(n.value,t.min,t.max),d=null!==n.value;return W`
                          <div
    ...
    `}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=this._config.name||t?.attributes.friendly_name||this._config.entity||"Heat Map",i=!1!==this._config.show_current?Yt(t):"";return W`
      <ha-card>
        <div class="stage">
          <div
            class="header"
  ...
  `]}};ie([St({attribute:!1})],fa.prototype,"hass",void 0),ie([zt()],fa.prototype,"_config",void 0),ie([zt()],fa.prototype,"_grid",void 0),ie([zt()],fa.prototype,"_loading",void 0),ie([zt()],fa.prototype,"_error",void 0),ie([zt()],fa.prototype,"_popover",void 0),ie([zt()],fa.prototype,"_xLabelVisible",void 0),fa=ie([yt(Us)],fa);var _a=ht(()=>{ua="nvision-reactor-core-card",ma="nvision-reactor-core-card-editor",pa="auto",ga=["sensor","binary_sensor"]});hi(),_a();var va=[185,198,215,248,278,312,42];function ya(t,e){if(js(e))return"binary";const i=t.states[e]?.state;return void 0!==Ze(i)?"numeric":"other"}function ba(t,e){const i=t.states[e]?.state;return void 0!==i&&"unavailable"!==i&&"unknown"!==i&&("on"===i||"true"===i||"open"===i||"home"===i)}function xa(t,e,i,n){const s=Ze(t.states[e]?.state);return void 0===s?.35:Je(s,i,n)}function wa(t,e){return"binary"===t?0:"numeric"===t?Math.round(5+16*e):10}function $a(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:ga,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function Ma(t,e,i,n,s){const a=function(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}(e),o=ya(t,e),r=xa(t,e,i,n),l=t.states[e]?.state;return{entityId:e,kind:o,seed:a,x:0,y:0,angle:a*Math.PI*2,orbitRadius:s*(.12+.28*a),orbitSpeed:9e-4+.0016*a,epicycleRadius:s*(.018+.045*a),epicycleSpeed:.0014+.0022*a,trail:[],trailCapacity:wa(o,r),binaryOn:ba(t,e),flash:0,numericNorm:r,unavailable:"unavailable"===l||"unknown"===l}}function ka(t,e,i,n){const s=i.min??0,a=i.max??100,o=$a(e,i),r=new Map(t.map(t=>[t.entityId,t])),l=[];for(const c of o){const t=r.get(c);if(t){const i=ya(e,c),n=xa(e,c,s,a),o=ba(e,c);o!==t.binaryOn&&(t.flash=1),t.kind=i,t.numericNorm=n,t.binaryOn=o,t.trailCapacity=wa(i,n),t.unavailable="unavailable"===e.states[c]?.state||"unknown"===e.states[c]?.state,t.trail.length>t.trailCapacity&&(t.trail=t.trail.slice(-t.trailCapacity)),l.push(t);continue}l.push(Ma(e,c,s,a,n))}return l}function Ca(t,e,i){const n=(14e-6*e+.31*t.seed)%va.length,s=Math.floor(n),a=va[s]+(va[(s+1)%va.length]-va[s])*(n-s);let o=82,r=58;return"binary"===t.kind?(o=t.binaryOn?96:58,r=t.binaryOn?70:38):t.unavailable&&(o=18,r=42),`hsla(${a}, ${o}%, ${r}%, ${i})`}function Sa(t){t.trailCapacity<=0?t.trail=[]:(t.trail.push({x:t.x,y:t.y}),t.trail.length>t.trailCapacity&&t.trail.shift())}function Aa(t,e,i){const n=e.trail;if(!(n.length<2))for(let s=1;s<n.length;s+=1){const a=s/n.length;t.beginPath(),t.moveTo(n[s-1].x,n[s-1].y),t.lineTo(n[s].x,n[s].y),t.strokeStyle=Ca(e,i,.08+.42*a),t.lineWidth=1+2.2*a,t.stroke()}}function za(t,e,i,n,s,a){t.beginPath(),t.arc(e,i,n*(1+.8*a),0,2*Math.PI),t.fillStyle=s.replace(/[\d.]+\)$/,.12+.18*a+")"),t.fill(),t.beginPath(),t.arc(e,i,n,0,2*Math.PI),t.fillStyle=s,t.fill()}var Ea,Pa,Ta,Ia=/* @__PURE__ */dt({NvisionReactorCoreCardEditor:()=>Ta}),La=ht(()=>{kt(),Dt(),Bt(),ae(),he(),_a(),se(),Ea=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:pa,selector:{select:{options:[{value:"auto",label:"Auto-discover sensors"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},oe()],Pa=[{name:"entities",selector:{entity:{multiple:!0,domain:["sensor","binary_sensor"]}}}],Ta=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"min"===t.name?"Numeric trail min":"max"===t.name?"Numeric trail max":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:pa,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...Ea.slice(0,3),...Pa,...Ea.slice(3)]:Ea}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema()}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:Y}_valueChanged(t){Ut(this,"config-changed",{config:t.detail.value})}},ie([zt()],Ta.prototype,"_config",void 0),Ta=ie([yt(ma)],Ta)});kt(),Dt(),_a(),se(),Ht({type:ua,name:"Nvision Reactor Core",description:"Orbiting sensor particles with reactor-style glow trails"});var Oa=class extends _t{constructor(...t){super(...t),this._frameId=0,this._animating=!1,this._lastFrame=0,this._particles=[],this._entityKey="",this._actions=new Kt(()=>this,()=>this.hass,()=>this._config)}static async getConfigElement(){return await Promise.resolve().then(()=>(La(),Ia)),document.createElement(ma)}static getStubConfig(t,e,i){const n=[...e,...i,...Object.keys(t.states)],s=/* @__PURE__ */new Set,a=[];for(const o of n){if(s.has(o))continue;s.add(o);const t=o.split(".",1)[0];if("sensor"!==t&&"binary_sensor"!==t||a.push(o),a.length>=8)break}return{type:`custom:${ua}`,mode:pa,entities:a.length?a:void 0,max_particles:32,min:0,max:100}}setConfig(t){this._config={mode:pa,max_particles:32,min:0,max:100,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t}}getCardSize(){return 2}getGridOptions(){return{columns:6,rows:2}}connectedCallback(){super.connectedCallback(),this._ctx&&(this._lastFrame=0,this._startAnimation())}disconnectedCallback(){this._stopAnimation(),this._resizeObserver?.disconnect(),super.disconnectedCallback()}updated(t){(t.has("hass")||t.has("_config"))&&this.hass&&this._config&&this._syncParticles(),this._ensureCanvas()}_syncParticles(){if(!this.hass||!this._config)return;const t=this._canvas,e=t?Math.min(t.clientWidth,t.clientHeight):200,i=this._discoverIds().join("|"),n=[this._config.mode,this._config.max_particles,(this._config.domains??[]).join(","),(this._config.exclude??[]).join(","),this._config.min,this._config.max,(this._config.entities??[]).join(",")].join(";");i+n===this._entityKey&&this._particles.length||(this._entityKey=i+n),this._particles=ka(this._particles,this.hass,this._config,e)}_discoverIds(){if(!this.hass||!this._config)return[];if("manual"===(this._config.mode??"auto")&&this._config.entities?.length)return this._config.entities.filter(t=>Boolean(this.hass?.states[t]));const t=this._config.domains?.length?this._config.domains:["sensor","binary_sensor"],e=this._config.max_particles??32;return Object.keys(this.hass.states).filter(e=>t.includes(e.split(".",1)[0])).sort((t,e)=>t.localeCompare(e)).slice(0,e)}_ensureCanvas(){const t=this._canvas;t&&!this._ctx&&(this._ctx=t.getContext("2d")??void 0,this._ctx&&(this._resizeObserver=new ResizeObserver(()=>{this._resizeCanvas(),this._syncParticles()}),this._resizeObserver.observe(t.parentElement??this),this._resizeCanvas(),this._syncParticles(),this._lastFrame=0,this._startAnimation()))}_startAnimation(){if(this._animating)return;this._animating=!0;const t=e=>{if(!this.isConnected||!this._ctx)return void(this._animating=!1);const i=this._lastFrame?Math.min((e-this._lastFrame)/16.67,3):1;this._lastFrame=e,this._draw(i,e),this._frameId=requestAnimationFrame(t)};this._frameId=requestAnimationFrame(t)}_stopAnimation(){cancelAnimationFrame(this._frameId),this._animating=!1}_resizeCanvas(){const t=this._canvas;if(!t)return;const e=t.getBoundingClientRect(),i=window.devicePixelRatio||1;t.width=Math.max(1,Math.floor(e.width*i)),t.height=Math.max(1,Math.floor(e.height*i)),this._ctx?.setTransform(i,0,0,i,0,0)}_draw(t,e){const i=this._canvas,n=this._ctx;if(!(i&&n&&this.hass&&this._config))return;const s=i.clientWidth,a=i.clientHeight;if(s<=0||a<=0)return;this._particles.length||this._syncParticles();const o=window.matchMedia("(prefers-reduced-motion: reduce)").matches;!function(t,e,i,n,s,a){const o=e/2,r=i/2,l=Math.min(e,i),c=a?.12:1,h=.001*s;for(const d of t){d.angle+=d.orbitSpeed*n*c;const e=o+Math.cos(d.angle+6.28*d.seed)*d.orbitRadius,i=r+Math.sin(.83*d.angle+4.17*d.seed)*d.orbitRadius*.88;let s=e+Math.cos(h*d.epicycleSpeed+9.1*d.seed)*d.epicycleRadius,a=i+Math.sin(h*d.epicycleSpeed*1.27+5.3*d.seed)*d.epicycleRadius;for(const n of t){if(n===d)continue;const t=s-n.x,e=a-n.y,i=Math.hypot(t,e),o=.07*l;if(i>.5&&i<o){const n=(o-i)/o*l*.012*c;s+=t/i*n,a+=e/i*n}}const u=o-s,m=r-a,p=Math.hypot(u,m),g=.44*l;if(p>g){const t=.035*(p-g)*c;s+=u/p*t,a+=m/p*t}d.x=s,d.y=a,d.flash>0&&(d.flash=Math.max(0,d.flash-.0045*n)),Sa(d)}}(this._particles,s,a,t,e,o),function(t,e,i,n,s){const a=i/2,o=n/2,r=Math.min(i,n);t.clearRect(0,0,i,n);const l=t.createRadialGradient(a,o,0,a,o,.55*r);l.addColorStop(0,"hsla(200, 70%, 58%, 0.12)"),l.addColorStop(.45,"hsla(260, 55%, 42%, 0.06)"),l.addColorStop(1,"hsla(0, 0%, 0%, 0)"),t.fillStyle=l,t.fillRect(0,0,i,n);for(const c of e)Aa(t,c,s);for(const c of e){const e="binary"===c.kind?.028*r:"numeric"===c.kind?.014*r+c.numericNorm*r*.008:.016*r;let i=c.unavailable?.28:.72;if("binary"===c.kind){const t=c.binaryOn?.55+.35*Math.sin(.012*s+12*c.seed):.35;i=Math.min(1,t+.45*c.flash)}const n=Ca(c,s,i);za(t,c.x,c.y,e,n,i)}za(t,a,o,.022*r*(.55+.12*Math.sin(.0018*s)),`hsla(${va[Math.floor(14e-6*s%va.length)]}, 88%, 68%, 0.85)`,.9)}(n,this._particles,s,a,e)}render(){if(!this._config||!this.hass)return Y;const t=this._config.name||"Reactor Core",e=this._particles.length||this._discoverIds().length;return W`
      <ha-card>
        <div class="stage">
          <canvas aria-hidden="true"></canvas>
          <div
    ...
    `]}};ie([St({attribute:!1})],Oa.prototype,"hass",void 0),ie([zt()],Oa.prototype,"_config",void 0),ie([Lt("canvas")],Oa.prototype,"_canvas",void 0),Oa=ie([yt(ua)],Oa),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");