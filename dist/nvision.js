...
`,Kt=ht(()=>{Ht="nvision-blank-card",Gt="nvision-blank-card-editor"});function Xt(t,e,i,n){var s,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var o=t.length-1;o>=0;o--)(s=t[o])&&(r=(a<3?s(r):a>3?s(e,i,r):s(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r}var Qt=ht(()=>{});function Zt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}var Jt,te,ee,ie=ht(()=>{}),ne=ht(()=>{kt(),Qt(),Jt=class extends _t{},Xt([St({attribute:!1})],Jt.prototype,"hass",void 0)}),se=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ee}),ae=ht(()=>{kt(),Dt(),ie(),ne(),Kt(),Qt(),te=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}}],ee=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?V`
  ...
  `}};function ws(t){return String(t).padStart(2,"0")}function $s(t,e){const i=Object.fromEntries(function(t){let e=ys.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",hour12:!1,weekday:"short"}),ys.set(t,e)),e}(e).formatToParts(new Date(t)).map(t=>[t.type,t.value])),n=vs.indexOf(String(i.weekday))>=0?vs.indexOf(String(i.weekday)):0,s=Number(i.year),a=Number(i.month),r=Number(i.day);return{year:s,month:a,day:r,hour:Number(i.hour)%24,weekday:n,dateKey:`${s}-${ws(a)}-${ws(r)}`,monthKey:`${s}-${ws(a)}`}}function Ms(t,e,i){const n=$s(ks(t,e,i),e);return`${n.year}-${ws(n.month)}-${ws(n.day)}`}function ks(t,e,i){const n=$s(t,e),s=(n.weekday-i+7)%7;return Cs(n.year,n.month,n.day,0,0,e)-24*s*60*60*1e3}function Cs(t,e,i,n,s,a){const r=Date.UTC(t,e-1,i,n,s,0),o=Object.fromEntries(function(t){let e=bs.get(t);return e||(e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}),bs.set(t,e)),e}(a).formatToParts(new Date(r)).map(t=>[t.type,t.value]));return r-(Date.UTC(Number(o.year),Number(o.month)-1,Number(o.day),Number(o.hour),Number(o.minute),0)-r)}function Ss(t,e,i,n,s){if("none"===t)return"";const a=function(t,e,i=0){return{...$s(t,e),weekKey:Ms(t,e,i)}}(e,i,s);switch(t){case"hour":return String(a.hour);case"weekday":return String(a.weekday);case"day":return a.dateKey;case"week":return a.weekKey;case"month":return a.monthKey;case"time":return String(Math.floor(e/n)*n);default:return}}function As(t,e,i,n,s){const a=/* @__PURE__ */new Map;if("none"===t)return{keys:[""],labels:[""],bucketRanges:a};if("hour"===t)return{keys:Array.from({length:24},(t,e)=>String(e)),labels:Array.from({length:24},(t,e)=>function(t){return new Date(Date.UTC(2024,0,1,t,0,0)).toLocaleTimeString([],{hour:"numeric"})}(e)),bucketRanges:a};if("weekday"===t){const t=Array.from({length:7},(t,e)=>(n+e)%7);return{keys:t.map(String),labels:t.map(t=>vs[t]),bucketRanges:a}}if("day"===t){const t=function(t,e){const i=[],n=$s(t.startMs,e);let s=Cs(n.year,n.month,n.day,0,0,e);for(;s<=t.endMs;){const t=$s(s,e);i.push({key:t.dateKey,label:`${t.month}/${t.day}`}),s+=864e5}return i.slice(-Math.ceil(t.hours/24))}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("week"===t){const t=function(t,e,i){const n=[];let s=ks(t.startMs,e,i);for(;s<=t.endMs;){const t=$s(s,e);n.push({key:t.weekKey,label:`${t.month}/${t.day}`}),s+=6048e5}return n}(e,i,n);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}if("month"===t){const t=function(t,e){const i=[],n=$s(t.startMs,e);let s=n.year,a=n.month;for(;;){const n=`${s}-${ws(a)}`;if(i.push({key:n,label:`${s}-${ws(a)}`}),a+=1,a>12&&(a=1,s+=1),Cs(s,a,1,0,0,e)>t.endMs)break}return i}(e,i);return{keys:t.map(t=>t.key),labels:t.map(t=>t.label),bucketRanges:a}}const r=function(t,e){const i=[];let n=Math.floor(t.startMs/e)*e;for(;n<t.endMs;){const t=n+e,s=new Date(n);i.push({key:String(n),start:n,end:t,label:s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}),n=t}return i}(e,s);for(const o of r)a.set(o.key,`${new Date(o.start).toLocaleString()} – ${new Date(o.end).toLocaleString()}`);return{keys:r.map(t=>t.key),labels:r.map(t=>t.label),bucketRanges:a}}function zs(t,e,i,n,s,a,r){return"time"===t?r.get(i)??s:"none"===e?s:"hour"===t&&"day"===e||"hour"===t&&"weekday"===e||"weekday"===t&&"week"===e?`${a} ${s}`:`${a} · ${s}`}function Es(t){return fs[t&&_s[t]||(t&&t in fs?t:void 0)||"week_hourly"]}function Ps(t,e,i,n,s,a,r=0,o,l){const c=function(t,e=Date.now()){return{hours:t,endMs:e,startMs:e-60*t*60*1e3}}(ps[n]),h=(d=c.hours)<=24||d<=48||d<=336?36e5:864e5;var d;const u=As(e,c,a,r,h),m=As(i,c,a,r,h),g=new Set(u.keys),p=new Set(m.keys),f=/* @__PURE__ */new Map;for(const x of t){if(x.time<c.startMs||x.time>c.endMs)continue;const t=Ss(e,x.time,a,h,r),n=Ss(i,x.time,a,h,r);if(void 0===t||void 0===n)continue;if(!g.has(t)||!p.has(n))continue;const s=`${n}|${t}`,o=f.get(s)??[];o.push(x.value),f.set(s,o)}const _=[],v=m.keys.map((t,n)=>u.keys.map((a,r)=>{const o=f.get(`${t}|${a}`)??[],l=function(t,e){if(!t.length)return null;switch(e){case"sum":case"count":return t.reduce((t,e)=>t+e,0);case"max":return Math.max(...t);case"min":return Math.min(...t);case"last":return t[t.length-1];default:return t.reduce((t,e)=>t+e,0)/t.length}}(o,s);return null!==l&&_.push(l),{value:l,count:o.length,rangeLabel:zs(e,i,a,0,u.labels[r],m.labels[n],u.bucketRanges)}}));let y=o,b=l;if(void 0===y||void 0===b){const t=_.length?Math.min(..._):0,e=_.length?Math.max(..._):1;y=y??t,b=b??(e===t?t+1:e)}return b<=y&&(b=y+1),{xLabels:u.labels,yLabels:m.labels,xKeys:u.keys,yKeys:m.keys,cells:v,min:y,max:b}}function Ts(t,e,i){return null===t?0:Math.min(1,Math.max(0,(t-e)/(i-e)))}Xt([St({attribute:!1})],xs.prototype,"hass",void 0),Xt([zt()],xs.prototype,"_config",void 0),xs=Xt([yt(as)],xs);var Ls=ht(()=>{ps={"24h":24,"48h":48,"7d":168,"14d":336,"30d":720,"90d":2160,"365d":8760},fs={week_hourly:{x:"hour",y:"day",period:"7d"},two_weeks:{x:"hour",y:"day",period:"14d"},daily_rhythm:{x:"hour",y:"weekday",period:"30d"},month_days:{x:"day",y:"week",period:"30d"},month_calendar:{x:"weekday",y:"week",period:"90d"},quarter:{x:"week",y:"month",period:"90d"},timeline_24h:{x:"time",y:"none",period:"24h"},timeline_48h:{x:"time",y:"none",period:"48h"},year_overview:{x:"week",y:"month",period:"365d"}},_s={timeline:"timeline_24h",custom:"week_hourly"},vs=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],ys=/* @__PURE__ */new Map,bs=/* @__PURE__ */new Map});function Is(t){if(t.callWS)return t.callWS.bind(t);const e=t.connection;if(e?.sendMessagePromise)return e.sendMessagePromise.bind(e);throw new Error("WebSocket API unavailable")}function Os(t){return Is(t)}function Rs(t){if(!t)return!1;const e=t.split(".",1)[0];return"binary_sensor"===e||"input_boolean"===e}function qs(t){return Rs(t)?"count":"mean"}function Fs(t,e){switch(e){case"mean":default:return t.mean??t.state??void 0;case"sum":return t.sum??t.change??void 0;case"max":return t.max??void 0;case"min":return t.min??void 0;case"last":return t.state??t.mean??void 0;case"count":return t.change??void 0}}function Ns(t){return t<1e11?1e3*t:t}var js,Ds,Us,Bs,Hs,Gs;async function Vs(t,e,i,n,s){return function(t,e){if(t.length<=e)return t;const i=Math.ceil(t.length/e),n=[];for(let s=0;s<t.length;s+=i)n.push(t[s]);return n}(function(t,e){const i=[];let n=!1;for(const s of t){const t=1e3*(s.lu??s.lc??0);if(e){const e="on"===s.s;e&&!n&&i.push({time:t,value:1}),n=e;continue}const a=Number(s.s);Number.isFinite(a)&&i.push({time:t,value:a})}return i}(function(t,e){return Array.isArray(t)?t[0]??[]:t[e]??[]}(await Os(t)({type:"history/history_during_period",start_time:i.toISOString(),end_time:n.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!0}),e),s),8e3)}async function Ws(t,e,i,n,s,a){const r=Os(t),o="sum"===s?["sum","change"]:"max"===s?["max"]:"min"===s?["min"]:["mean","state"];return function(t,e){const i=[];for(const n of t){const t=Fs(n,e);null!=t&&Number.isFinite(t)&&i.push({time:Ns(n.start),value:t})}return i}((await r({type:"recorder/statistics_during_period",start_time:i.toISOString(),end_time:n.toISOString(),statistic_ids:[e],period:a,types:o}))[e]??[],s)}var Ys,Ks,Xs,Qs=ht(()=>{Ls(),js="nvision-heat-map-card",Ds="nvision-heat-map-card-editor",Us="week_hourly",Bs="theme",Hs=[{value:"week_hourly",label:"Week — hour × day"},{value:"two_weeks",label:"Two weeks — hour × day"},{value:"daily_rhythm",label:"Daily rhythm — hour × weekday"},{value:"month_days",label:"Month — day × week"},{value:"month_calendar",label:"Quarter calendar — weekday × week"},{value:"quarter",label:"Quarter — week × month"},{value:"timeline_24h",label:"Timeline — 24 hours"},{value:"timeline_48h",label:"Timeline — 48 hours"},{value:"year_overview",label:"Year — week × month"}],Gs=[{value:"theme",label:"Theme"},{value:"semantic",label:"Semantic"},{value:"temperature",label:"Temperature"},{value:"custom",label:"Custom"}]}),Zs=/* @__PURE__ */dt({NvisionHeatMapCardEditor:()=>Xs}),Js=ht(()=>{kt(),Dt(),ie(),ne(),Qs(),Qt(),Ys=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"preset",required:!0,default:Us,selector:{select:{options:[...Hs],mode:"dropdown"}}},{name:"color_mode",required:!0,default:Bs,selector:{select:{options:[...Gs],mode:"dropdown"}}},{type:"grid",name:"",schema:[{name:"show_axis_labels",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_cell_values",selector:{boolean:{}}},{name:"show_current",selector:{boolean:{}}},{name:"dim_low_values",selector:{boolean:{}}}]}],Ks=[{type:"grid",name:"",schema:[{name:"color_low",selector:{color_rgb:{}}},{name:"color_high",selector:{color_rgb:{}}}]}],Xs=class extends Jt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"preset"===t.name?"View":"color_mode"===t.name?"Color mode":"color_low"===t.name?"Low color":"color_high"===t.name?"High color":"show_axis_labels"===t.name?"Axis labels":"show_legend"===t.name?"Scale":"show_cell_values"===t.name?"Values in cells":"dim_low_values"===t.name?"Dim low values":"show_current"===t.name?"Current value":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={preset:Us,color_mode:Bs,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,...t,color_mode:"primary"===t.color_mode?"theme":t.color_mode}}_schema(){return"custom"===this._config?.color_mode?[...Ys,...Ks]:Ys}render(){return this.hass&&this._config?V`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:K}_valueChanged(t){const e=t.detail.value;Zt(this,"config-changed",{config:{...e,color_mode:"primary"===e.color_mode?"theme":e.color_mode}})}},Xt([zt()],Xs.prototype,"_config",void 0),Xs=Xt([yt(Ds)],Xs)});function ta(t){return t&&"primary"!==t?t:"theme"}kt(),Dt(),Ls(),Qs(),Qt(),Ut({type:js,name:"Nvision Heat Map",description:"Temporal heat map for sensor history and patterns"});function ea(t,e,i,n,s){if(!s)return"rgba(0, 0, 0, 0.05)";const a=function(t,e,i,n){const s=ta(i);return"semantic"===s?we(t,e):"temperature"===s?$e(t,e):"custom"===s?ke(t,e,n.color_low,n.color_high):Me(t,e)}(t,e,i,n);return n.dim_low_values?`color-mix(in srgb, ${a} ${85*Math.max(e,.08)}%, var(--card-background-color))`:`color-mix(in srgb, ${a} ${Math.max(100*e,8)}%, var(--card-background-color))`}function ia(t,e,i,n=!1){if(null===t)return"—";const s="count"===e?String(Math.round(t)):Number.isInteger(t)?String(t):n?t.toFixed(0):t.toFixed(1);return i&&"count"!==e?n?s:`${s} ${i}`:s}function na(t,e,i){return ia(t,e,i,!0)}var sa=null;function aa(t,e){return sa??=document.createElement("canvas").getContext("2d"),sa?(sa.font=e,sa.measureText(t).width):6*t.length}var ra=class extends _t{constructor(...t){super(...t),this._loading=!1,this._fetchVersion=0,this._measureFrame=0}static async getConfigElement(){return await Promise.resolve().then(()=>(Js(),Zs)),document.createElement(Ds)}static getStubConfig(t,e,i){const n=e.find(e=>{const i=t.states[e];return e.startsWith("sensor.")||e.startsWith("binary_sensor.")||Number.isFinite(Number(i?.state))})||e[0]||i[0]||Object.keys(t.states)[0];return{type:`custom:${js}`,entity:n,preset:Us,color_mode:Bs,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1}}_computeLoadKey(){const t=this._config;if(!t?.entity)return"";const e=Es(t.preset);return JSON.stringify({entity:t.entity,preset:t.preset,aggregate:qs(t.entity),axes:e})}setConfig(t){this._config={preset:Us,color_mode:Bs,show_axis_labels:!0,show_legend:!0,show_current:!0,show_cell_values:!1,dim_low_values:!1,tap_action:{action:"more-info"},hold_action:{action:"more-info"},...t,color_mode:ta(t.color_mode)},this._loadKey=void 0}getCardSize(){const t=this._grid?.yLabels.length??4;return Math.max(3,Math.min(8,Math.ceil(.75*t)+2))}getGridOptions(){const t=this._grid?.yLabels.length??4;return{columns:6,rows:Math.max(3,Math.min(8,Math.ceil(.75*t)+2)),min_rows:3}}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(()=>this._scheduleXLabelMeasure())}disconnectedCallback(){this._resizeObserver?.disconnect(),cancelAnimationFrame(this._measureFrame),super.disconnectedCallback()}updated(t){if(t.has("_config")||t.has("hass")){const t=this._computeLoadKey();t&&this.hass&&t!==this._loadKey&&(this._loadKey=t,this._loadData())}t.has("_grid")&&(this._xLabelVisible=void 0),this._grid&&!1!==this._config?.show_axis_labels&&this._scheduleXLabelMeasure()}_scheduleXLabelMeasure(){cancelAnimationFrame(this._measureFrame),this._measureFrame=requestAnimationFrame(()=>this._updateXLabelVisibility())}_observeGridWrap(t){this._resizeObserver&&t!==this._observedWrap&&(this._observedWrap&&this._resizeObserver.unobserve(this._observedWrap),this._observedWrap=t,this._resizeObserver.observe(t))}_updateXLabelVisibility(){const t=this._grid,e=this.shadowRoot;if(!t||!e||!1===this._config?.show_axis_labels)return;const i=e.querySelector(".grid-wrap"),n=e.querySelector(".data-grid .cell")??e.querySelector(".timeline-grid .cell");if(!i||!n)return;this._observeGridWrap(i);const s=e.querySelectorAll(".data-grid .cell, .timeline-grid .cell");let a=n.getBoundingClientRect().width;if(s.length>1){const t=s[0].getBoundingClientRect();a=s[1].getBoundingClientRect().left-t.left}const r=e.querySelector(".axis.x"),o=r?getComputedStyle(r).font:"500 10px Roboto, sans-serif",l=function(t,e,i,n=6){if(e<=0||!t.length)return t.map(()=>!0);const s=t.map(()=>!1);let a=-1/0;for(let r=0;r<t.length;r++){const o=t[r];if(!o)continue;const l=aa(o,i),c=(r+.5)*e;c-l/2>=a+n&&(s[r]=!0,a=c+l/2)}return s}(t.xLabels,a,o);(function(t,e){return!(!t||!e||t.length!==e.length)&&t.every((t,i)=>t===e[i])})(l,this._xLabelVisible)||(this._xLabelVisible=l)}async _loadData(){const t=this._config,e=this.hass,i=t?.entity;if(!t||!e||!i)return this._grid=void 0,void(this._error=void 0);try{Is(e)}catch{return this._error="History unavailable",void(this._grid=void 0)}const n=++this._fetchVersion;this._loading=!0,this._error=void 0;try{const s=Es(t.preset),a=qs(i),r=await async function(t,e,i,n){const s=/* @__PURE__ */new Date,a=/* @__PURE__ */new Date(s.getTime()-60*i*60*1e3);if(Rs(e)||"count"===n)return Vs(t,e,a,s,!0);if(i>=24)try{const r=await Ws(t,e,a,s,n,i>336?"day":"hour");if(r.length>0)return r}catch{}return Vs(t,e,a,s,!1)}(e,i,ps[s.period],a);if(n!==this._fetchVersion)return;if(await new Promise(t=>{"function"!=typeof requestIdleCallback?setTimeout(t,0):requestIdleCallback(()=>t(),{timeout:120})}),n!==this._fetchVersion)return;this._grid=Ps(r,s.x,s.y,s.period,a,e.config.time_zone||"UTC",1)}catch(s){if(n!==this._fetchVersion)return;this._error=function(t,e="Could not load history"){return t instanceof Error||"object"==typeof t&&null!==t&&"message"in t&&"string"==typeof t.message?t.message:e}(s),this._grid=void 0}finally{n===this._fetchVersion&&(this._loading=!1)}}_handleHeaderClick(t){t.stopPropagation(),this.hass&&this._config&&ss(this,this.hass,this._config,"tap")}_showPopover(t,e){const i=t.currentTarget,n=i.closest(".grid-wrap");if(!n)return;const s=i.getBoundingClientRect(),a=n.getBoundingClientRect(),r=this._config,o=r.entity?this.hass?.states[r.entity]:void 0,l=String(o?.attributes.unit_of_measurement??""),c=qs(r.entity);this._popover={anchorX:s.left-a.left+s.width/2,anchorY:s.top-a.top,label:e.rangeLabel,value:ia(e.value,c,"count"===c?"":l),count:e.count}}_hidePopover(){this._popover=void 0}_renderLegend(t){const e=this._config,i=ta(e.color_mode),n=e.entity?this.hass?.states[e.entity]:void 0,s=String(n?.attributes.unit_of_measurement??""),a=qs(e.entity),r=Ce(this,i,e.color_low,e.color_high),o=(t.min+t.max)/2;return V`
      <div class="legend-wrap" aria-hidden="true">
        <div class="legend-labels">
          <span>${na(t.max,a,s)}</span>
          <span>${na(o,a,s)}</span>
          <span>${na(t.min,a,s)}</span>
        </div>
        <div
          class="legend-bar"
    ...
    `}_renderCell(t,e,i,n,s,a,r){const o=Ts(t.value,n.min,n.max),l=null!==t.value;return V`
      <div
        class=${Zn({cell:!0,empty:!l,"has-value":l})}
        tabindex=${l?0:K}
        style=${ge({background:ea(this,o,e,i,l)})}
    ...
    `:K}_renderGrid(t){const e=this._config,i=ta(e.color_mode),n=!1!==e.show_axis_labels,s=!0===e.show_cell_values,a=!1!==e.show_legend,r=e.entity?this.hass?.states[e.entity]:void 0,o=String(r?.attributes.unit_of_measurement??""),l=qs(e.entity),c=n?2:1,h=this._xLabelVisible??t.xLabels.map(()=>!0);if(function(t){return 1===t.yKeys.length&&""===t.yKeys[0]}(t))return this._renderTimelineGrid(t,e,i,n,s,a,l,o,h);const d=n?`auto repeat(${t.xLabels.length}, minmax(0, 1fr))`:`repeat(${t.xLabels.length}, minmax(0, 1fr))`;return V`
      <div class="heatmap-body">
        <div class="grid-column">
          <div class="cells-legend-row">
                ...
                <div class="grid-wrap">
                  ...
                  >
                    ${t.cells.flatMap((a,r)=>{const h=r+1;return[n?V`
                          ...
                          `:K,...a.map((n,a)=>{const r=Ts(n.value,t.min,t.max),d=null!==n.value;return V`
                          <div
                            class=${Zn({cell:!0,empty:!d,"has-value":d})}
                            tabindex=${d?0:K}
                            style=${ge({gridColumn:String(a+c),gridRow:String(h),background:ea(this,r,i,e,d)})}
  ...
  `]}};Xt([St({attribute:!1})],ra.prototype,"hass",void 0),Xt([zt()],ra.prototype,"_config",void 0),Xt([zt()],ra.prototype,"_grid",void 0),Xt([zt()],ra.prototype,"_loading",void 0),Xt([zt()],ra.prototype,"_error",void 0),Xt([zt()],ra.prototype,"_popover",void 0),Xt([zt()],ra.prototype,"_xLabelVisible",void 0),ra=Xt([yt(js)],ra),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");