...
`,Qt=ht(()=>{Dt="nvision-blank-card",Gt="nvision-blank-card-editor"});function Xt(t,e,i,n){var s,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var o=t.length-1;o>=0;o--)(s=t[o])&&(r=(a<3?s(r):a>3?s(e,i,r):s(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r}var Zt=ht(()=>{});function Jt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}var Kt,te,ee,ie=ht(()=>{}),ne=ht(()=>{At(),Zt(),Kt=class extends _t{},Xt([kt({attribute:!1})],Kt.prototype,"hass",void 0)}),se=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ee}),ae=ht(()=>{At(),Ut(),ie(),ne(),Qt(),Zt(),te=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}}],ee=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?W`
  ...
  `]}};Xt([kt({attribute:!1})],Pi.prototype,"hass",void 0),Xt([zt()],Pi.prototype,"_config",void 0),Xt([Ot("canvas")],Pi.prototype,"_canvas",void 0),Pi=Xt([yt(Xe)],Pi);var Ii=ht(()=>{vi="nvision-waveform-card",yi="nvision-waveform-card-editor",bi=.72,xi=.78,wi=.45,$i="line",Mi="balanced",Ai="surge",Ci={wave:"surge",echo:"spawn",pulse:"surge",stream:"jet",spectrum:"surge",cascade:"spawn"},ki={line:"line",circle:"ring",grid:"field"},Si=[{value:"line",label:"Line"},{value:"ring",label:"Ring"},{value:"field",label:"Field"}],zi=[{value:"compact",label:"Compact"},{value:"balanced",label:"Balanced"},{value:"expansive",label:"Expansive"}],Ei=[{value:"surge",label:"Surge"},{value:"spawn",label:"Spawn"},{value:"jet",label:"Jet stream"}]});function Ti(t){return t-Math.floor(t)}Ii();var Oi={compact:{dotScale:.88,span:.94,phaseSpeed:.92},balanced:{dotScale:1,span:.98,phaseSpeed:1},expansive:{dotScale:1.08,span:1,phaseSpeed:1.08}},Li={line:{compact:16,balanced:24,expansive:32},ring:{compact:18,balanced:24,expansive:32},field:{compact:16,balanced:25,expansive:36}};function qi(t){return t*t*(3-2*t)}function Ri(t,e){const i=Math.max(.08,t),n=qi(i);return e*(.28+.16*(1-n)+.22*n+.26*Math.max(0,i-.5)**2)}function Fi(t){if("ring"===t.layout){const e=t.width/2,i=t.height/2,n=Math.atan2(t.baseY-i,t.baseX-e);return{primary:{x:-Math.sin(n),y:Math.cos(n)},perp:{x:Math.cos(n),y:Math.sin(n)}}}return{primary:{x:0,y:1},perp:{x:1,y:0}}}function Ni(t,e){const{x:i,y:n}=function(t,e,i){const{dot:n,index:s,phase:a,intensity:r,variant:o,height:l}=t;if(r<=.38)return{x:e,y:i};const c=Fi(t),h=(a+1.4*o)*(1+.18*r),d=s+.47*o,u=r*r;let g=Math.sin(h*(3.1+2.4*n.seed)+.85*d)*l*u*.12;if(r>.45){const t=(r-.45)**2;g+=Math.cos(7.4*h+1.7*d+n.phase+o)*l*t*.18,g+=Math.sin(8.2*h+2.1*d)*l*t*.1}return{x:e+c.perp.x*g,y:i+c.perp.y*g}}(t,e.x,e.y);return{...e,x:i,y:n}}function ji(t){const e=function(t){return t.layout?t.layout:t.shape?ki[t.shape]??"line":$i}(t),i=function(t){if(t.size)return t.size;const e=t.dot_count;if(void 0!==e){if(e<=18)return"compact";if(e>=30)return"expansive"}return Mi}(t),n=function(t){return t.motion?Ci[t.motion]??t.motion:t.overlap_dots?"spawn":Ai}(t),s=Oi[i];return{layout:e,size:i,motion:n,dotCount:Li[e][i],dotScale:s.dotScale,span:s.span,phaseSpeed:s.phaseSpeed}}function Ui(t){return Array.from({length:t},(e,i)=>({phase:i/t*Math.PI*2,seed:.618033988749895*i%1}))}function Bi(t){return.5*t}var Hi={spawn:function(t){const{dot:e,phase:i,intensity:n,height:s,width:a,baseX:r,baseY:o,layout:l}=t,c=qi(n),h=3.2-1.1*c,d=Ti(i*(.55+.85*c)*.14+e.seed*h),u=Math.sin(d*Math.PI),g=Ri(n,s)*d*1.15;if("ring"===l){const i=a/2,n=s/2,l=Math.atan2(o-n,r-i),h={x:-Math.sin(l),y:Math.cos(l)},d={x:Math.cos(l),y:Math.sin(l)},m=g*(.35+.4*e.seed);return Ni(t,{x:r+h.x*m+d.x*m*.15,y:o+h.y*m+d.y*m*.15,radiusMul:.7+u*c*.45,alphaMul:u*(.35+.55*c)})}const m=Fi(t),p=g*(.4+.35*e.seed);return Ni(t,{x:r+m.primary.x*p*.2+m.perp.x*p*.08,y:o+m.primary.y*p,radiusMul:.68+u*c*.42,alphaMul:u*(.32+.58*c)})},jet:function(t){const{dot:e,index:i,count:n,phase:s,intensity:a,height:r,width:o,baseY:l,layout:c}=t,h=qi(a),d=.28+.55*h,u=Math.sin(1.4*s+6.28*e.seed)*r*.04*h;if("ring"===c){const a=o/2,l=r/2,c=i/n*Math.PI*2-Math.PI/2+.35*e.seed+s*d*.22*(1+.6*h),u=.06*Math.min(o,r),g=Math.min(o,r)/2-u;return Ni(t,{x:a+Math.cos(c)*g,y:l+Math.sin(c)*g,radiusMul:.82+.22*h,alphaMul:.55+.38*h})}const g=.08*o,m=l+u;return Ni(t,{x:Ti(s*d*.16+e.seed+.07*i)*(o+2*g)-g,y:m,radiusMul:.78+.28*h,alphaMul:.5+.42*h})},surge:function(t){const{index:e,count:i,phase:n,intensity:s,height:a,baseX:r,baseY:o,layout:l}=t,c=qi(s),h=Ri(s,a),d=function(t){return.42+.68*qi(Math.max(.08,t))}(s),u=e%2==0,g=n*d-e/Math.max(1,i-1)*Math.PI*1.6,m=.5*Math.sin(g)+.5,p=h*(.25+m*(.55+.65*c)),f=.06*a;if("ring"===l){const n=t.width/2,s=t.height/2,a=e/i*Math.PI*2-Math.PI/2,l=u?-1:1,h=Math.hypot(r-n,o-s)+l*p*.85;return Ni(t,{x:n+Math.cos(a)*h,y:s+Math.sin(a)*h,radiusMul:.74+m*c*.38,alphaMul:.48+m*c*.46})}return Ni(t,{x:r,y:u?f+p:a-f-p,radiusMul:.72+m*c*.36,alphaMul:.46+m*c*.48})}};function Di(t,e,i,n,s,a,r,o,l){const c=Math.min(r,o),h=function(t,e,i,n,s,a){const r=Math.min(n,s),o=.04*r;switch(t){case"ring":{const t=n/2,o=s/2,l=.06*r,c=(Math.min(n,s)/2-l)*(.92+.06*a),h=(e+.5)/i*Math.PI*2-Math.PI/2;return{x:t+Math.cos(h)*c,y:o+Math.sin(h)*c}}case"field":{const t=Math.ceil(Math.sqrt(i)),o=Math.ceil(i/t),l=.04*r,c=.04*r,h=.028*r*a,d=(n-2*l-h*(t-1))/t,u=(s-2*c-h*(o-1))/o;return{x:l+e%t*(d+h)+d/2,y:c+Math.floor(e/t)*(u+h)+u/2}}default:{const t=n-o,r=(t-o)*a;return{x:(o+t-r)/2+(i<=1?.5:e/(i-1))*r,y:Bi(s)}}}}(t.layout,i,n,r,o,t.span),d={dot:e,index:i,count:n,phase:s,intensity:a,scale:c,baseX:h.x,baseY:h.y,width:r,height:o,variant:l,layout:t.layout};return Hi[t.motion](d)}function Gi(t,e,i,n){const s=.04*i,a=.58*i;let r=1;t<a&&(r=t<=s?.06:.06+.94*qi((t-s)/(a-s)));const o=.5*n,l=.42*n,c=Math.abs(e-o);let h=1;return t<a&&c<l&&(h=.08+.92*qi(c/l)),r*h}function Wi(t,e,i,n,s,a){if("ring"===a)return 1;const r=Math.max(4,.06*s),o=Math.max(3,.04*s),l=Math.min(1,Math.max(0,t/r)),c=Math.min(1,Math.max(0,(i-t)/r)),h=Math.min(1,Math.max(0,e/o)),d=Math.min(1,Math.max(0,(n-e)/o));return"line"===a?Math.min(l,c):Math.min(l,c,h,d)}var Vi,Yi,Qi=/* @__PURE__ */dt({NvisionWaveformCardEditor:()=>Yi}),Xi=ht(()=>{At(),Ut(),ie(),ne(),Ii(),Zt(),Vi=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},{name:"color",selector:{color_rgb:{}}},{type:"grid",name:"",schema:[{name:"layout",required:!0,default:$i,selector:{select:{options:[...Si],mode:"dropdown"}}},{name:"size",required:!0,default:Mi,selector:{select:{options:[...zi],mode:"dropdown"}}}]},{name:"motion",required:!0,default:Ai,selector:{select:{options:[...Ei],mode:"dropdown"}}},{name:"shake_speed",required:!0,default:wi,selector:{number:{min:.15,max:1.5,step:.05}}}],Yi=class extends Kt{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"entity"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"):"min"===t.name?"Minimum value":"max"===t.name?"Maximum value":"color"===t.name?"Waveform color":"layout"===t.name?"Layout":"size"===t.name?"Size":"motion"===t.name?"Motion":"shake_speed"===t.name?"Shake speed":this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={min:0,max:100,layout:$i,size:Mi,motion:Ai,shake_speed:wi,...t}}render(){return this.hass&&this._config?W`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Vi}
