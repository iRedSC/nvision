...
`,ee=ht(()=>{Xt="nvision-blank-card",Qt="nvision-blank-card-editor"});function ie(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o}var ne,se=ht(()=>{}),ae=ht(()=>{kt(),se(),ne=class extends _t{},ie([St({attribute:!1})],ne.prototype,"hass",void 0)});function oe(t="more-info"){return{name:"interactions",type:"expandable",flatten:!0,schema:[{name:"tap_action",selector:{ui_action:{default_action:t}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"",type:"optional_actions",flatten:!0,schema:[{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}}function re(t,e){return"interactions"===e.name?"Interactions":"hold_action"===e.name||"double_tap_action"===e.name?`${t.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)} (${t.localize("ui.panel.lovelace.editor.card.config.optional")})`:void 0}var le,ce,he=ht(()=>{}),de=/* @__PURE__ */dt({NvisionBlankCardEditor:()=>ce}),ue=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ee(),se(),le=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},oe()],ce=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
  ...
  `]}};ie([St({attribute:!1})],va.prototype,"hass",void 0),ie([zt()],va.prototype,"_config",void 0),ie([zt()],va.prototype,"_grid",void 0),ie([zt()],va.prototype,"_loading",void 0),ie([zt()],va.prototype,"_error",void 0),ie([zt()],va.prototype,"_popover",void 0),ie([zt()],va.prototype,"_xLabelVisible",void 0),va=ie([yt(Hs)],va);var ya=ht(()=>{ma="nvision-reactor-core-card",pa="nvision-reactor-core-card-editor",ga="auto",fa=["sensor","binary_sensor","switch","light","timer"],_a=["sensor","binary_sensor","switch","light","timer"]});function ba(t){const e=t.split(":").map(Number);return 3===e.length?3600*e[0]+60*e[1]+e[2]:2===e.length?60*e[0]+e[1]:Number(t)||0}function xa(t){return void 0!==t&&"unavailable"!==t&&"unknown"!==t&&("on"===t||"true"===t||"open"===t||"home"===t||"active"===t)}function wa(t,e){const i=e.split(".",1)[0];if("light"===i)return"light";if("timer"===i)return"timer";if("switch"===i||Ds(e))return"toggle";const n=t.states[e]?.state;return void 0!==Ze(n)?"numeric":"other"}function $a(t,e,i,n){const s=Ze(t.states[e]?.state);return void 0===s?.35:Je(s,i,n)}function Ma(t,e){const i=t.states[e];if(!i||"active"!==i.state)return 0;const n=function(t){const e=t.attributes.remaining;if("string"!=typeof e)return;let i=ba(e);if("active"===t.state&&t.attributes.finishes_at){const e=new Date(String(t.attributes.finishes_at)).getTime();i=Math.max((e-Date.now())/1e3,0)}return i}(i),s=function(t){const e=t.attributes.duration;return"string"==typeof e?ba(e):0}(i);return void 0===n||s<=0?.55:1-Math.min(1,Math.max(0,n/s))}function ka(t,e,i,n){const s=t.states[e]?.state,a=wa(t,e),o="light"===a?function(t,e){const i=t.states[e];if(!i||"on"!==i.state)return{lightBrightness:0};const n=os(i);return{lightColor:n?`rgb(${n.join(", ")})`:void 0,lightBrightness:ns(i)}}(t,e):{};return{kind:a,isOn:xa(s),numericNorm:$a(t,e,i,n),lightColor:o.lightColor,lightBrightness:o.lightBrightness??0,timerUrgency:"timer"===a?Ma(t,e):0,unavailable:"unavailable"===s||"unknown"===s}}ya(),hi();var Ca=[.42,.58,.72,.84],Sa=[185,198,215,248,278,312,42],Aa=2*Math.PI;function za(t){let e=2166136261;for(let i=0;i<t.length;i+=1)e^=t.charCodeAt(i),e=Math.imul(e,16777619);return(e>>>0)/4294967296}function Ea(t,e){const i=Math.min(Ca.length,Math.max(2,Math.ceil(Math.sqrt(e)))),n=t%i,s=Math.ceil(e/i);return{shell:n,slot:Math.floor(t/i)%s,slotsOnShell:s}}function Pa(t,e){const i=(14e-6*e+.31*t)%Sa.length,n=Math.floor(i);return Sa[n]+(Sa[(n+1)%Sa.length]-Sa[n])*(i-n)}function Ta(t,e,i,n){const s=ka(e,t.entityId,i,n);t.kind=s.kind,t.isOn=s.isOn,t.numericNorm=s.numericNorm,t.lightColor=s.lightColor,t.lightBrightness=s.lightBrightness,t.timerUrgency=s.timerUrgency,t.unavailable=s.unavailable}function Oa(t,e){const i=function(t,e){return"numeric"===t.kind?Ia(e,t.numericNorm):"light"===t.kind?e*(.008+.024*t.lightBrightness):La(e,t.kind)}(t,e),n=.014*e;return Math.min(3.4,Math.max(.5,n/Math.max(i,.004*e)))}function Ia(t,e){return t*(.006+.028*e)}function La(t,e){switch(e){case"toggle":return.016*t;case"light":return.011*t;case"timer":return.013*t;case"numeric":return.012*t;default:return.01*t}}function qa(t,e){e.push({x:t.x,y:t.y,age:0,seed:t.seed})}function Ra(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:fa,n=e.max_particles??32,s=e.exclude??[];return Object.keys(t.states).filter(e=>{const n=e.split(".",1)[0];return!!i.includes(n)&&(!function(t,e){for(const i of e)if(i)if(i.includes("*")){if(new RegExp(`^${i.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")}$`).test(t))return!0}else if(t===i)return!0;return!1}(e,s)&&"unavailable"!==t.states[e]?.state)}).sort((t,e)=>t.localeCompare(e)).slice(0,n)}function Fa(t,e,i,n,s,a){const o=za(e),r=za(`${e}:y`),l=Ea(s,a),c=t.states[e]?.state,h={entityId:e,kind:wa(t,e),seed:o,seedY:r,x:0,y:0,phase:o*Aa,shell:l.shell,slot:l.slot,slotsOnShell:l.slotsOnShell,orbitTilt:o*Aa,orbitRyScale:.62+.32*r,baseOrbitSpeed:85e-5+.0011*o,wobbleSpeed:.0016+.0024*r,vx:0,vy:0,isOn:!1,lastState:c,numericNorm:.35,lightBrightness:0,timerUrgency:0,unavailable:"unavailable"===c||"unknown"===c,placed:!1};return Ta(h,t,i,n),h}function Na(t,e){const i=t/2,n=e/2,s=Math.max(10,.06*t),a=Math.max(10,.06*e),o=Math.max(1,t/2-s),r=Math.max(1,e/2-a);return{cx:i,cy:n,halfW:o,halfH:r,scale:Math.min(t,e),clampX:o,clampY:r}}function ja(t,e,i,n){const{cx:s,cy:a,halfW:o,halfH:r}=Na(e,i),l=Ca[t.shell%Ca.length],c=t.slot/Math.max(1,t.slotsOnShell)*Aa+.55*t.seed+t.phase,h=o*l,d=r*l*t.orbitRyScale,u=Math.cos(c)*h,m=Math.sin(c)*d,p=t.orbitTilt;let g=s+u*Math.cos(p)-m*Math.sin(p),f=a+u*Math.sin(p)+m*Math.cos(p);const _=.001*n,v=.028+.018*t.seed;return g+=Math.cos(_*t.wobbleSpeed+11*t.seed)*h*v,f+=Math.sin(_*t.wobbleSpeed*1.23+9*t.seedY)*d*v,{x:g,y:f}}function Da(t,e,i,n){const s=ja(t,e,i,n);t.x=s.x,t.y=s.y,t.placed=!0}function Ba(t,e,i){const n=Pa(t.seed,e);let s=82,a=58;return t.unavailable&&(s=18,a=42),`hsla(${n}, ${s}%, ${a}%, ${i})`}function Ua(t,e,i,n,s,a,o=.5){t.beginPath(),t.arc(e,i,n*(1+a*o),0,Aa),t.fillStyle=s.replace(/[\d.]+\)$/,.07+.1*a+")"),t.fill(),t.beginPath(),t.arc(e,i,n,0,Aa),t.fillStyle=s,t.fill()}function Ha(t,e,i,n){const s=La(i,"toggle"),a=e.isOn?.012:.007,o=Math.sin(n*a+12*e.seed),r=e.isOn?.38+.48*o:.06+.06*o,l=Pa(e.seed,n),c=e.isOn?.92:.34,h=e.unavailable?`hsla(${l}, 18%, 42%, ${.4*c})`:`hsla(${l}, ${e.isOn?90:38}%, ${e.isOn?65:36}%, ${c})`;Ua(t,e.x,e.y,s,h,r)}function Wa(t,e,i,n){const s=e.lightBrightness,a=i*(.008+.024*s),o=e.unavailable?.25:e.isOn?.22+.72*s:.18,r=e.lightColor??(e.isOn?"rgb(255, 183, 77)":Ba(e,n,.25));Ua(t,e.x,e.y,a,function(t,e){const i=t.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/);return i?`rgba(${i[1]}, ${i[2]}, ${i[3]}, ${e})`:t.match(/hsla?\(([^)]+)\)/)?t.replace(/[\d.]+\)$/,`${e})`):t}(r,o),o)}function Ga(t,e,i,n){const s=e.timerUrgency,a=.005+.048*s,o=Math.sin(n*a+10*e.seed),r=1+o*(.15+.35*s),l=e.unavailable?.25:.35+.25*s,c=(.22+.3*o)*(.3+.7*s)*r,h=La(i,"timer")*r,d=Pa(e.seed,n);Ua(t,e.x,e.y,h,`hsla(${d}, 86%, ${58+12*s}%, ${l})`,c)}function Va(t,e,i,n){const s="numeric"===e.kind?Ia(i,e.numericNorm):La(i,e.kind),a=e.unavailable?.28:.78,o=Ba(e,n,a);Ua(t,e.x,e.y,s,o,.65*a)}function Ya(t,e,i,n,s,a,o,r){const l=r?.15:1,c=i?.min??0,h=i?.max??100;if(e)for(const d of t)"timer"!==d.kind&&"light"!==d.kind&&"numeric"!==d.kind&&"toggle"!==d.kind||Ta(d,e,c,h);!function(t,e,i,n,s,a){const{cx:o,cy:r,scale:l,clampX:c,clampY:h}=Na(e,i),d=.13*l,u=.0032*a,m=.11*a;for(const p of t){p.phase+=p.baseOrbitSpeed*Oa(p,l)*n;const g=ja(p,e,i,s);p.vx+=(g.x-p.x)*u*n,p.vy+=(g.y-p.y)*u*n;for(const e of t){if(e===p)continue;const t=p.x-e.x,i=p.y-e.y,s=Math.hypot(t,i);if(s>.5&&s<d){const e=((d-s)/d)**1.5*m*n;p.vx+=t/s*e,p.vy+=i/s*e}}const f=o-p.x,_=r-p.y,v=Math.hypot(f,_);v>.96*Math.min(c,h)&&(p.vx+=f/v*.006*n*a,p.vy+=_/v*.006*n*a),p.vx*=.88,p.vy*=.88,p.x+=p.vx*n*a*16,p.y+=p.vy*n*a*16,p.x=Math.min(o+c,Math.max(o-c,p.x)),p.y=Math.min(r+h,Math.max(r-h,p.y)),p.placed=!0}}(t,n,s,a,o,l)}function Ka(t,e,i,n,s,a){const{cx:o,cy:r,scale:l}=Na(n,s);t.clearRect(0,0,n,s);const c=t.createRadialGradient(o,r,0,o,r,.72*l);c.addColorStop(0,"hsla(200, 70%, 58%, 0.06)"),c.addColorStop(.35,"hsla(260, 55%, 42%, 0.03)"),c.addColorStop(1,"hsla(0, 0%, 0%, 0)"),t.fillStyle=c,t.fillRect(0,0,n,s),function(t,e,i,n){for(const s of e){const e=s.age/1400,a=i*(.03+.48*e),o=(1-e)**1.2*.11,r=Pa(s.seed,n);t.beginPath(),t.arc(s.x,s.y,a,0,Aa),t.strokeStyle=`hsla(${r}, 86%, 64%, ${o})`,t.lineWidth=1+1.4*(1-e),t.stroke()}}(t,i,l,a);for(const h of e)switch(h.kind){case"toggle":Ha(t,h,l,a);break;case"light":Wa(t,h,l,a);break;case"timer":Ga(t,h,l,a);break;default:Va(t,h,l,a)}Ua(t,o,r,.012*l*(.55+.12*Math.sin(.0018*a)),`hsla(${Sa[Math.floor(14e-6*a%Sa.length)]}, 88%, 68%, 0.65)`,.5,.3)}var Xa,Qa,Za,Ja=/* @__PURE__ */dt({NvisionReactorCoreCardEditor:()=>Za}),to=ht(()=>{kt(),Dt(),Ht(),ae(),he(),ya(),se(),Xa=[{name:"name",selector:{text:{}}},{name:"mode",required:!0,default:ga,selector:{select:{options:[{value:"auto",label:"Auto-discover entities"},{value:"manual",label:"Manual entity list"}]}}},{name:"max_particles",default:32,selector:{number:{min:4,max:64,mode:"box"}}},{type:"grid",name:"",schema:[{name:"min",required:!0,default:0,selector:{number:{step:"any"}}},{name:"max",required:!0,default:100,selector:{number:{step:"any"}}}]},oe()],Qa=[{name:"entities",selector:{entity:{multiple:!0,domain:[..._a]}}}],Za=class extends ne{constructor(...t){super(...t),this._computeLabel=t=>{if(this.hass)return"name"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.name"):"mode"===t.name?"Entity source":"entities"===t.name?this.hass.localize("ui.panel.lovelace.editor.card.generic.entities"):"max_particles"===t.name?"Maximum particles":"min"===t.name?"Numeric orbit min":"max"===t.name?"Numeric orbit max":re(this.hass,t)??this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}setConfig(t){this._config={mode:ga,max_particles:32,min:0,max:100,entities:[],...t}}_schema(){return"manual"===this._config?.mode?[...Xa.slice(0,3),...Qa,...Xa.slice(3)]:Xa}render(){return this.hass&&this._config?G`
    ...
    `]}};function io(t,e){if("manual"===(e.mode??"auto")&&e.entities?.length)return e.entities.filter(e=>Boolean(t.states[e]));const i=e.domains?.length?e.domains:[..._a],n=e.max_particles??32;return Object.keys(t.states).filter(t=>i.includes(t.split(".",1)[0])).sort((t,e)=>t.localeCompare(e)).slice(0,n)}ie([St({attribute:!1})],eo.prototype,"hass",void 0),ie([zt()],eo.prototype,"_config",void 0),ie([It(".stage")],eo.prototype,"_stage",void 0),ie([It("canvas")],eo.prototype,"_canvas",void 0),eo=ie([yt(ma)],eo),console.info("%c nvision 0.1.0 ","color: var(--primary-color, #03a9f4); font-weight: 700;");